export const dataFeatured=[{title: "“Mù tịt\" chuyên môn nhưng lại là “nữ thần\" nức tiếng cộng đồng game Việt, top gái xinh sở hữu bí thuật gì?",
...
export const dataContent=[{title: "Dragon Ball Super: Vượt qua Ultra Instinct, Ultra Ego của Vegeta được \"ví von\" giống với một loại sức mạnh \"nghìn năm có một\"",
...
export const dataContent02=[{title: "Mặc bikini xuống phố chơi điện tử xèng, nữ streamer từng bị \"fan boy lớp 6\" quấy rối nhận vô số chỉ trích",
...
export const dataContent03=[{title: "Mỹ nhân Nhật Bản kể chuyện bị mất việc vì gò bồng đảo quá khủng, tức mình chuyển nghề 18+",
...
export const dataContent04=[{title: "Mỹ: Người dân Greenville tuyệt vọng trong thị trấn bị cháy rừng xóa sổ",
...
export const dataContent05=[{title: "Đừng ăn mì tôm trứng xúc xích nữa, đây là cách để làm mì gói trở nên dinh dưỡng hơn",
...
export const dataContent06=[{title: "Sẽ ra sao nếu các loài động vật đều có tạo hình khối hộp vuông như Minecraft?",
...
export const dataContent07=[{title: "Nữ thần lai nhà YG Jeon Somi gây bão với visual siêu thực như búp bê Barbie, Jennie u mê đến mức spam bình luận khen hết lời",
...
export const dataContent08=[{title: "4 xung đột giữa các diễn viên của Fast & Furious khiến người dọa bỏ vai kẻ thì bye bye thật",
...
export const dataContent09=[{title: "Những loài quái vật kỳ quái trong truyền thuyết châu Á",
...
export const dataContent10=[{title: "Nghiện cởi, nữ streamer xinh đẹp cả triệu follow gây sốc khi đổi nghề sang bán ảnh nóng, nội y và đồ chơi 18+",
...
export const dataContent11=[{title: "Hot girl phim 18+ gây sốc khi báo hiệu ngày tàn của ngành công nghiệp, khuyên các đàn em nên rút lui, đừng ảo tưởng được như Yua Mikami",
...
export const dataContent12=[{title: "Thất vọng vì thua Đức tan nát, Ronaldo bèn cởi trần khiến dân tình náo loạn: 6 múi sầu riêng đều tăm tắp nhờ nói không với Coca",
...
export const dataContent13=[{title: "Những tựa game hay tuyệt nhưng khiến game thủ phát cáu vì cái kết vớ vẩn",
...
export const dataContent14=[{title: "Hướng dẫn bảo vệ sức khỏe đi kèm ảnh bikini gợi cảm, nữ bác sĩ xinh đẹp khiến CĐM phát sốt",
...
export const dataContent15=[{title: "“CS:GO Mobile” tiến hành thử nghiệm, đã có trên Google Play, game thủ nghi vấn ông lớn này phát hành tại VN?",

export const dataFeatured=[{title: "Bộ sưu tập hình ảnh giúp bạn tiếp thu được những kiến thức kỳ quái chả ai biét",
...
export const dataContent=[{title: "Dragon Ball Super: Đều nâng cao sức mạnh, Fusion Dance và bông tai Potara đâu là phép \"hợp thể\" mạnh hơn?",
...
export const dataContent02=[{title: "Nhan sắc xinh đẹp của thiên thần trượt băng đã cosplay Trùng Trụ, tài sắc vẹn toàn càng ngắm càng mê",
...
export const dataContent03=[{title: "Dragon Ball Super: Mãn nhãn ngắm \"from hủy diệt\" của Vegeta, hoàng tử không lông mày nhưng vẫn ngầu bá cháy",
...
export const dataContent04=[{title: "Dragon Ball Super: Dù Bản năng Vô cực mạnh thế nào thì vẫn không thể thay thế tuyệt chiêu này của Goku",
...
export const dataContent05=[{title: "8 game có cốt truyện sinh ra để \"lừa\" game thủ (P1)",
...
export const dataContent06=[{title: "Tại sao khỉ đột, tinh tinh và chuột túi hầu như không cần phải tập luyện sức mạnh mà cơ bắp của chúng vẫn cực kỳ phát triển?",
...
export const dataContent07=[{title: "Top 10 tựa game PC những năm 2000 với đồ họa đỉnh cao làm game thủ mãi nhớ (P.2)",
...
export const dataContent08=[{title: "Thành gái độc thân, body Dương Mịch ngày càng \"mlem\": Nhìn màn hở bạo khoe vòng eo sexy ở sự kiện hôm nay là rõ",
...
export const dataContent09=[{title: "Đường Tăng đẹp nhất Tây Du Ký tức giận bỏ vai chỉ vì 18 nghìn đồng, dối lừa khán giả rồi bị Trư Bát Giới \"vạch mặt\"?",
...
export const dataContent10=[{title: "Những trò chơi đặc biệt được mệnh danh \"sách giáo khoa\" cho cả làng game",
...
export const dataContent11=[{title: "Bước nhẹ ra vườn hồng ở biệt thự 21 tỷ, Lọ Lem có ngay bộ ảnh sống ảo, “sốc visual” nhất là góc nghiêng đẹp nức nở!",
...
export const dataContent12=[{title: "Mát mắt ngắm mỹ nhân Azur Lane diện đồ bơi khoe body nuột nà, tâm hồn cứ gọi là bát ngát",
...
export const dataContent13=[{title: "Vô tư gác chân lên ghế, nữ streamer xinh đẹp hớ hênh, lộ ngay điểm nhạy cảm gây chú ý",
...
export const dataContent14=[{title: "Văn Toàn được đồng đội cõng lên xe trở về khách sạn sau trận thắng Indonesia",
...
export const dataContent15=[{title: "Thánh nữ\" Dota 2 mừng tuổi mới, chiêu đãi fan bằng bộ ảnh khoe vòng một cực phẩm trên Instagram",

export const dataFeatured=[{title: "Những khung cảnh quen thuộc của game thủ Việt thời còn chưa có Internet, nhìn là thấy cả bầu trời kỷ niệm (p2)",
...
export const dataContent=[{title: "Nhan sắc thăng hạng của mỹ nhân bị ghét vì đóng cảnh nóng phản cảm trong Tân Hoàn Châu Cách Cách",
...
export const dataContent02=[{title: "Những chi tiết thú vị trong Black Widow đã hé lộ thông tin quan trọng về các mối quan hệ thuộc MCU",
...
export const dataContent03=[{title: "Dragon Ball: Hồi sinh cả vũ trụ nhưng Goku và Vegeta lại chưa từng ước chủng tộc Saiyan quay trở lại, lý do vì đâu?",
...
export const dataContent04=[{title: "Toàn bộ sự nghiệp vĩ đại của Messi tại Barcelona qua ảnh",
...
export const dataContent05=[{title: "Muốn \"bóc trần\" nhan sắc Rosé (BLACKPINK) ở hậu trường mà bó tay, \"đắt\" nhất combo tóc vàng bay tôn lên visual đẹp muốn lịm đi",
...
export const dataContent06=[{title: "Điểm lại 10 trend khai nguồn từ idol Hàn, đâu mới là xu hướng được lòng netizen nhất?",
...
export const dataContent07=[{title: "Mua căn hộ 58m2, vợ chồng trẻ tự thiết kế siêu ưng nhưng nể nhất là chi phí siêu \"hạt dẻ\"",
...
export const dataContent08=[{title: "Trở lại nơi từng bị quấy rối khiếm nhã, nữ streamer siêu vòng một gây bất ngờ, tiếp tục cởi áo khoe body ngay sau đó",
...
export const dataContent09=[{title: "Giảm cân thành công để sở hữu thân hình nóng bỏng, cô gái bỗng hóa thành nữ YouTuber nổi tiếng",
...
export const dataContent10=[{title: "Mở tour \"suối nước nóng\" giá 12 triệu, nàng hot girl phim 18+ bẽ bàng khi không ai đăng ký, lên tiếng chỉ trích fan thậm tệ",
...
export const dataContent11=[{title: "Top 10 nữ thần trong game khiến bạn tin vào tình yêu đích thực",
...
export const dataContent12=[{title: "Top 5 cầu thủ Việt có lượng người theo dõi khủng nhất trên Facebook, cái tên \"mlem mlem\" Đoàn Văn Hậu xếp thứ mấy?",
...
export const dataContent13=[{title: "Lee Kwang Soo và hành trình ở Running Man: Khởi đầu bằng nước mưa, kết thúc đẫm nước mắt",
...
export const dataContent14=[{title: "Sam bị tuột bikini trên sóng, nữ YouTuber vội vàng che đậy nhưng vẫn hớ hênh, lên tiếng trần tình tại \"vòng một quá to\"",

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    ...
                    người lớn. Hiện tại, cô nàng đang là diễn viên độc quyền của
                    công ty Moodyz và là 1 trong những cái tên trẻ nhất trong
                    lịch sử tham gia vào ngành công nghiệp này.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Ngay từ khi mới xuất hiện, <strong>Rikka Ono</strong> đã tạo
                    nên ấn tượng mạnh với nhan sắc xinh đẹp, mong manh, trong
                    sáng và vô cùng đáng yêu. Cô nàng chỉ cao có 148 cm, với số
                    đo 3 vòng lần lượt là 81 - 58 - 82. Dù vậy, điều này cũng
                    không quá ảnh hưởng tới tình cảm của fan hâm mộ dành cho cô
                    nàng.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Sau khi trình làng, <strong>Rikka Ono</strong> đã ngay lập
                    tức leo lên top 1 bảng xếp hạng trong vòng 3 ngày liên tiếp.
                    Cô nàng cũng được giới chuyên môn đánh giá khá cao, khi được
                    xếp thứ 2 trong số các tân binh phim 18+ trình làng trong
                    năm 2020, còn sản phẩm trình làng cũng nằm trong top 5 những
                    sản phẩm bán chạy nhất của năm.
                  </p>
                  ...
                  <p>
                    ...
                    các "nữ thần AV" trước đây. Trong khoảng 3 tháng giữa năm
                    2020, Nozomi Ishihara liên tục giữ vị trí số 1 trong bảng
                    xếp hạng của các nền tảng 18+. Nhận thấy sức hút của cô gái
                    trẻ, thậm chí các studio lớn của ngành công nghiệp AV cũng
                    đã vào cuộc.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    trị lớn để mời cô gái này ký hợp đồng độc quyền. Theo thống
                    kê từ bảng xếp hạng, Nozomi Ishihara đứng hạng 7 trong số
                    các diễn viên 18+ ăn khách nhất, và cũng là tân binh thành
                    công nhất năm 2020.
                  </p>
                  ...
                  <p>
                    ...
                    đã trở thành 1 trong những cái tên đáng chú ý nhất của công
                    ty này.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    thời trang thực thụ. Cô nàng cao tới 171cm, với số đô 3 vòng
                    là 86/60/88 cm. Bản thân Marin cũng chia sẻ, trước khi
                    chuyển sang ngành công nghiệp 18+, cô gái trẻ cũng đã hoạt
                    động với tư cách là người mẫu và vũ công. Tuy nhiên, điều
                    này cũng gây ảnh hưởng lớn đến thói quen của cô nàng khi
                    luôn có thói quen nhìn thẳng và máy quay và đã mất kha khá
                    thời gian để sửa lại điều này.
                  </p>

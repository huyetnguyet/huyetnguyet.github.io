                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      đó và thu giữ hàng chục CPU, hàng trăm card đồ họa và
                      3.800 máy chơi game PlayStation 4 Slim được cho là để
                      “khai thác tiền điện tử”. Tuy nhiên, có gì đó không bình
                      thường, vì việc khai thác tiền điện tử trên{" "}
                      <strong>
                    ...
                    <p>
                      ...
                      hoặc nhận các nhân vật quý hiếm. Những người điều hành
                      trang trại sau đó có thể bán những tài khoản này để lấy
                      tiền.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Giống như nhiều game thể thao khác hiện nay, FIFA 21 có
                      chế độ Ultimate Team, về mặt lý thuyết cho phép game thủ
                      xây dựng một đội bóng trong mơ của họ bằng cách sử dụng
                      các thẻ cầu thủ có được từ lootbox. Lootbox có thể được
                      mua bằng tiền tệ trong trò chơi hoặc bằng tiền thật. Lưu ý
                      là cơ hội để có được một nhân vật thực sự mạnh là dưới 1%,
                      vì vậy game thủ có thể phải bỏ ra cả tấn tiền mà không
                      kiếm được một cầu thủ tử tế. Trong khi đó, việc kiếm tiền
                      trong trò chơi mất rất nhiều thời gian vì nó đòi hỏi rất
                      nhiều công đoạn (thực hiện các nhiệm vụ lặp đi lặp lại).
                    </p>
                    <ContentImage
                      src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/7/19/photo-1-1626707442669514919282.png"
                    ...
                    />
                    <p>
                      Các bot tự động chơi số giờ và đơn vị tiền tệ cần thiết
                      trên máy game, sau đó tài khoản được bán trong các cửa
                      hàng trực tuyến. Trong các cửa hàng như vậy, bạn có thể
                      tìm thấy quảng cáo bán tài khoản FIFA với các đội có sẵn.
                      Ví dụ: trên một trong các trang web này (hình bên dưới),
                      một người dùng bán các tài khoản khác nhau với giá 1.500
                      UAH (với đội trị giá 1,3 tỷ tiền tệ trong trò chơi) và
                      2.500 UAH, khoảng 50 đến 100 USD.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      nơ-ron, hướng đến nhằm kiếm tiền trong trò chơi. Sau đó,
                      họ có thể bán tài khoản chứa đầy tiền tệ trong game cho
                      những người muốn thử vận may và kiếm một cầu thủ hiếm bằng
                      cách mua lootbox hoặc lấy nhân vật hiếm đó để bán lại với
                      giá cao hơn. Bán tiền tệ trong game như không sinh lợi quá
                      nhiều, nhưng cố gắng có được một nhân vật hiếm thì rất
                      khó. Vì họ sử dụng điện miễn phí, thậm chí một việc như
                      vậy cũng có thể có ý nghĩa về mặt tài chính đối với họ.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Không chỉ <strong>PS4</strong> và CPU, trang trại này còn
                      có ước tính khoảng 500 card đồ hoạ. Với 500 card đồ họa,
                      cùng một trang trại đó cũng có thể khai thác Ethereum.
                      Trong khi đó, 500 card đồ họa cũng có thể điều khiển các
                      nhân vật trong các game khác để đào tạo chúng, nhận tiền
                      tệ trong trò chơi và / hoặc lootbox. Có vẻ như đây là một
                      hoạt động "cày cuốc" khá đa dạng, có thể được sử dụng cho
                      cả khai thác tiền điện tử cũng như các nhân vật và tiền tệ
                      trong game.
                    </p>

            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Anh Tùng Lâm (1994) hiện là huấn luyện viên môn BodyJam của
                    1 trung tâm thể dục - thể hình tại Hà Nội. Trái ngược với
                    những gì mọi người thường hình dung về 1 huấn luyện viên thể
                    hình, anh Lâm mong muốn tổ ấm của mình sẽ là nơi thật nhẹ
                    nhàng, bình yên và có thể thoải mái thể hiện bản thân.
                  </p>
                  <p>
                    Động lực để anh quyết tâm tậu nhà riêng có 1 phần bắt nguồn
                    từ tuổi thơ sinh ra và lớn lên trong 1 căn nhà vỏn vẹn 8m2,
                    khi ấy mọi sinh hoạt đều vô cùng bất tiện với nhiều khó
                    khăn, thiếu thốn. Căn hộ rộng 40m2 tại Kim Mã này cũng nằm
                    gần gia đình nên mẹ anh thi thoảng có thể ghé qua nấu nướng,
                    đồng thời lại có thể thường xuyên được tụ tập bên gia đình,
                    họ hàng.
                  </p>
                  <p>
                    Căn hộ tập thể cũ này đã có tuổi đời hơn 20 năm nên hiện
                    trạng xuống cấp trầm trọng. Tường, trần, sàn đều bị ngấm, ố
                    và bong tróc khá nhiều. Sàn gỗ thì co ngót và rộp lên. Hệ
                    thống chiếu sáng yếu ớt, thiếu thốn không đủ để cung cấp ánh
                    sáng cho toàn bộ căn nhà. Trong nhà cũng chỉ có 1 vài{" "}
                    <strong>đồ nội thất</strong> cơ bản đủ để sử dụng. Ngoài ra,
                    ban công nhỏ và bị vây kín, không đủ rộng để có không gian
                    phơi phóng hay làm góc chill.
                  </p>
                  <p>
                    Vì vậy, khi tiến hành cải tạo, đơn vị thiết kế đã xử lý và
                    hoàn thiện lại trần - tường - sàn. Trần thạch cao được kết
                    hợp ốp gỗ. Trong khi đó, tường được xử lý ngấm ố, chát chít
                    và sơn lại toàn bộ. Ngoài ra, 1 số mảng tường cũ được đập bỏ
                    để cải tạo thành tường mới. Với đôn sàn ở khu vực{" "}
                    <strong>nhà vệ sinh</strong>, <strong>kiến trúc sư</strong>{" "}
                    đã xử lý chống tràn nước ra các khu vực khác trong nhà, đồng
                    thời thay sàn gạch tại khu bếp và{" "}
                    <strong>phòng làm việc</strong> để tạo sự khác biệt, phân
                    tách không gian và tạo độ thẩm mỹ. Toàn bộ khu vực phòng
                    khách - phòng ngủ cũng được ốp sàn gỗ.
                  </p>
                  <p>
                    Hệ thống chiếu sáng được nâng cấp với hệ đèn âm trần kết hợp
                    với đèn lon để tạo điểm nhấn cho{" "}
                    <strong>đồ nội thất</strong> và ánh sáng trong khi sử dụng.
                    Khu vực ban công cũ đã được cơi nới, mở rộng thêm diện tích
                    để trở thành <strong>phòng làm việc</strong> và mini bar.
                  </p>
                  <RelationNewsInPage category={category} />

                  <p>
                    Trái với vẻ bí bách, tù túng của các căn hộ tập thể cũ,
                    không gian mới sau khi được cải tạo lại trở nên thoáng đãng,
                    rộng rãi hơn. Đặc biệt là nó rất phù hợp với cuộc sống của 1
                    chàng trai độc thân với style trẻ trung, hiện đại cùng tone
                    màu sắc thiên về mệnh của chủ nhà như vàng, xanh lá cây,
                    hồng. Dù diện tích căn hộ vỏn vẹn 40m2 nhưng đủ vừa vặn và
                    ấm cúng: có <strong>phòng làm việc</strong> và khu tập thể
                    dục tích hợp, bếp nhỏ gọn nhưng tiện nghi cùng bàn ăn tiện
                    lợi theo <strong>phong cách Nhật Bản</strong>.
                  </p>
                  <p>
                    Quá trình cải tạo gặp một vài khó khăn như xin giấy phép xây
                    dựng của những nhà dân xung quanh và tổ dân phố, phải gia cố
                    rất chắc chắn các tường chịu lực cũng như kết cấu khung
                    xương của căn hộ để không ảnh hưởng đến cấu trúc và mức độ
                    an toàn của toàn tòa nhà. Tuy nhiên, sau thời gian 90 ngày,
                    căn hộ đã được lột xác mỹ mãn với chi phí 420 triệu, đúng
                    như những gì anh Lâm đã hình dung về tổ ấm trong mơ.
                  </p>

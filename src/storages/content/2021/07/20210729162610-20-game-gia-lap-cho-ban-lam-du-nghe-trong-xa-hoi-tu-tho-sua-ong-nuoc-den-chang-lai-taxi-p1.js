              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    ...
                    <strong>game mô phỏng</strong> lái xe tải, mang đến cho bạn
                    cơ hội để trở thành <strong>tài xế xe tải</strong> thực sự.
                    Với những thương hiệu xe tải nổi tiếng, vô số lựa chọn có
                    thể tùy biến và hiệu ứng vật lý tiên tiến, game mang đến một
                    trải nghiệm lái xe tải tuyệt vời mà bạn chưa từng thử trước
                    nay.
                  </p>
                  <p>
                    Tham gia game <strong>Euro Truck Simulator 2</strong>, bạn
                    sẽ được đi du lịch khắp châu Âu như là một vị vua của những
                    con đường, người cung cấp hàng hóa quan trọng trên những
                    cung đường ấn tượng. Game có nhiều danh thắng, vùng lãnh thổ
                    được tái tạo chính xác để khám phá từ Anh, Bỉ, Đức, Ý, Hà
                    Lan đến Ba Lan và nhiều hơn nữa, khiến bạn có cảm giác như
                    mình đang lái xe trong thế giới thực. Không chỉ lái xe, nền
                    kinh tế trong trò chơi cho phép tạo và phát triển những công
                    ty vận chuyển, thách thức sự chịu đựng, kỹ năng, trình độ
                    quản lý của bạn. Cơ hội là vô tận, hãy bắt đầu sự nghiệp to
                    lớn của bạn từ công việc nhỏ bé nhất là lái xe tải trong
                  ...
                  <p>
                    ...
                    nhiều hơn với những bản mod) cùng trở về nơi chốn quê thanh
                    bình để cùng nhau trở thành những người nông dân chăm chỉ
                    xây dựng một trang trại rộng lớn theo đúng ý thích của cả
                    nhóm.{" "}
                  </p>
                  <p>
                    Game được làm theo lối đồ họa truyền thống mang đến một cảm
                    giác nhẹ nhàng và khá thích mắt. Không chỉ vậy, khả năng
                    tương tác của bạn với các nhân vật phụ trong game cũng rất
                    đa dạng khiến <strong>Stardew Valley</strong> trở thành một
                    thế giới hết sức chân thật và gần gũi.
                  </p>
                  ...
                  <p>
                    ...
                    James đã buộc phải tiếp quản khách sạn BnB khi anh trai của
                    James biến mất một cách bí ẩn. Ngoài việc tìm ra anh trai
                    qua nhiều manh mối khác nhau, với tư cách là phó giám đốc
                    của khách sạn BnB, người chơi sẽ hỗ trợ những cô gái xinh
                    đẹp đang muốn tìm một chốn nghỉ ngơi, thư giãn.
                  </p>
                  <p>
                    Thông qua việc phát triển các mối quan hệ trong cốt truyện
                    của game, người chơi trong Together BnB sẽ dần làm quen với
                    những cô gái xinh đẹp, rồi dần dần phát triển một mối quan
                    hệ lãng mạn ngày càng sâu sắc hơn. Tuy nhiên hãy chú ý chiều
                    lòng và làm các cô gái xinh đẹp cảm thấy vui, nếu không
                    người chơi sẽ bị "đá" đấy.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Mỗi màn chơi, Together BnB sẽ yêu cầu người chơi lựa chọn
                    trang phục thích hợp cho cô bạn gái đang hẹn hò, chụp ảnh
                    cho nếu như họ muốn. Mua nguyên liệu và nấu các món ăn ngon
                    để giúp lấy điểm trong mắt của cô gái. Thậm chí người chơi
                    có thể rủ các cô gái đi dã ngoại, nếm rượu vang, mát xa và
                    nhiều hơn nữa để giành được trái tim của họ.{" "}
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    sẽ phải chiến đấu chống lại những con thú trong rừng để bảo
                    vệ các cô gái. Sau mỗi lần hoàn thành màn chơi, người chơi
                    sẽ được mở khóa thêm những bộ trang phục mới, lộng lẫy hơn,
                    và cũng không kém phần gợi cảm cho các cô gái và đặc biệt
                    được họ yêu mến.
                  </p>
                  <h5>Taxi Simulator (Giả lập lái xe taxi)</h5>
                  <p>
                    Taxi Simulator là tựa game cho phép bạn trở thành một lái xe
                    taxi trong thành phố phồn hoa, nhộn nhịp. Đương nhiên,
                    ...
                    trường hợp, thậm chí có thể liên quan đến những vụ án nghiêm
                    trọng.
                  </p>
                  <p>
                    Như trong trailer vừa xem, người chơi sẽ phải đối mặt với
                    những tính huống trớ trêu như khách say rượu, cặp đôi "mây
                    mưa" trên xe, tên bắt cóc và thậm chí là phải đỡ đẻ cho một
                    người phụ nữ bụng mang dạ chửa... Bạn sẽ làm gì khi gặp phải
                    những tính huống như thế? Hãy thử ngay Taxi Simulator để xem
                    cuộc sống của các bác lái xe taxi thú vị và khó khăn như thế
                    nào nhé.
                  </p>
                </div>
              </div>

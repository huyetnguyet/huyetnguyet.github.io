              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    ...
                    người chơi sẽ dùng súng để đối đầu với các đối thủ khác nhau
                    trong trận đấu. Trò chơi này có một kho{" "}
                    <strong>vũ khí</strong> thật sự khổng lồ, nhưng không phải
                    khẩu nào cũng uy lực và giúp người chơi chiến thắng được cả
                    .Một trong những khẩu súng như vậy chính là Suicide Gun -
                    khẩu súng "tự hủy".
                  </p>
                  <p>
                  ...
                  />
                  <p>
                    Dark Souls 3 có nhiều <strong>vũ khí</strong> cực mạnh giúp
                    bạn phá đảo trò chơi này một cách dễ dàng, nhưng không có
                    nghĩa là nó không có những vũ khí "phế vật". Trường hợp được
                    nhắc đến trong bài này là cây Farron Greatsword - một vũ khí
                    khiến <strong>game</strong> thủ cảm thấy bực mình và... mù
                    mắt.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Về cơ bản, Farron Greatsword chặt chém rất đã tay và đẹp
                    mắt, thế nhưng khi dùng thì người chơi sẽ mất đi khả năng né
                    đòn khi đang chuẩn bị thi ra đòn với cây đại đao này. Thêm
                    nữa, sát thương của nó cũng chỉ bình thường chứ không phải
                    quá đáng cho lắm. Thế nên, Farron Greatsword không được{" "}
                    <strong>game</strong> thủ quá ưa chuộng trong 1 tựa game mà
                    sự sống chết chỉ trong một vài tích tắc sinh tử như Dark
                    Souls 3.{" "}
                  </p>
                  ...
                  <p>
                    ...
                    khá ngầu, khẩu súng này bắn ra một tia laze sáng chói lóa cả
                    mắt người chơi. Nó làm cho người chơi cảm thấy, dường như
                    đây chính là cây vũ khí họ tìm bấy lâu nay.
                  </p>
                  <p>
                    ...
                    cho đẹp vậy thôi chứ chả ai lại muốn đùa giỡn với mạng sống
                    của chính mình được cả.
                  </p>
                  ...
                  <p>
                    ...
                    <strong>game</strong>, khi người chơi game trên tay thì cảm
                    giác nó còn nằm lọt thỏm trong lòng bàn tay. Nhiều người
                    từng kỳ vọng rằng Kolibri mang tính năng gì đặc biệt, thế
                    nhưng khi dùng thì họ mới biết đã lầm.{" "}
                  </p>
                  <p>

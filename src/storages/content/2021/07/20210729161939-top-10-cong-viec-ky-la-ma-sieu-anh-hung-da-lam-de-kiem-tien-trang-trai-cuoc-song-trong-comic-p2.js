                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    <p>
                      ...
                      lái thử nghiệm tại Không quân Hoa Kỳ. Sau đó, anh quyết
                      định chuyển sang làm việc cho công ty tư nhân Ferris Air.
                      Nhiệm vụ chính của Hal trong công việc này là kiểm tra bộ
                      điều khiển và thúc đẩy động cơ máy bay lên đến mức giới
                      hạn cao nhất, nhằm đảm bảo rằng phương tiện sẽ sẵn sàng
                      cho các phi công chính.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      sĩ tâm lý cho khá nhiều <strong>siêu anh hùng</strong>.
                      Cái tên đầu tiên là Hulk/Bruce Banner, khi Samson đã hỗ
                      trợ cho anh cách kiểm soát được cơn giận.
                    </p>
                    <p>
                      Những cái tên khác từng được Doc Samson tư vấn tâm lý còn
                      có She-Hulk, Captain <strong>Marvel</strong>, War Machine,
                      nhóm Thunderbolts. Với lượng gamma trong người, Samson đã
                      tham gia Alpha Flight với cái tên Sasquatch.
                    </p>
                    ...
                    <p>
                      ...
                      là đô vật chuyên nghiệp thuộc hiệp hội UCWF, một tập hợp
                      của các các thể sở hữu siêu sức mạnh gồm{" "}
                      <strong>Marvel</strong> Boy, Ikaris và Demolition Man.
                    </p>
                    ...
                    />
                    <p>
                      Trong <strong>Marvel</strong> Comics, Luke Cage đã tận
                      dụng năng lực của mình vào việc kinh doanh với dịch vụ anh
                      hùng cho thuê. Chính từ dịch vụ này, mà anh đã kiếm được
                      một khoản kếch xù, qua đó một bước lên mây thành đại gia.
                      Một khoảng thời gian sau đó, dịch vụ anh hùng cho thuê lại
                      thuộc quyền quản lý của Oracle Inc, một công ty được điều
                      hành bởi Namor the Sub-Mariner.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      xuất thân là một quân nhân đầy nghiêm nghị và quả cảm.
                      Nhưng anh thực chất còn là một họa sĩ đầy tài năng.
                    </p>
                    <p>

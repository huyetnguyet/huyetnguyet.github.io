            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Không phải lúc nào thị trường cũng đánh giá đúng giá trị của
                    một tựa game open-world. Đôi khi, chúng chỉ có chất lượng
                    trung bình, nhưng hiệu ứng truyền thống đã đẩy chúng lên
                    thành hàng siêu phẩm và ngược lại. Những tựa game dưới đấy
                    được nhiều game thủ đánh giá là có chất lượng tuyệt vời,
                    nhưng đáng tiếc lại bị ghẻ lạnh, chúng thực sự là những
                    hidden game trong dòng game open-world.
                  </p>
                  <h5>1. Dying Light</h5>
                  <ContentImage
                    src="https://gamek.mediacdn.vn/133514250583805952/2021/6/30/-1625042149365447372853.jpg"
                  ...
                  />
                  <p>
                    Trong mắt nhiều người Dying Light là một tựa game thất bại.
                    Thế nhưng đối với những ai đủ kiên nhẫn dành thời gian cho
                    nó, chắc chắn họ sẽ phải công nhận rằng tựa game này hoàn
                    toàn có khả năng đánh bại những siêu phẩm như Skyrim, Far
                    Cry 3, AC: Brotherhood hay Fallout: New Vegas.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Điểm yếu chí mạng của Dying Light là cốt truyện và thiết lập
                    các nhiệm vụ quá nhàm chán, tệ hại. Và nếu đã chuẩn bị sẵn
                    tinh thần đón nhận điều này thì người chơi sẽ có thể{" "}
                    <strong>khám phá</strong> được cơ chế vận hành lẫn thế giới
                    tuyệt vời trong game.
                  </p>
                  <p>
                    Đồ họa của Dying Light rất tốt, ở mỗi khung cảnh hình ảnh
                    đều được đầu tư, chăm chút tỉ mỉ. Thế giới trong game sống
                    động hệt như đời thật và người chơi như có cảm hứng tìm hiểu
                    từng ngóc ngách của nó. Bên cạnh đó, Dying Light còn cải
                    tiến kỹ năng parkour cho người chơi khi kết hợp parkour cơ
                    bản của Mirror’s Edge với các góc nhìn đa dạng hơn thay vì
                    chỉ là góc nhìn của người chơi. Kết quả là sự kết hợp này
                    tạo ra một chuỗi kỹ năng cực kỳ mượt mà, chân thực cuốn hút
                    người chơi khi họ được thử cảm giác parkour chạy trốn cả đội
                    quân zombie.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Các màn combat cận chiến của Dying Light cũng được game thủ
                    đánh giá cao. Cơ chế chiến đấu tinh chỉnh và bổ sung thêm
                    các kỹ năng, kho vũ khí đa dạng, giúp trải nghiệm trận đấu
                    trở nên thú vị nhưng không quá dễ dàng. Đặc biệt, game giữ
                    nguyên những cảnh xé xác, tấn công đẫm máu hệt như trong
                    phim kinh dị.
                  </p>
                  ...
                  />
                  <p>
                    Tựa game No Man’s Sky vốn không được đánh giá cao, nhưng nó
                    thực sự là một lựa chọn không tồi nếu chơi cùng nhóm bạn.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Giống như Fallout 76, người chơi sẽ cùng xuất hiện trên một
                    map, nhưng họ không bao giờ gặp nhau vì vũ trụ luôn mở rộng.
                    Game có cơ chế chiến đấu hơi kỳ quặc, nhưng các trận chiến
                    với tàu cướp không gian theo góc nhìn thứ nhất cực kỳ thú
                    vị. Người chơi sẽ được trải nghiệm cảm giác sử dụng bộ phản
                    lực để bay lượn quanh hành tinh với một khẩu súng plasma
                    trên tay.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Bên cạnh đó, game còn cho phép người chơi thiết lập các tiền
                    đồn ở nhiều hành tinh khác nhau, thực hiện thêm các nhiệm vụ
                    truy tìm mẫu vật, quản lý cuộc sống trên tiền đồn… khiến trò
                    chơi càng trở nên hấp dẫn hơn.
                  </p>
                  <h5>3. Mad Max</h5>
                  <ContentImage
                  ...
                  />
                  <p>
                    Mặc dù trò chơi này không liên quan nhiều đến Mad Max: Fury
                    Road, Mad Max vẫn là một tựa game hấp dẫn.
                  </p>
                  <p>
                    ...
                    vùng đất hoang mạc cũng như kết bạn với những người bạn lập
                    dị trên cả quãng đường đi.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    chiến đấu tạo ra một nền tảng tuyệt vời để trò chơi xây dựng
                    thế giới thỏa thích.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Vận xui của Mad Max có lẽ là việc nó ra cùng ngày với Metal
                    Gear Solid 5: The Phantom Pain, điều này khiến cho nó mất đi
                    hiệu quả truyền thông khi mà ngay sau đó còn phải cạnh tranh
                    với Assassin’s Creed: Syndicate và Fallout 4.
                  </p>
                </div>
              </div>

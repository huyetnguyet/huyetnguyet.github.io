              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    <strong>mạng xã hội</strong> lớn bậc nhất thế giới này sẽ đệ
                    đơn kiện để chống lại những nhóm <strong>lừa đảo</strong>{" "}
                    trực tuyến. Bốn người Việt bị Facebook cáo buộc bao gồm
                    N.H.Thêm, L. Khang, N.Q.Bảo và P.H.Dũng. Bốn người này bị tố
                    cáo sử dụng thủ thuật “ăn trộm cookie” nhằm đột nhập vào các
                    tài khoản của nhân viên ở những đại lý quảng cáo, sau đó sử
                    dụng để chạy quảng cáo trái phép.
                  </p>
                  <ContentImage
                    src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/6/30/photo-1-1625052441581230996678.jpeg"
                  ...
                  />
                  <p>
                    Bốn đối tượng này sử dụng thủ thuật <strong>lừa đảo</strong>{" "}
                    bằng cách khiến nạn nhân của mình cài đặt một app trên
                    Android có tên Ad Manager for <strong>Facebook</strong> -
                    "Trình quản lý Quảng cáo cho Facebook". App này sẽ thu thập
                    những thông tin đăng nhập của người dùng một cách trái phép,
                    sau đó thậm chí truy cập tài khoản Facebook của nạn nhân và
                    bắt đầu tự chạy quảng cáo. Ở thời điểm hiện tại, app này đã
                    bị xóa khỏi Google Play.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Đáng chú ý hơn, bốn đối tượng này còn chạy quảng cáo cho ứng
                    dụng nhằm thực hiện thủ đoạn <strong>lừa đảo</strong> trực
                    tuyến. <strong>Facebook</strong> cho biết, theo thống kê của
                    họ thì số tiền mà nạn nhân bị thiệt hại lên tới 36 triệu
                    USD. <strong>Mạng xã hội</strong> lớn nhất thế giới cho biết
                    họ đã hoàn trả lại tiền cho nạn nhân và thực hiện các biện
                    pháp tăng cường bảo mật cho tài khoản của người dùng.
                  </p>
                  <ContentImage

                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      cuộc đời của Hoàng đế <strong>Ung Chính</strong> chứa
                      nhiều bí ẩn nhất. Về việc ông kế vị ngai vàng thế nào,
                      nguyên nhân cái chết đều là một bí ẩn lớn đối với hậu thế.
                      Đến nay, một phần những bí ẩn này đã được giải đáp qua một
                      tài liệu mật. Mọi người sau khi biết được không khỏi cảm
                      thán, chẳng trách ngay cả chính sử triều Thanh cũng không
                      dám lưu lại.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Căn cứ vào một hồ sơ mật của hoàng gia, tức sổ sách của
                      Nội chính bộ, có ghi chép lại một số nội dung về việc mua
                      bán trong cung. Đặc biệt có thể thấy, 5 năm trước khi{" "}
                    ...
                    <p>
                      ...
                      loại thuốc này, hơn nữa còn thưởng cho triều thần. Như
                      vậy, đáp án về cái chết của Hoàng đế Ung Chính đã có lời
                      đáp. Những viên tiên đan được tinh luyện này, bình thường
                      sẽ chứa hàm lượng kim loại lớn vượt quá ngưỡng cho phép,
                      thời gian sử dụng lâu dài sẽ trúng độc kim loại rồi dẫn
                      đến tử vong.
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Sau khi <strong>Ung Chính</strong> chết, Càn Long lên
                      ngôi. Là một đứa con hiếu thảo, ông đương nhiên không thể
                      để nguyên nhân cái chết của phụ vương lan truyền khắp
                      thiên hạ, cũng như bôi nhọ danh dự của Hoàng gia nên đã
                      tận lực che giấu sự thật. Khó trách những sử quan cũng
                      không dám ghi lại trong sử sách.
                    </p>
                    <ContentImage
                      src="https://kenh14cdn.com/thumb_w/620/203336854389633024/2021/7/22/-16269520850801595646324.jpg"

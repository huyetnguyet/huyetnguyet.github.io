                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      mang tên <strong>Esports</strong>. Vì thế, cũng như đá
                      bóng, điền kinh hay bơi lội… Esports được “đối xử" công
                      bằng như một môn học chính quy và được đào tạo bài bản, để
                      lớp game thủ sau khi tốt nghiệp sẽ có được kỹ năng nhất
                      định. Nhiều ngôi trường đã được mở ra dành riêng cho các
                      game thủ như vậy.
                    </p>
                    <h5>Trường Cao đẳng nghề tỉnh Sơn Tây (Trung Quốc)</h5>
                    <p>
                      Năm 2016 khi <strong>Esports</strong> mới bùng nổ, trường
                      Cao đẳng Sơn Tây đã mở một khóa bồi dưỡng vận động viên
                      thể thao điện tử nhằm đào tạo những tuyển thủ game chuyên
                      nghiệp. Đây cũng là ngôi trường có định hướng giảng dạy
                      game rất sớm.
                    </p>
                    <p>
                      3 tựa game được đào tạo chính ở đây là Liên Minh Huyền
                      Thoại, Overwatch và Hearthstone trong đó số học viên học
                      lớp LMHT là đông nhất. Song song với việc giảng dạy lý
                      thuyết là những giờ thực hành được tổ chức như những cuộc
                      thi đấu chuyên nghiệp thực sự giữa các học viên giúp họ có
                      trải nghiệm tốt nhất trong đấu trường chuyên nghiệp.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      50% là giảng dạy lý thuyết, phân tích các tựa game như
                      LOL, Overwatch, PUBG.
                    </p>
                    <p>
                      Không đơn thuần chỉ tập trung đào tạo kỹ năng chơi game,
                      sau năm học đầu tiên những người có tiềm năng sẽ tiếp tục
                      được đào tạo thành <strong>game thủ</strong> chuyên
                      nghiệp, các đối tượng khác sẽ được dạy những kĩ năng khác:
                      tổ chức các sự kiện game, quảng cáo…
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      việc ổn định trong tương lai. Họ có thể làm những công
                      việc liên quan đến game như phát triển trò chơi điện tử,
                      thành lập và tổ chức các sự kiện game, sáng tạo game, bình
                      luận viên, chuyên gia đào tạo… và tất nhiên là không thể
                      thiếu công việc là một tuyển thủ chuyên nghiệp.
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Dù cho đây là một ngành cạnh tranh gay gắt và không phải
                      ai cũng có được vinh quang nhưng vẫn có không ít người
                      quyết tâm theo đuổi niềm mơ ước của mình
                    </p>
                    ...
                    />
                    <p>
                      Đại học Chung Ang từng làm chấn động ngành giáo dục khi
                      xác nhận tuyển những sinh viên muốn theo đuổi con đường
                      thi đấu game chuyên nghiệp. Những người đã là{" "}
                    ...
                    />
                    <p>
                      Không quá nổi trội nhưng Malaysia cũng là một quốc gia có
                      sự quan tâm lớn cho nền công nghiệp game và Học viện{" "}
                      <strong>Esports</strong> chính là nơi Malaysia ươm mầm cho
                      những ước mơ của <strong>game thủ</strong>.
                    </p>
                    <p>
                      Tại học viện, các khóa học dài khoảng 8 tháng với 2 mức
                      học phí khác nhau dành cho sinh viên trong nước và quốc
                      tế. Theo học ở học viện, những sinh viên tốt nghiệp có cơ
                      hội việc làm cao nhờ việc học viện sẽ giới thiệu sinh viên
                      cho những đối tác của họ.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Dù ở các quốc gia khác nhau, mô hình và phương thức học
                      tập có thể mang tính đặc thù riêng thế nhưng đều giúp
                      những người yêu thích game có thể áp dụng những kiến thức
                      và nuôi lớn đam mê của mình.
                    </p>
                  </div>
                  <AdsHorizontal />
                </div>

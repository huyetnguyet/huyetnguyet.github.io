              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    chiếc smartphone, chúng có thể thỏa thích tìm kiếm, hòa mình
                    vào những cái tên như PUBG Mobile, Liên Quân Mobile hay Free
                    Fire. Tuy nhiên, đôi khi "dư thừa" quá lại khiến chúng ta
                    nhớ về thời xưa - về những hình ảnh, ký ức thời mà làng game
                    Việt vẫn còn sơ khai hơn bao giờ hết. Khi mà Internet hay
                    ADSL vẫn còn là thuật ngữ lạ tai, PC vẫn đang cài Win98 và
                    điện tử 4 nút là thú vui giải trí "nhà giàu" của những đứa
                    trẻ thời bấy giờ. Cùng lên chuyến xe du hành thời gian và về
                    lại làng game trong giai đoạn đấy nhé.
                  </p>

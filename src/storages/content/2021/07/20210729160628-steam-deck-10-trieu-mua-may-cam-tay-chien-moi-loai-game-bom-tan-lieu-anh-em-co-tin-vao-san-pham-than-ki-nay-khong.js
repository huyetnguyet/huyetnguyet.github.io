            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Sau nhiều thời gian đồn đoán kéo dài từ tháng 5 tới bây giờ,
                    Valve đã chính thức công bố tới các <strong>game</strong>{" "}
                    thủ một sản phẩm máy console cầm tay đáng để kỳ vọng có tên{" "}
                    <strong>Steam</strong> Deck. Lịch ra mắt của sản phẩm này là
                    cuối năm 2021, song những thông tin trước mắt đang làm{" "}
                    <strong>game thủ</strong> tỏ ra vô cùng thích thú và quan
                    tâm.
                  </p>
                  <ContentImage
                    src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/7/17/photo-1-16264933757941782750761.jpg"
                  ...
                  <p>
                    ...
                    <strong>game</strong> trên kho Steam cũng như nhiều tựa game
                    khác ở mọi lúc mọi nơi. Chúng ta cùng xem cấu hình chiếc máy
                    này có gì mà Valve lại tự tin đến thế nhé.
                  </p>
                  <p>
                    <strong>Steam</strong> Deck sử dụng hệ điều hành SteamOS do
                    Valve phát triển. Hệ điều hành này cho phép người chơi thoải
                    mái cài đặt ứng dụng từ bên thứ ba. Nghĩa là{" "}
                    <strong>game</strong> thủ có thể xoá hẳn SteamOS và cài đặt
                    hệ điều hành Windows hay những tựa game khác thay vì khoá
                    như hệ máy console/handheld của Sony, Microsoft, Nintendo.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    Playstation Portable, thì <strong>Steam</strong> Deck có cấu
                    hình vượt trội hơn hẳn. Chiếc máy này tự tin chiến được một
                    số những con <strong>game</strong> AAA hiện giờ nhưng với
                    cấu hình vừa đủ.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Điểm nội trội thứ hai phải kể đến việc mở khoá hoàn toàn cho{" "}
                    <strong>game</strong> thủ để có thể chơi các tựa game bên
                    ngoài <strong>Steam</strong>. Không chỉ Steam, người chơi có
                    thể tải game từ những cửa hàng khác như Epic Games Store,
                    Uplay,…
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Với những công năng của một chiếc PC di động như vậy bạn chỉ
                    cần bỏ ra 399USD (9.1 triệu vnđ) cho chiếc{" "}
                  ...
                  <p>
                    Trong tương lai, <strong>Steam</strong> Deck được dự báo sẽ
                    có xuất phát điểm khá cao và có khả năng soán ngôi nhiều thế
                    hệ máy đã dày dặn kinh nghiệm trước đó.
                  </p>
                </div>
              </div>

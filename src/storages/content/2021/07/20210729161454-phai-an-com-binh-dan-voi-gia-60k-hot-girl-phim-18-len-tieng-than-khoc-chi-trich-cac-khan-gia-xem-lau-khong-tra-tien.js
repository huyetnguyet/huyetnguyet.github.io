              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    thức vô cùng to lớn, mà cụ thể ở đây chính là ảnh hưởng của
                    dịch bệnh. Rất nhiều studio trở nên điêu đứng, trong khi đa
                    số các diễn viên, trừ những cô nàng{" "}
                    <strong>hot girl</strong> top đầu cũng đang liên tục phải
                    than trời về sự sụt giảm trong thu nhập cũng như chế độ của
                    mình. Điển hình như mới đây,{" "}
                  ...
                  />
                  <p>
                    Cụ thể, trên Twitter, Misashi đã phàn nàn về việc ngày càng
                    có nhiều bộ phim hạng A bị vi phạm bản quyền, qua đó trực
                    tiếp khiến cho doanh thu của ngành công nghiệp{" "}
                    <strong>AV</strong> Nhật Bản bị sụt giảm đáng kể. Điều này
                    vô hình chung cũng dẫn tới việc ngân sách để sản xuất, đầu
                    tư cho các tác phẩm mới cũng chẳng còn là bao nhiêu. Và theo
                    như Misashi chia sẻ, trong tác phẩm mới nhất này, cô thậm
                    chí còn không có chuyên gia trang điểm, phải tự làm lấy mọi
                    việc và tệ hơn, ngay cả suất cơm trưa trên phim trường cũng
                    đã bị hạ giá xuống chỉ còn 300 yên (khoảng 60.000 VND) - một
                    con số mà như nàng <strong>hot girl</strong> chia sẻ là
                  ...
                  />
                  <p>
                    Dành cho những ai chưa biết thì đa phần các diễn viên có tên
                    tuổi hoặc thuộc top đầu của ngành công nghiệp{" "}
                    <strong>AV</strong> Nhật Bản đều sẽ được hỗ trợ bữa trưa
                    ngay tại trường quay. Ở thời kỳ vàng son, đó thường là những
                    suất buffet thịnh soạn, nhưng giờ đây, như lời Misashi, nó
                    chẳng khác gì hộp cơm bình dân với mức giá ấy. Bảo sao cô
                    nàng tỏ ra bức xúc tới vậy.
                  </p>
                  ...
                  <p>
                    ...
                    tất cả mọi người muốn tạo ra một môi trường tốt, xem các tác
                    phẩm chất lượng cao, hãy mua các bộ phim <strong>AV</strong>{" "}
                    chính hãng, đừng xem lậu nữa" - Misashi bức xúc.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    mộ hưởng ứng và nhiều người thậm chí còn cảm thấy xót xa cho
                    cô nàng. Tuy nhiên, ở chiều ngược lại, cũng có không ít
                    người chê bai về việc nàng <strong>hot girl</strong> lên
                    tiếng than thở, khi cho rằng cô còn hạnh phúc hơn nhiều so
                    với những người đồng nghiệp kém may mắn chẳng có phim mà
                    đóng trong quãng thời gian này. Thực tế thì bức xúc của
                    Misashi cũng hợp lý, nhưng để chấm dứt thói quen "xem lậu"
                    từ phía các khán giả của ngành công nghiệp{" "}

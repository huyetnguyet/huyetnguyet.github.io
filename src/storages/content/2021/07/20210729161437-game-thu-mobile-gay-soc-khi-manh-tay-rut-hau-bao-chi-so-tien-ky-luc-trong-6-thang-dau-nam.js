            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Không hề thua kém <strong>game thủ</strong> PC hay console,
                    khả năng rút hầu bao chi tiền của người chơi{" "}
                    <strong>game mobile</strong> cũng “không phải dạng vừa đâu”.{" "}
                  </p>
                  <p>
                    Theo thông tin được tổ chức Sensor Tower tiết lộ, những{" "}
                    <strong>game thủ</strong> mobile trên khắp thế giới đã chi
                    đến 44,7 tỷ USD, tức hơn 1 triệu tỷ đồng trong vòng 6 tháng
                    đầu tiên của năm nay. Trong đó, những người sử dụng nền tảng
                    iOS chiếm phần lớn khi bỏ ra 26 tỷ USD, còn game thủ Android
                    chiếm phần còn lại.{" "}
                  </p>
                  <ContentImage
                    src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/7/7/photo-1-16256531735491340483581.jpg"
                  ...
                  <p>
                    ...
                    Android có nhiều cửa hàng ứng dụng khác nhau chia sẻ số tiền
                    này. Dù vậy đại đa số tiền của <strong>game thủ</strong>{" "}
                    Android vẫn được chi trên Google Play.
                  </p>
                  <p>
                    Mặc dù chi tiêu của người tiêu dùng trong các trò chơi trên
                    thiết bị di động đang tăng với tốc độ chậm hơn năm ngoái,
                    nhưng điều này không cho thấy sự suy thoái mà ngược lại, là
                    sự bình thường hóa sau sự gia tăng quan tâm trong những
                    trường hợp bất thường của đại dịch COVID-19.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Bên cạnh đó, một số liệu cho thấy, <strong>game thủ</strong>{" "}
                    là những người chịu chi nhất, hơn những đối tượng dùng
                    mobile khác. Cụ thể, toàn bộ số tiền mà người dùng Android
                    và iOS chi ra cho ứng dụng là gần 65 tỷ USD, có nghĩa là số
                    tiền họ bỏ ra cho game chiếm gần 69%.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Những tựa game được tải nhiều nhất trên các cửa hàng này là
                    Join Clash 3D, High Heels, Bridge Race, Among Us, Garena
                    Free Fire (thường được <strong>game thủ</strong> gọi vui là
                    “lửa chùa”)... Một số game khác của nhà phát hành Trung Quốc
                    Tencent cũng chiếm nhiều vị trí đầu trong bảng xếp hạng.
                    Những cái tên đáng chú ý khác bao gồm Pokemon Go, PUBG
                    Mobile, Roblox, Genshin Impact, Call of Duty: Mobile,…{" "}
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    rằng, nhiều bom tấn ra đời sẽ tiếp tục bòn rút túi tiền của{" "}
                    <strong>game thủ</strong>: Apex Legends Mobile, Pokemon
                    Unite, Diablo Immortal,…{" "}
                  </p>
                </div>
              </div>

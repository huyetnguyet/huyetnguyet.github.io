                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      phim họ xem. Dưới đây là 18 lỗi mà bạn có thể chưa từng
                      nhận thấy trước đây, nhưng khi bạn nhìn ra, bạn sẽ thấy
                      chúng là những lỗi khó có thể chấp nhận trong những bộ
                      phim nổi tiếng.
                    </p>
                    ...
                    <p>
                      ...
                      trong bộ ba phim The Lord of the Rings chúng lại có màu
                      đen.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Trong bộ phim "Chúa tể của những chiếc nhẫn: Sự trở lại
                      của nhà vua", một trong những chiếc cầu thang đột nhiên
                      biến mất cùng với Frodo.
                    </p>
                    <h5>Harry Potter</h5>
                    <ContentImage
                    ...
                    />
                    <p>
                      Đây không phải là ma thuật, những sợi dây đốt trong các
                      ngọn nến vẫn có thể nhìn thấy rõ ràng.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Trong cảnh này, Mary Jane trượt trên một ít nước trái cây
                      bị đổ, nhưng trong khung hình tiếp theo, vết đổ đã biến
                      mất. Chẳng nhẽ sàn nhà có thể tự làm sạch ư?
                    </p>
                    <h5>Star Trek</h5>
                    <ContentImage
                    ...
                    />
                    <p>
                      Đội trưởng Robau được nhìn thấy đeo huy hiệu Starfleet
                      nhưng ngay khi anh ta ngồi vào ghế của mình, huy hiệu kia
                    ...
                    />
                    <p>
                      Bạn có thể thấy rõ một sợi dây chạy dọc bên trong quần
                      jean của Bella.
                    </p>
                    ...
                    />
                    <p>
                      Chúng ta có thể thấy rõ dây an toàn của Đặc vụ K ở đây.
                    </p>
                    ...
                    <p>
                      ...
                      trên một câu chuyện có thật trong lịch sử. Tuy nhiên,
                      trong cảnh của một trận chiến kinh thiên động địa, một
                      trong những cỗ xe bị lật và bạn có thể thấy một bình khí
                      thời hiện đại được gắn phía sau nó.
                    </p>
                    <h5>Avengers</h5>
                    <ContentImage

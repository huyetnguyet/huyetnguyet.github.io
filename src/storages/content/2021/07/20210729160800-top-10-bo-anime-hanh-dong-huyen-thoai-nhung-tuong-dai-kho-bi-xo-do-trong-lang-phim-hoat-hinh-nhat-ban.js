              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    ...
                    <strong>Naruto</strong> từ lúc là 1 Genin đến khi trở thành
                    Hokage xứng đáng được coi là một bộ <strong>anime</strong>{" "}
                    kinh điển có tầm ảnh hưởng trên toàn thế giới. Series Naruto
                    có nhiều khoảnh khắc hài hước, những pha hành động hấp dẫn
                    và cũng có những cảnh buồn đến chảy nước mắt.
                  </p>
                  ...
                  <p>
                    ...
                    <strong>anime</strong> shonen kinh điển ảnh hưởng tới nhiều
                    tác phẩm khác. Không chỉ nhóm chiến binh Z được khán giả yêu
                    mến mà ngay cả dàn phản diện như Frieza hay Buu cũng đều
                    khiến các fan say mê.
                  </p>
                  <h5>3. Bleach</h5>
                  <ContentImage
                  ...
                  <p>
                    ...
                    tượng như chính nhân vật chính Kurosaki Ichigo. Thật tiếc là
                    bộ anime này đã không thể kết thúc với phần còn lại của câu
                    chuyện trong manga.{" "}
                  </p>
                  ...
                  <p>
                    ...
                    tuyệt vời, thường được trình bày dưới dạng một giải đấu giao
                    tranh liên quan đến con người và ma quỷ.{" "}
                  </p>
                  ...
                  <p>
                    ...
                    chuyện xoay quanh một chiến binh tên là Kenshiro, người được
                    kế thừa một môn phái võ thuật chết người được gọi là Hokuto
                    Shinken. Môn phái cho phép anh có khả năng giết chết đối thủ
                    bằng cách công kích vào các yếu huyệt của chúng. Phong cách
                    chiến đấu này thường khiến cho kẻ thù chết một cách dã man
                    và máu me. Kenshiro dành cả cuộc đời của mình để chiến đấu
                    chống lại nhiều băng đảng, kẻ cướp và lãnh chúa để bảo vệ
                    cuộc sống của những người vô tội không có khả năng tự vệ,
                    cũng như những người anh em và bạn bè chí cốt.
                  </p>
                  ...
                  />
                  <p>
                    Trong những năm qua, <strong>One Piece</strong> đã trở thành
                    tựa manga bán chạy số một tại Nhật Bản và{" "}
                    <strong>anime</strong> của nó cũng rất thành công. Ngay từ
                    đầu, Luffy và những người bạn của cậu ấy đã mang đến cho
                    chúng ta những pha hành động thú vị cùng những pha hài hước
                    khiến chúng ta bật cười. Bên cạnh đó cũng có những khoảnh
                    khắc có thể khiến người đàn ông nam tính nhất cũng phải bật
                    khóc.{" "}
                  </p>
                  <h5>8. Saint Seiya </h5>
                  <ContentImage
                  ...
                  />
                  <p>
                    Ra đời từ năm 1986, Saint Seiya luôn sánh vai cùng những bộ
                    manga nổi tiếng khác cùng thời như Doraemon, Dragon Ball,…
                    tại vị trí top những bộ truyện tranh bán chạy nhất. Câu
                    chuyện về nhóm Thánh đấu sĩ bảo vệ nữ thần Athena chống lại
                    các thế lực hắc ám cũng gặt hái thành công lớn ở nhiều nước
                    trên thế giới.
                  </p>
                  <h5>9. Hellsing</h5>
                  <ContentImage
                  ...
                  <p>
                    ...
                    phẩm này thu hút bởi cốt truyện độc đáo với dàn nhân vật thú
                    vị.
                  </p>
                  <h5>10. Berserk </h5>
                  <ContentImage
                  ...
                  <p>
                    ...
                    trong Berserk thậm chí còn trở thành nguồn cảm hứng cho trò
                    chơi Dark Souls.
                  </p>
                </div>
              </div>

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    <strong>Đường Tăng</strong>. Đầu tiên là Uông Việt , rồi đến{" "}
                    <strong>Từ Thiếu Hoa</strong> và cuối cùng là Trì Trọng Thụy
                    . Trong số 3 người, Từ Thiếu Hoa được khán giả tung hô là
                    "Đường Tăng đẹp trai nhất" do sở hữu visual nổi bật, ngũ
                    quan hài hòa và ánh mắt bay bổng. Thế nhưng có lẽ vì được
                    truyền thông ca tụng nên Từ Thiếu Hoa dần mắc bệnh "ngôi
                    sao", khiến đoàn phim Tây Du Ký phật ý.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    vọng. Ban đầu, Từ Thiếu Hoa cho biết ông phải dừng vai diễn{" "}
                    <strong>Đường Tăng</strong> của mình lại để theo đuổi con
                    đường học vấn. Thế nhưng sau đó, Mã Đức Hoa - người thủ vai{" "}
                    <strong>Trư Bát Giới</strong> trong Tây Du Ký đã bật mí sự
                    thật về màn bỏ vai của Từ Thiếu Hoa năm nào.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Vì có thời lượng không nhiều bằng và tạo hình tương đối đơn
                    giản, <strong>Từ Thiếu Hoa</strong> không được trả thù lao
                    cao bằng Mã Đức Hoa hay Lục Tiểu Linh Đồng . Theo Sohu,
                    lương mỗi tập của cặp đôi Tôn Ngộ Không -{" "}
                    <strong>Trư Bát Giới</strong> là 70 tệ (khoảng 250 nghìn
                    đồng), nhưng <strong>Đường Tăng</strong> chỉ được 60 tệ (hơn
                    213 nghìn đồng). Điều này khiến Từ Thiếu Hoa không bằng
                    lòng, sau đó ông vịn vào việc mình có nhiều đất diễn hơn
                    trong tập Nữ Nhi Quốc để đòi tăng cát-xê.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    (không đến 18 nghìn đồng). Thế nhưng Dương Khiết không đồng
                    ý nên <strong>Từ Thiếu Hoa</strong> quyết định bỏ vai. Thế
                    nhưng cũng có nhiều nguồn tin tiết lộ rằng thực chất "mẹ đẻ"
                    của phim Tây Du Ký đã tăng cát-xê tập đó của Từ Thiếu Hoa
                    lên 75 tệ, cao hơn cả Lục Tiểu Linh Đồng và Mã Đức Hoa. Tuy
                    nhiên sau cùng nam diễn viên vẫn lựa chọn rời dự án.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    yêu thích nhất nhưng <strong>Từ Thiếu Hoa</strong> chưa bao
                    giờ có động thái liên hệ với dàn cast{" "}
                    <strong>Tây Du Ký</strong>. Ông đều vắng mặt ở những lần tái
                    hợp, một phần có lẽ vì "quê độ" sau lời bộc bạch trên sóng
                    truyền hình của "lão Trư". Hiện tại, Từ Thiếu Hoa đã có gia
                    đình, nhưng trớ trêu hơn cả, ông vẫn thường hóa trang thành
                    Đường Tăng để đi hát kiếm tiền, chật vật để mưu sinh qua
                    ngày.
                  </p>
                  <p>

                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      một số cái tên có khi còn nổi bật hơn trong phim, lấn át
                      cả nhan sắc và khí chất của bạn diễn. Dưới đây là một số
                      vai nữ phụ cổ trang giúp diễn viên thủ vai "một phát lên
                      luôn" trong sự nghiệp.
                    </p>
                    <h5>
                    ...
                    />
                    <p>
                      <strong>Lưu Đào</strong> vào năm 24 tuổi đã trở thành nữ
                      phụ được săn đón nhất nhì Cbiz nhờ nhan sắc mặn mà, khỏe
                      khoắn trong <strong>Thiên Long Bát Bộ</strong>. Những
                      đường nét tự nhiên, sắc sảo giúp mỹ nữ 1979 tỏa sáng,
                      không hề bị lu mờ trước một nàng thơ trắng trẻo, ngây ngô
                      như Lưu Diệc Phi.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      <strong>Mị Nguyệt Truyện</strong>. Ban đầu, Mị Xu và em
                      gái Mị Nguyệt (Tôn Lệ) vô cùng yêu thương nhau trong cung.
                      Thế nhưng từ ngày hoàng đế chuyển sang sủng ái Mị Nguyệt,
                      Mị Xu bắt đầu sinh lòng ghen ghét, đố kỵ. Diễn xuất của
                      Lưu Đào năm đó được đánh giá là chín muồi, có sắc thái
                      riêng chứ không bị Tôn Lệ lấn át.
                    </p>
                    ...
                    <p>
                      Bộ phim "đại bạo"{" "}
                      <strong>Tam Sinh Tam Thế: Thập Lý Đào Hoa</strong> mang
                      đến chuyện tình đầy nước mắt của Dạ Hoa - Bạch Thiển nhưng
                      cũng mang đến cho khán giả một nữ phụ Phượng Cửu (
                      <strong>Địch Lệ Nhiệt Ba</strong>) quá đáng yêu. Sự hồn
                      nhiên, nhí nhảnh của "tiểu hồ ly" giúp Địch Lệ Nhiệt Ba
                      bật lên trên con đường diễn xuất, thậm chí còn có hẳn một
                      phần phim riêng là Tam Sinh Tam Thế: Chẩm Thượng Thư.
                    </p>
                    <h5>
                      3. Công chúa nhỏ Lạc Yên được khen nức nở không thua gì
                      chị lớn Trường Ca
                    </h5>
                    <ContentImage
                    ...
                    />
                    <p>
                      Ngay khi <strong>Trường Ca Hành</strong> chưa lên sóng,
                      phần đông khán giả đã xuýt xoa không thôi trước nét đẹp
                      thanh thuần của công chúa nhỏ Lạc Yên. Đây được xem là màn
                      vớt vát hình tượng đỉnh cao nhất thời gian gần đây khi{" "}
                      <strong>Triệu Lộ Tư</strong> lúc bấy giờ bị chỉ trích
                      không ngừng vì một màu, lại khoái "cọ nhiệt". Với tính
                      cách nhẹ nhàng, tốt bụng, Lạc Yên chính là giọt nước ấm
                      trong cuộc đại chiến sóng gió của Trường Ca Hành.
                    </p>
                    ...
                    <p>
                      ...
                      ra mắt và gây ra làn sóng tranh cãi lớn khi nữ chính Ân
                      Đào không thể hiện thành công hình ảnh của "đại mỹ nhân"
                      Dương quý phi. Trái lại, người xem lại ấn tượng sâu sắc
                      với cô nhạc kỹ thường hay múa hát để phục vụ hoàng đế và
                      các phi tần trong cung.Vai diễn của{" "}
                      <strong>Lý Niệm</strong> không chỉ là vũ nữ ca múa mà còn
                      là thân mẫu của nữ chính Dương quý phi. Thế nhưng so với
                      hình ảnh của Ân Đào, nhân vật của Lý Niệm được nhật xét có
                      phần trẻ đẹp, tươi tắn hơn gấp bội.
                    </p>
                    <h5>
                      5. Thuần phi với hình tượng "trở mặt" đáng gờm, không
                      thiếu phần xinh tươi ở Diên Hi Công Lược
                    </h5>
                    <ContentImage
                    ...
                    <p>
                      ...
                      hiền thục, nền nã cũng là vị nương nương khiến khán giả
                      nhớ mãi không quên trong{" "}
                      <strong>Diên Hi Công Lược</strong>. Ban đầu, sự thông minh
                      của Thuần phi đã không ít lần cứu mạng chị em phi tần. Về
                      sau, tình yêu bị cấm đoán của cô dành cho Phó Hằng (Hứa
                      Khải) đã khiến mỹ nhân an phận nhất Tử Cấm Thành "lật như
                      bánh tráng". Tuy không đi được đến giây phút cuối cùng
                      nhưng không thể phủ nhận, Thuần phi là một trong những
                      "đóa hoa" tuyệt sắc, có tính cách khó đoán thú vị của Diên
                      Hi Công Lược.
                    </p>
                    <h5>
                    ...
                    />
                    <p>
                      Ngay từ khi có những hình ảnh tạo hình đầu tiên của bom
                      tấn cung đấu <strong>Như Ý Truyện</strong>, fan đã "đặt
                      kèo", thậm chí "đổ cả gia tài" vào một cái tên vừa nhìn đã
                      thấy "nguy hiểm" - Gia phi Kim Ngọc Nghiên (
                      <strong>Tân Chỉ Lôi</strong>). Gia phi nương nương càng đi
                      sâu càng thu hút sự chú ý với những âm mưu thâm độc, cá
                      tính khác biệt và chiến tích dài như sớ vô cùng ấn tượng.
                      Thế nhưng, nhan sắc của "chiến thần Cao Ly" cũng là yếu tố
                      gây thương nhớ khi đậm chất Hàn Quốc, thậm chí còn được
                      khán giả gọi vui là "Jennie của Tử Cấm Thành".
                    </p>

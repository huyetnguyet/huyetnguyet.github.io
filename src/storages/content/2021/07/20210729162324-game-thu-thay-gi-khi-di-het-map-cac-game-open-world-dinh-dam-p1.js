              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    <strong>open world</strong> được giới thiệu là rộng lớn, tuy
                    nhiên, nó vẫn có những giới hạn nhất định. Vì thế để đối phó
                    với việc người chơi quá hiếu kỳ mà chạy đến cuối bản đồ, đội
                    ngũ phát triển game đã nghĩ ra rất nhiều thứ thú vị.
                  </p>
                  ...
                  />
                  <p>
                    Cách thức cổ điển và hữu hiệu trong mọi trường hợp là tạo ra
                    một bức tường vô hình để cản bước nhân vật tìm đến rìa bản
                    đồ. Tuy nhiên, cách này bị nhiều <strong>game</strong> thủ
                    đánh giá là nhàm chán, thiếu sáng tạo.
                  </p>
                  ...
                  <p>
                    ...
                    Row, Just Cause hay Crackdown, sẽ có thiết lập hòn đảo không
                    thể sử dụng thuyền bè. Nếu sử dụng thuyền, chúng sẽ đắm ngay
                    lập tức hoặc bị lật nếu người chơi cố chạy đi xa.
                  </p>
                  ...
                  <p>
                    ...
                    điểm rìa bản đồ như vậy rất hợp lý, vì sẽ chẳng ai thắc mắc
                    vì sao dưới vực thẳm lại có nhiều sinh vật kỳ quái, hung dữ
                    như vậy sinh sống.
                  </p>
                  ...
                  <p>
                    ...
                    chuyển ngay lập tức quay trở lại vùng thực hiện nhiệm vụ của
                    bản đồ mà không cần lý do giải thích.
                  </p>
                  ...
                  <p>
                    ...
                    thấy dễ chịu và bớt "giả trân" hơn so với bức tường vô hình.
                    Nhà sản xuất thường tạo ra một vách đá hoặc thung lũng cao,
                    khiến người chơi không thể vượt qua được, gần giống với ý
                    tưởng về vực sâu không đáy dưới đại dương.
                  </p>
                  ...
                  <p>
                    ...
                    Minecraft do cộng đồng tham gia tạo dựng nên mức độ rộng lớn
                    hơn hẳn các tựa game <strong>open world</strong> khác, đến
                    mức nhiều người nhầm tưởng nó là vô tận. Tuy nhiên,
                    Minecraft vẫn có giới hạn và nó được gọi là Far Lands.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Có điều là giới hạn này cũng không thật sự nghiêm ngặt lắm,
                    vì nhiều người vẫn có thể vượt qua giới hạn được lập ra để
                    tiếp tục khám phá thế giới.
                  </p>
                  ...
                  />
                  <p>
                    Skyrim và Oblivion có lẽ là những trò chơi mà người chơi có
                    thể tìm đến tận rìa thế giới một cách khá dễ dàng. Tuy

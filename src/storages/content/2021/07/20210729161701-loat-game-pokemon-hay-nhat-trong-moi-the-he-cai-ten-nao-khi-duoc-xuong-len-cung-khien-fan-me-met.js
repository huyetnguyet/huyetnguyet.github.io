                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      Hiện tại, không ít fan đang mong chờ về loạt game thuộc
                      thế hệ thứ 9.
                    </p>
                    <p>
                      Theo truyền thống, mỗi thế hệ game{" "}
                      <strong>Pokémon</strong> sẽ được Nintendo và Game Freak
                      cho ra mắt từ hai đến ba phần với những tên gọi khác nhau.
                      Chính vì vậy mà ta hãy điểm qua những ấn phẩm hay nhất,
                      tính theo mỗi thế hệ nhé!
                    </p>
                    <h5>
                    ...
                    <p>
                      ...
                      <strong>Pokémon</strong> ra mắt, với Red and Blue. Ngay
                      sau đó, người chơi còn đón chào thêm cả phần game Yellow,
                      với điểm nhấn như Charizard có thể học cách bay lượn cũng
                      như Pikachu không thể tiến hóa như anime.
                    </p>
                    <p>
                    ...
                    />
                    <p>
                      Tiếp đến sẽ là thế hệ 3, ra mắt với{" "}
                      <strong>Pokémon</strong> Ruby and Sapphire. Với nhiều
                      người, tựa game đã đem đến hai Pokémon huyền thoại được
                      đánh giá rất tốt gồm Kyogre và Groudon, so với các nhóm
                      Aqua và Magma không quá nổi bật. Tuy vậy, thế hệ này còn
                      có một phiên bản tổng hòa những điểm mạnh từ Ruby và
                      Sapphire, <strong>Pokémon Emerald</strong>.
                    </p>
                    <p>
                      Với trọng tâm là Rayquaza, <strong>Pokémon</strong> được
                      yêu thích nhất thế hệ 3 cùng với điểm nhấn như Battle
                      Frontier. Thêm vào đó còn là nhiều Pokémon hơn so với hai
                      ấn bản trước.
                    </p>
                    <h5>
                    ...
                    />
                    <p>
                      Đối với nhiều người chơi, <strong>Pokémon</strong>{" "}
                      Platinum được đánh giá là phiên bản xuất sắc nhất thuộc
                      thế hệ thứ 4. Phần game có một cốt truyện hay, điểm nhấn
                      Pokémon huyền thoại Giratina và Distortion World. Kết hợp
                      với đồ họa được chăm chút tỉ mỉ, lên đến giới hạn cuối
                      cùng cho phần cứng của hệ máy Nintendo DS lúc bấy giờ. Các
                      Pokémon như Gliar, Electivire và Magmortar đều là những
                      điểm nhấn thú vị.
                    </p>
                    <h5>
                    ...
                    <p>
                      ...
                      đồ họa, gameplay và cốt truyện thú vị mặc dù gây ra không
                      ít tranh cãi giữa cộng đồng fan về chất lượng tổng thể.
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Cả hai phần Black and White đều cân tài cân sức, khi
                      Zekrom để lại ấn tượng hơn Reshiram. Trong khi đó, bối
                      cảnh bên phần White như thành phố Opelucid tốt hơn người
                      anh em của mình.
                    </p>
                    <h5>
                    ...
                    <p>
                      ...
                      thêm yếu tố về hệ thần tiên thông qua X and Y. Điều đặc
                      biệt là đội ngũ sản xuất lại quyết định chỉ đưa yếu tố
                      thần tiên vào đúng một trong hai Pokémon huyền thoại tại
                      vùng Kalos. Kẻ được chọn chính là Xerneas (X), Pokémon hệ
                      thần tiên và bóng tối.
                    </p>
                    <p>
                      Trong khi đó, Yveltal chỉ mang hệ bóng tối và bay lượn mà
                      đã quá đỗi bình thường với người chơi. Cả hai phần game
                      đều có ngoại cảnh và câu chuyện thú vị, nhưng{" "}
                    ...
                    <p>
                      ...
                      lại là <strong>Pokémon</strong> Ultra Sun and Ultra Moon
                      với dàn Ultra Beast. Quả thực Ultra Beast là một chi tiết
                      cực kỳ mới mẽ, khi dàn Pokémon này du hành từ chiều không
                      gian khác, qua đó có thiết kế đặc biệt hơn những Pokémon
                      còn lại.
                    </p>
                    <p>
                      Nhiều nhận định cho rằng phần Ultra Sun được đánh giá cao
                      hơn về cả nội dung lẫn <strong>Pokémon</strong> huyền
                      thoại như Solgaleo.
                    </p>
                    <h5>
                    ...
                    />
                    <p>
                      Cái tên cuối cùng góp mặt trong danh sách lần này sẽ là
                      thế hệ 8 với <strong>Pokémon</strong> Sword and Shield.
                      Tuy rất được mong chờ và có những sáng tạo thú vị như là
                      khu vực hoang dã, nhưng lại không nhận về đánh giá tích
                      cực vì ít có sự thay đổi hoặc cải tiến so với những phiên
                      bản tiền nhiệm.
                    </p>
                    <p>

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    <strong>MacBook</strong> thì lựa chọn đầu tiên không thể bỏ
                    qua dòng XPS của Dell. Lớp vỏ hợp kim nhôm nhiều màu sắc để
                    lựa chọn có độ mỏng chỉ 14mm, nhẹ 1,2kg, cộng thêm viền màn
                    hình siêu mỏng nữa nên độ di động của XPS 13 9300 là “khỏi
                    bàn”.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    hoàn toàn đủ sức cân tốt các tác vụ văn phòng, giải trí nhẹ
                    nhàng.
                  </p>
                  <p>
                    ...
                    <strong>laptop</strong> của Lenovo sẽ thấy khác một trời một
                    vực, gõ sướng tay hơn nhiều.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    hình sáng đẹp, viền mỏng, thiết kế sang chảnh từng chi tiết
                    và cấu hình mạnh mẽ đời mới.
                  </p>
                  <p>
                    Nói về <strong>laptop</strong> Windows cao cấp thì không thể
                    bỏ qua Surface Laptop 4. Dòng máy này có màn hình cảm ứng
                    lớn 13.5 inch sáng đẹp sắc nét, thiết kế là lạ nhìn là “mê
                    mẩn” với nắp kim loại nhám và bàn phím phủ vải mềm mại.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    nàng nào có nhu cầu chỉnh sửa hình ảnh, video bên cạnh công
                    việc chính thì không nên bỏ qua.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Nếu ngoài công việc văn phòng và giải trí đơn giản như xem
                    phim, các nàng còn có hoa tay, thích vẽ vời thì một chiếc{" "}
                    <strong>laptop</strong> 2-in-1 với màn hình cảm ứng xoay lật
                    360 độ kèm bút cảm ứng như Spectre X360 chính là “chân ái”.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    <strong>laptop</strong> khác, kể cả <strong>MacBook</strong>
                    .
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Bên cạnh đó, máy cũng có cấu hình mạnh để làm việc thoải mái
                    hơn. Nàng nào hay phải đi ra ngoài cũng sẽ thấy yên tâm vì
                    máy chỉ nhẹ đúng 1,3kg thôi.
                  </p>
                </div>
              </div>

                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      hoàng nội y" đưa người hâm mộ đi từ bất ngờ này đến bất
                      ngờ khác khi có đến 1001 cách để trưng trổ đường cong gắt
                      như đường đua.
                    </p>
                    <p>
                      Hết thả dáng bên dưới hồ bơi trong "lâu đài" mới của Vũ
                      Khắc Tiệp, <strong>Ngọc Trinh</strong> tiếp tục dùng đạo
                      cụ là siêu xe gần 10 tỷ đồng "sống ảo". Đầu tư nhất, "Nữ
                      hoàng nội y" thiết kế riêng 1 bộ bikini cùng màu siêu xe
                      và cắt xẻ táo bạo khiến dân tình toát mồ hôi thay vì sợ sơ
                      hở 1 chút sẽ lộ điểm nhạy cảm ngay và luôn.
                    </p>
                    <p>
                      Để màn khoe body thêm đặc sắc, <strong>Ngọc Trinh</strong>{" "}
                      đã mượn trend "con gái miền Tây" biến hình đang hot trên
                      TikTok. Nhìn "cô Thắm" Ngọc Trinh thay đổi trong 1 nốt
                      nhạc mà netizen muốn ngất ngang vì quá sexy. Chỉ với clip
                      24 giây thôi mà "Nữ hoàng nội y" như mở 1 bữa tiệc khoe
                      visual và 3 vòng ngồn ngộn gây choáng ngợp.
                    </p>
                    ...
                    <p>
                      ...
                      <strong>Ngọc Trinh</strong> hoá "cô Thắm" miền Tây dịu
                      dàng quá...
                    </p>
                    <p>
                      Ai ngờ vài giây sau, "Nữ hoàng nội y" đã xuất hiện quyền
                      lực bên con siêu xe 10 tỷ. Động tác bước ra khỏi xế xịn
                      thôi mà <strong>Ngọc Trinh</strong> cũng uốn éo vài "đường
                      quyền" để khoe đường cong
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      <strong>Ngọc Trinh</strong> sở hữu lưng trần "cực phẩm",
                      mỗi lần lắc lư đều khiến dân tình "say theo điệu nhạc
                      chất". Nhưng 1 bộ phận netizen cũng thót tim vì lo lắng
                      người đẹp Trà Vinh sẽ lộ điểm nhạy cảm vì bộ bikini cắt xẻ
                      quá táo bạo
                    </p>
                    <ContentImage

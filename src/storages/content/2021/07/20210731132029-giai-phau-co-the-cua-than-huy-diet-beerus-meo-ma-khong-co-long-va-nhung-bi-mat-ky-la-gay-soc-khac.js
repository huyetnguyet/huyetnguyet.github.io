              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    <strong>Thần hủy diệt</strong> của thế giới đa vũ trụ trong{" "}
                    <strong>Dragon Ball Super</strong>. Trong số nhiều vị thần
                    trong <strong>vũ trụ 7</strong>, <strong>Beerus</strong> là
                    vị thần đáng sợ nhất. Là vị thần của sự hủy diệt, ông được
                    giao nhiệm vụ duy trì sự cân bằng trong vũ trụ. Sự phá hủy
                    là cần thiết để tạo ra hành tinh mới, nhưng ông không hành
                    động theo lệnh của Zeno hay Đại Thiên Sứ, ông phá hủy theo ý
                    thích của mình.
                  </p>
                  <p>
                    Tuy có sức mạnh đáng sợ là vậy tuy nhiên{" "}
                    <strong>Beerus</strong> là một người hòa đồng và hài hước,
                    điều này càng khiến nhiều khán giả thích thú hơn khi ông ta
                    có bề ngoài khá "tấu hài. Không những thế cơ thể của ông còn
                    có rất nhiều những điểm kỳ lạ.
                  </p>
                  <h5>
                  ...
                  />
                  <p>
                    Dù là mèo nhưng <strong>Beerus</strong> không có lông, điều
                    này là do thiết kế của ông dựa trên một giống mèo cụ thể. Về
                    mặt tính cách, Beerus được mô phỏng theo Cornish Rex của
                    người sáng tạo Akira Toriyama, nhưng thiết kế hình ảnh của
                    ông dựa trên loài mèo Sphynx.
                  </p>
                  <p>
                    ...
                    màu lông của chúng và loại hoa văn nếu có. Giống mèo Sphynx
                    cũng phù hợp với biểu tượng Ai Cập mà các vị{" "}
                  ...
                  />
                  <p>
                    Thiết kế của <strong>Beerus</strong> dựa trên các vị thần Ai
                    Cập Anubis và Sekhmet. Sekhmet là nữ thần chữa bệnh của Ai
                    Cập, có nhiệm vụ bảo vệ các Pharaoh và dẫn dắt họ vào trận
                    chiến. Cô ấy có đầu của một con sư tử cái, giống với hình
                    dạng đầu của Beerus. Cô cũng sẽ thực hiện hình phạt thần
                    thánh, thường là dưới hình thức hủy diệt và bệnh dịch, giống
                    như vị trí mà Beerus đang đảm nhiệm.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Còn Anubis là vị thần cầm đầu chó rừng trông coi người chết
                    và quá trình ướp xác. Trong Underworld, Anubis sẽ thực hiện
                    phán xét linh hồn của một người bằng cách sử dụng một chiếc
                    cân và một chiếc lông đà điểu. Với tư cách là{" "}
                    <strong>Thần hủy diệt</strong>, điều này phù hợp với mô tả
                    công việc của <strong>Beerus</strong>, đối với một người khi
                    ông đánh giá liệu thứ gì đó có phải là mối đe dọa đối với
                    trật tự của vũ trụ hay không.
                  </p>
                  <h5>
                  ...
                  <p>
                    ...
                    tinh trong <strong>Dragon Ball Super</strong>. Bản thân Whis
                    cũng đã thừa nhận rằng, Beerus có thể phá hủy toàn bộ hệ Mặt
                    Trời mà không gặp rắc rối gì.
                  </p>
                  <p>
                    Ngay cả các Kai tối cao cũng đồng tình với tuyên bố của Whis
                    về sức mạnh của <strong>Beerus</strong>. Trên thực tế, người
                    ta nói rằng chỉ một cái hắt hơi của ông cũng đủ để phá hủy
                    một hành tinh.
                  </p>
                  <h5>
                  ...
                  <p>
                    ...
                    ta bắt đầu tỏa ra một luồng năng lượng hủy diệt. Năng lượng
                    này có sức mạnh xóa bỏ mọi thứ khỏi sự tồn tại. Những thứ
                    duy nhất có thể phá hủy nó là những sinh vật thần thánh khác
                    và đôi cánh vô hiệu hóa của con chim Tokitoki.
                  </p>
                  <p>
                    ...
                    Năng lượng Hủy diệt cũng có thể được sử dụng phòng thủ bằng
                    cách tạo ra một hàng rào bảo vệ.
                  </p>
                  <h5>
                  ...
                  <p>
                    ...
                    nhỏ bé nhưng ông còn mạnh hơn người anh em song sinh Champa
                    béo tốt của mình. Sự thật này đã được xác nhận bởi Vados vì
                    thế rõ ràng ngoại hình không thể nói nên điều gì. Trong khi
                    cả hai anh em đều là <strong>Thần hủy diệt</strong>, Champa
                    không có sức chịu đựng hay khả năng phục hồi như Beerus,
                    điều này thể hiện trong cuộc thi oẳn tù tì giữa hai người
                    khi Champa phàn nàn rằng tay ông bắt đầu bị đau trong khi
                    Beerus vẫn ổn.
                  </p>
                  <p>
                    Không những thế dù thân hình bé nhỏ nhưng{" "}
                    <strong>Beerus</strong> có thể hấp thụ lượng thức ăn khổng
                    lồ, khi sự thèm ăn của ông trỗi dậy thì nó có sánh ngang cả
                    với Goku. Bên cạnh đó Beerus còn có sở thích ngủ trưa kéo
                    dài hàng năm trời mà không cần ăn uống bất cứ thứ gì.
                  </p>
                </div>
              </div>

                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      <strong>Thần của người Saiyan</strong> thông qua 1 nghi
                      thức với 5 người Saiyan có trái tim thuần khiết khác.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      khác, mặc dù có 1 người vẫn còn đang nằm trong bụng mẹ.
                      Goku sau đó đã sử dụng hình dạng{" "}
                      <strong>Super Saiyan God</strong> của mình để chiến đấu
                      với Beerus.
                    </p>
                    <ContentImage
                      src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/7/20/photo-1-16267746209691819938455.jpg"
                    ...
                    />
                    <p>
                      Sau một thời gian dài huấn luyện dưới sự hướng dẫn của
                      Whis, Goku có thể biến thành{" "}
                      <strong>
                        Super <strong>Saiyan</strong> God
                      </strong>{" "}
                    ...
                    <p>
                      ...
                      đào tạo đủ để sử dụng Super Saiyan God và Super Saiyan
                      Blue thay thế cho nhau để lấp đầy những khuyết điểm của
                      từng dạng biến đổi này.
                    </p>
                    <ContentImage
                    ...
                    <h5>3. Trunks Xeno</h5>
                    <p>
                      Xeno Trunks là phiên bản Trunks của một dòng thời gian
                      khác, nơi Trunks tham gia đội Tuần tra Thời gian. Xeno
                      Trunks biến thành{" "}
                      <strong>
                        Super <strong>Saiyan</strong> God
                      </strong>{" "}
                    ...
                    />
                    <p>
                      Theo <strong>Black Goku</strong> trong phiên bản manga,
                      nếu dân tộc <strong>Saiyan</strong> ngay từ đầu đã có linh
                      khí của một vị thần và biến thành Super Saiyan thì anh ta
                      có thể biến thành phiên bản{" "}
                      <strong>Super Saiyan God</strong> Super Saiyan của Black
                      Goku. Dạng này sau đó được Black Goku đặt cho cái tên là
                      Super Saiyan Rose, một dạng Super Saiyan có cấp độ tương
                      đương với Super Saiyan Blue và chắc chắn mạnh hơn Super
                      Saiyan God.
                    </p>
                    <h5>5. Yamoshi</h5>
                    <p>
                    ...
                    />
                    <p>
                      Dựa trên câu chuyện truyền lại, Yamoshi không chỉ có thể
                      trở thành Super <strong>Saiyan</strong> mà còn từng biến
                      thành <strong>Super Saiyan God</strong> với sự giúp đỡ của
                      năm người bạn Saiyan của mình, để chiến đấu chống lại
                      những gã Saiyan độc ác. Tức là Yamoshi không chỉ là người
                      có thể biến thành Super Saiyan đầu tiên mà còn là Super
                      Saiyan God đầu tiên.
                    </p>
                  </div>
                  <AdsHorizontal />

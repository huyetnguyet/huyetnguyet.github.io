                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      là khoảng sân phía trước và xung quanh nhà, chủ nhà đã
                      quyết định mua căn villa này ngay lập tức mà không suy
                      nghĩ nhiều.
                    </p>
                    <p>
                      Ngoài ra, dự án <strong>khu đô thị</strong> Park City còn
                      có cơ sở hạ tầng đồng bộ và đầy đủ tiện ích nên rất phù
                      hợp với các gia đình có con nhỏ. Vị trí thuận lợi không
                      quá xa trung tâm cũng tạo điều kiện cho việc di chuyển
                      nhanh chóng, dễ dàng.
                    </p>
                    <p>
                      <strong>Kiến trúc sư</strong> đã chọn phong cách Wabi Sabi
                      để giúp cho căn <strong>villa</strong> có 1 tấm áo giản
                      đơn, không khoa trương nhưng đầy tinh tế. Sản sinh từ Nhật
                      Bản, phong cách này hướng con người tới sự tối giản, bình
                      yên và trân trọng vẻ đẹp không hoàn hảo. Vì vậy, tông màu
                      chính của ngôi nhà là màu gỗ tự nhiên, màu trắng ghi của
                      tường và sự mộc mạc của gạch, đá - tất cả đều hướng tới
                      tinh thần thô mộc và giản đơn của Wabi Sabi.
                    </p>
                    <p>
                      Điểm đắt giá nhất trong ngôi nhà là khoảng thông tầng
                      trong không gian phòng khách - bếp, được điểm xuyến bằng
                      những chiếc mái vòm cong cao và những mảng kính lớn. Thiết
                      kế này giúp lấy sáng cho cả không gian chính, ngồi trong
                      nhà còn có thể nhìn ra khoảng sân đầy nắng và cây xanh để
                      tận hưởng cảm giác thư thả, yên bình. Sofa lớn trong phòng
                      khách có kiểu dáng thấp nên có thể ngả lưng hay lăn lộn
                      một cách thoải mái.
                    </p>
                    <p>
                      Khu vực bếp nổi bật với tone màu xanh cốm. Màu sắc này vừa
                      mang đến cảm giác mát mẻ cho không gian, đồng thời cũng
                      tạo điểm nhấn đẹp cho khu bếp. Vì vậy, phòng khách - bếp
                      là khu vực được đầu tư và tâm đắc nhất trong nhà. Nó hội
                      tụ đủ yếu tố để trở thành{" "}
                      <strong>không gian sinh hoạt</strong> chung lý tưởng: vừa
                      chan hoà ánh sáng và nắng gió, lại có trần cao rất rộng và
                      thoải mái.
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Không gian phòng ngủ master liên thông với khu vực phòng
                      xem phim để tiện cho việc sinh hoạt và nghỉ ngơi, thư giãn
                      của gia đình. Ở phòng WC master, <strong>bồn tắm</strong>{" "}
                      lớn được đặt bên khung cửa sổ bằng kính với những chậu cây
                      xanh để tạo cảm giác thư giãn, thoải mái.
                    </p>
                    <p>
                      Vì Wabi Sabi tôn vinh vẻ đẹp tự nhiên, thô mộc không mài
                      giũa nên hầu như <strong>đồ nội thất</strong> trong nhà
                      đều được làm từ những vật liệu như gỗ mộc, mây tre và đá.
                      Vì vậy, không gian toát lên sự hài hoà, giản đơn nhưng vẫn
                      có sức hấp dẫn riêng có.
                    </p>
                    <p>
                    ...
                    />
                    <p>
                      Nguồn: LukLak Design VN (ĐVTK) Meta Architecture (ĐVTC)
                    </p>
                  </div>
                  <AdsHorizontal />
                </div>

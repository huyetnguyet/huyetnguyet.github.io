              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    ...
                    <strong>phòng làm việc</strong> cũng được đập bỏ và thay thế
                    bằng hệ cửa kính. <strong>Không gian sinh hoạt</strong>{" "}
                    chung hiện tại rộng rãi tới mức có thể chứa được 20 người.
                  </p>
                  <p>
                    ...
                    <strong>phòng làm việc</strong>, tạo cảm giác thông thoáng.
                    Phòng làm việc cạnh cửa sổ được bố trí thêm khu vực nghỉ
                    ngơi, có thể kê gối để làm nơi thư giãn và đọc sách.
                  </p>
                  <p>
                    Bức tường ở khu vực <strong>bàn làm việc</strong> được sơn
                    màu xanh lá cây đậm để mang lại cảm giác thư thái. Phía bên
                    phải là giá sách, với các ngăn lưu trữ và cây xanh được đặt
                    so le trông rất gọn gàng, ngăn nắp và cũng phù hợp để trang
                    trí.
                  </p>
                  <p>
                    Cả 2 vợ chồng đều yêu thích phong cách công nghiệp. Vì vậy,
                    tường được sơn màu trắng và kết hợp với hệ đèn chiếu đơn
                    giản nhưng vẫn cung cấp đủ ánh sáng. Ngoài ra, bức tường
                    chính của phòng khách được làm bằng gạch đỏ cũ tạo cảm giác
                    hoài niệm.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Bàn ăn được kết nối với bức tường ốp gạch màu xanh lam. Hệ
                    thống chiếu sáng gồm đèn chùm 3 màu: đỏ, xám và xanh lá cây,
                    kết hợp với đèn chiếu điểm giúp cải thiện tâm trạng.
                  </p>
                  <p>
                    <strong>Phòng ngủ</strong> được bố trí 1 tủ gỗ cửa lùa với
                    kính xám. Giường được đặt trên sàn gỗ nâng cao mang{" "}
                    <strong>phong cách Nhật Bản</strong>. Và vì chiều cao chênh
                    lệch, sàn gỗ cũng có thể được sử dụng như một mặt phẳng để
                    gấp quần áo.
                  </p>
                  <ContentImage
                    src="https://kenh14cdn.com/thumb_w/660/203336854389633024/2021/7/26/d8f1c7616dc340199051e9ca7eb39097-16272931491721888550257.jpeg"

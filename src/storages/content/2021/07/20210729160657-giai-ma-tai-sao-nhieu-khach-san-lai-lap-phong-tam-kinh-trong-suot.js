                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    <p>
                      ...
                      tiên hẳn là căn phòng này thật rộng và sạch sẽ. Bởi đó
                      chính là hiệu ứng thị giác mà phòng tắm kính trong suốt
                      này mang lại.
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Hơn nữa, trên thực tế, để tối đa hóa hiệu quả sử dụng diện
                      tích của cả tòa nhà, các <strong>khách sạn</strong> lựa
                      chọn làm <strong>phòng tắm</strong> trong suốt để vừa cắt
                      giảm diện tích căn phòng càng nhiều càng tốt, vừa đảm bảo
                      được sự thoải mái cho khách hàng. Xây tường gạch truyền
                      thống chắc chắn tốn ít không gian hơn so với vách kính
                      rồi.
                    </p>
                    ...
                    />
                    <p>
                      Ánh sáng ban ngày chiếu vào kính{" "}
                      <strong>phòng tắm</strong> phản xạ lại và có thể giúp căn
                      phòng trở nên sáng sủa mà không cần đến bóng đèn điện. Lắp
                      phòng tắm bằng <strong>kính trong suốt</strong> vừa hiện
                      đại, sang trọng hơn mà lại giúp tận dụng ánh nắng mặt
                      trời, tiết kiệm năng lượng. Khách hàng không sử dụng tới
                      đèn điện, phải chăng <strong>khách sạn</strong> đã đỡ tốn
                      một khoản chi phí cho hóa đơn tiền điện đó hay sao?
                    </p>
                    ...
                    <p>
                      ...
                      thường là các doanh nhân. Khi vào{" "}
                      <strong>phòng tắm</strong>, họ có không gian riêng, cách
                      biệt với thế giới bên ngoài. Tiếng nước chảy rất ồn, át đi
                      mọi âm thanh khác, tăng thêm phần cách biệt.
                    </p>
                    <p>
                      ...
                      <strong>kính trong suốt</strong>, ít nhất bạn cũng có thể
                      có thêm thời gian để nhận biết tình hình và biết đâu thoát
                      khỏi tình huống xấu.
                    </p>
                    <p>

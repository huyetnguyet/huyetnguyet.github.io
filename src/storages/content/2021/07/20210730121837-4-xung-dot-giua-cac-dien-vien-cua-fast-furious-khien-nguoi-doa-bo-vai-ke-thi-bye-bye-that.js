              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    năm 2001 và cho đến nay <strong>The Fast Saga</strong> đã có
                    tới 9 phim được sản xuất. Tất nhiên, loạt "Fast & Furious"
                    cũng chứng kiến nhiều sự ra đi - trở lại của các nhân vật và
                    cũng không thể thiếu sự xung đột giữa các diễn viên.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    là phần thứ hai trong chuỗi phim Fast & Furious với tên gọi
                    Fast And Furious 2: 2 Fast 2 Furious, ngoài Paul Walker thì
                    toàn bộ diễn viên đều được thay mới.
                  </p>
                  <ContentImage
                    src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/7/29/photo-1-16275643825141972207601.jpg"
                  ...
                  <p>
                    ...
                    kịch phải viết lại kịch bản cũng như tạm hoãn lại thời gian
                    bấm máy.
                  </p>
                  <p>
                    Việc <strong>Vin Diesel</strong> không xuất hiện trong phần
                    2 cũng có lý do của nó. Đó là do anh ấy gặp vấn đề với kịch
                    bản của bộ phim này, nên kiên quyết không muốn đóng vai của
                    mình trong bộ phim thứ hai mặc dù được đề nghị trả mức thù
                    lao cao.
                  </p>
                  <p>
                    May mắn là <strong>Vin Diesel</strong> đã xuất hiện ở phần
                    cuối của phần phim thứ ba - Tokyo Drift và đã hoạt động trở
                    lại kể từ phần phim thứ tư.
                  </p>
                  <h5>
                  ...
                  <p>
                    ...
                    <strong>The Rock</strong> bắt đầu từ khi nào, nhưng lần đầu
                    tiên cả 2 lên tiếng bóng gió về đối phương là vào tháng
                    8/2016, thời điểm Fast 8 đang trong giai đoạn cuối của quá
                    trình bấm máy.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Khi đó, <strong>The Rock</strong> đã đăng tải trên Instagram
                    (hiện đã xóa bỏ) bài viết với nội dung có cụm từ "hèn nhát"
                    (Candy-asses) gây chú ý trong cộng đồng người hâm mộ. Và ai
                    cũng ngầm hiểu anh đang hướng mũi giáo đến{" "}
                  ...
                  <p>
                    ...
                    giản chỉ là bất đồng quan điểm cá nhân, vì mỗi người có một
                    lý tưởng riêng mà thôi. Tuy nhiên, mọi chuyện không kết thúc
                    êm đẹp như vậy, bởi nam diễn viên còn tiết lộ anh và Diesel
                    không hề ghi hình chung trong F8.
                  </p>
                  <h5>
                    3. <strong>The Rock</strong> và Tyrese Gibson
                  </h5>
                  <p>
                    <strong>Tyrese Gibson</strong> đã từng thể biểu lộ tức giận
                    với Dwayne “<strong>The Rock</strong>” Johnson vì tách riêng
                    thực hiện Hobbs And Shaw, phần ngoại truyện của Fast and
                    Furious mà The Rock đóng chính cùng Jason Statham, đặc biệt
                    là kể từ khi phần ngoại truyện này dẫn tới việc Fast and
                    Furious 9 bị hoãn công chiếu một năm. Thậm chí Gibson còn
                    nói rằng anh sẽ không tham gia Fast and Furious 9 trừ khi
                    Johnson bị loại khỏi bộ phim.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    phim này dù cả hai đã mất liên lạc. Tuy nhiên mới đây Tyrese
                    Gibson cho biết cả hai đã làm hòa và quay lại nói chuyện
                  ...
                  <p>
                    Michelle Rodriguez là diễn viên thủ vai nữ chính Letty Ortiz
                    trong <strong>The Fast Saga</strong>. Tuy nhiên, cô đã từng
                    phàn nàn và dọa sẽ bỏ vai nếu các nhân vật nữ trong phim này
                    không được giao một vai hay hơn và nổi bật hơn.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    với nhân vật chính là một nhân vật nữ, tuy nhiên vẫn chưa rõ
                    đó là ai, có thể là Letty Ortiz thì sao.
                  </p>
                </div>
              </div>

            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Nếu như để tìm ra một trong những cái tên nổi bật nhất trong
                    ngành công nghiệp <strong>AV</strong> Nhật Bản ở thời điểm
                    hiện tại, chắc chắn nhiều người sẽ liên tưởng ngay tới cô
                    nàng <strong>Eimi Fukada</strong> - một trong những{" "}
                    <strong>hot girl</strong> chăm chỉ nhất. Sở dĩ nói như vậy
                    vì mặc dù bản thân được đánh giá nằm ở vị thế top đầu trong
                    ngành, nhưng Eimi không hề kén cá chọn canh mà vẫn giữ tần
                    suất ra tác phẩm mới cực kỳ đều đặn. Song song với đó, cô
                    nàng cũng liên tục update trang cá nhân, kênh YouTube của
                    mình và những câu phát ngôn bá đạo.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Đặc biệt, cô nàng còn càng được các fan yêu quý hơn khi từng
                    lên trang cá nhân và để lại một dòng trạng thái đầy ẩn ý:
                    "Đôi khi chúng ta quên mất việc chính của mình là diễn viên{" "}
                    <strong>phim 18+</strong>". Câu nói này được coi như một
                    cách để <strong>Eimi Fukada</strong> tự nhắn nhủ bản thân
                    mình cũng như những người đồng nghiệp vốn đang có phần sa đà
                    vào YouTuber, người mẫu ảnh sau khi có chút ít danh tiếng.
                    Chắc đó cũng là lý do mà dù có bận bịu tới đâu, Eimi cũng
                    vẫn luôn rất tập trung vào công việc chính của mình. Tới mức
                    mà cô nàng sau đó còn thừa nhận rằng theo thời gian, chuyên
                    môn của mình đang ngày một tăng cao và cảm thấy rất tự tin
                    trước mọi yêu cầu.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Ngay cả nhiều đạo diễn, chuyên gia trong giới cũng thừa nhận{" "}
                    <strong>Eimi Fukada</strong> là một trong những{" "}
                    ...
                    thậm chí còn ví von công việc diễn xuất của mình như một trò
                    chơi xếp hình. Eimi thừa nhận luôn thích sắp xếp những ý
                    tưởng, kế hoạch hay nói ngắn gọn là mọi thứ từ trong đầu một
                    cách có tổ chức. Đó cũng là lý do mà cô nàng đạt được những
                    thành công và sự phát triển như ngày hôm nay.
                  </p>
                  ...
                  <p>
                    ...
                    <strong>Eimi Fukada</strong> đang là một trong những mỹ nhân
                    được yêu thích nhất nhì trong ngành công nghiệp phim{" "}
                    ...
                    <strong>hot girl</strong> còn bị fan cuồng tìm tới tận nhà,
                    bối rối phải chuyển "hộ khẩu" thì cũng đủ hiểu, cái tên Eimi
                    Fukada phổ biến tới cỡ nào rồi đấy.
                  </p>
                  <ContentImage

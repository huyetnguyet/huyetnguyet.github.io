                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      nhiên một trong những công việc quan trọng của người chơi
                      đó là sưu tầm nhân vật. Sẽ có rất nhiều các loại Pokémon
                      xuất hiện trong trò chơi này. Một số loại miễn phí, một số
                      loại cần tham gia các sự kiện đặc biệt, một số khác lại
                      cần phải bỏ tiền ra mới mua được.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      phép Hợp nhất Venusaur. Là một Pokemon thuộc loại
                      Attacker, Venusaur xuất sắc trong việc gây sát thương lớn
                      từ xa. Khả năng thụ động của nó làm tăng sát thương khi
                      lượng hp xuống thấp, điều này khuyến khích những người
                      chơi dùng Venusaur nên mạo hiểm và hung hãn hơn.
                    </p>
                    ...
                    <p>
                      ...
                      phép Hợp nhất cho Alolan Ninetales. Sự kiện này bắt đầu
                      khi người chơi đăng nhập vào Pokemon Unite lần đầu tiên và
                      sẽ không kết thúc cho đến khi tất cả 14 phần quà được nhận
                      (mỗi ngày 1 lần).
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Là một Pokemon thuộc loại Attacker, Alolan Ninetales không
                      chỉ có thể gây sát thương nặng mà còn khiến kẻ thù khó
                      chạy thoát nhờ lớp băng đóng băng của nó. Khả năng bị động
                      của Alolan Ninetales làm cho những hiệu ứng đóng băng mạnh
                      hơn. Người chơi nên cân nhắc sử dụng Alolan Ninetales nếu
                      muốn duy trì quyền kiểm soát chiến trường mà vẫn gây sát
                      thương cao.
                    </p>
                    <h5>Cinderace</h5>
                    <ContentImage
                    ...
                    />
                    <p>
                      Giống như Alolan Ninetales, Cinderace có thể nhận được
                      miễn phí trong Quà chào mừng 14 ngày. Chỉ cần chơi trò
                      chơi, đảm bảo đăng nhập mỗi ngày, cho đến khi đạt đến mốc
                      ngày thứ 8 là các bạn đã có thể nhận được Cinderace.{" "}
                    </p>
                    <p>
                      Cinderace là một loại Attacker <strong>Pokémon</strong>,
                      nhưng nó có tính cơ động cực cao. Khả năng bị động của
                      Cinderace cho phép nó đặt Cinders vào Pokémon đối phương
                      và gây thêm sát thương bất cứ khi nào Pokémon đó bị đánh.{" "}
                    </p>
                    <h5>Greninja</h5>
                    <ContentImage
                    ...
                    />
                    <p>
                      Greninja cũng là phần thưởng trong gói sự kiện đăng nhập
                      14 ngày của <strong>Pokémon</strong> Unite. Greninja, một
                      hot Pokémon đang được rất nhiều game thủ yêu thích trong
                      các bản beta và demo của <strong>Pokémon Unite</strong>.
                      Greninja có 3 cấp độ tiến hóa và đạt sức mạnh tối đa ở
                      level 7 (thấp hơn Charizard 2 level). Greninja là Pokémon
                      thiên về tấn công với sự cân bằng gần như hoàn hảo ở tất
                      cả các nhiệm vụ.
                    </p>
                    <h5>Crustle</h5>
                    <ContentImage
                    ...
                    />
                    <p>
                      Giấy phép Hợp nhất của Crustle có thể nhận được miễn phí
                      nếu người chơi hoàn thành toàn bộ Thử thách dành cho người
                      mới bắt đầu. Thử thách này mở khóa các nhiệm vụ mới mỗi
                      ngày trong 7 ngày, bắt đầu từ khi người chơi đăng nhập lần
                      đầu tiên. Tất cả các nhiệm vụ có giá trị 7 ngày phải được
                      hoàn thành trong vòng 30 ngày kể từ ngày bắt đầu trò chơi,
                      nhưng hoàn thành Ngày 7 sẽ mở khóa Crustle.
                    </p>
                    <p>
                      Chú cua đá Crustle là <strong>Pokémon</strong> hệ bọ và
                      đá. Pokémon này có 2 dạng tiến hóa và đạt sức mạnh tối đa
                      ở level 4. Giống Snorlax, đây cũng là Pokémon mang thiên
                      hướng chống chịu và hỗ trợ.
                    </p>
                  </div>
                  <AdsHorizontal />
                </div>

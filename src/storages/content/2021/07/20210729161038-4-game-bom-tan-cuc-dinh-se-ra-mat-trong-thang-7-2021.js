              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    />
                    <p>
                      Samurai Warriors 5 sẽ là một làn gió mới, mang tới hình
                      ảnh khác biệt cho dòng game chặt chém lâu đời của hãng.
                      Trò chơi bao gồm cả phần cốt truyện hoàn toàn mới, thiết
                      kế lại nhân vật từ đầu cũng như phong cách đồ họa chi tiết
                      đẹp mắt hơn. Tựa game đưa người chơi đến{" "}
                      <strong>thời chiến quốc</strong> ở Nhật Bản phong kiến với
                      hai nhân vật trung tâm rực sáng là{" "}
                      <strong>đại tướng quân</strong> Nobunaga Oda và Mitsuhide
                      Akechi. Bối cảnh diễn ra ở giai đoạn sau của cuộc nội
                      chiến 1467 đến năm 1477.
                    </p>
                    <p>
                      Samurai Warriors 5 chắc chắn vẫn mang tới những chiến
                      trường rộng lớn với số lượng quân địch lên đến hàng trăm,
                      hàng ngàn, tha hồ cho bạn càn quét, đuổi cùng giết tận.
                      Qua trailer đầu tiên, nhiều fan không khỏi thích thú khi
                      thấy phần hình ảnh của Samurai Warriors 5 thực sự ổn, mượt
                      và đẹp.
                    </p>
                    <h5>Pokémon Unite</h5>
                    ...
                    />
                    <p>
                      Với tên gọi Pokémon Unite, đây là sản phẩm của TiMi
                      Studios, một công ty con của Tencent, nơi từng sản xuất 2
                      tựa game đình đám là Honor of Kings và Call of Duty:
                      Mobile.
                    </p>
                    <p>
                      Với thể loại MOBA truyền thống, Pokémon Unite sẽ là đấu
                      trường nơi 10 người chơi sẽ so tài. Mỗi đội gồm 5 người,
                      thi đấu với nhau trên 1 bản đồ có 3 đường. Với những người
                      đã quen với <strong>Liên Minh Huyền Thoại</strong>, DOTA 2
                      trên PC hay Liên Quân Mobile trên di động thì sẽ dễ để làm
                      quen với Pokémon Unite.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      Theo dự kiến, Pokémon Unite sẽ phát hành hoàn toàn miễn
                      phí trên 2 hệ máy Nintendo Switch và di động. Không những
                      thế, game cũng hỗ trợ chơi chéo giữa 2 nền tảng này để
                      cộng đồng người chơi dễ dàng giao lưu, mở rộng.
                    </p>
                    ...
                    <p>
                      ...
                      động, thủ thành sôi động đã quay trở lại, đẹp hơn, lớn
                      hơn, nhiều đồ chơi hơn. Trò chơi sắp phát hành ngày 23/7
                      tới cho Xbox Series, PlayStation 4, Xbox One, và PC, PS5.
                    </p>
                    <p>
                      Orcs Must Die! 3 mở ra những màn chém giết orc ở một cấp
                      độ lớn hơn trước rất nhiều. Bạn có thể chơi đơn hoặc hợp
                      tác cùng người khác, sử dụng kho bẫy, vũ khí khổng lồ của
                      mình để ngăn những con orc ngu ngốc đang lao đến. Đặc
                      biệt, chế độ War Scenarios mới đã đưa đến những đội quân
                      orc cực lớn để thử sức bạn đấy.
                    </p>
                    <h5>F1 2021</h5>
                    <p>Hệ máy: PC, PS4, PS5, Xbox One, Xbox Series X/S</p>
                    <p>Phát hành: 16/7</p>
                    ...
                    <p>
                      ...
                      tháng 7/2021 bởi Feral Interactive và Codemasters. Đúng
                      như tên gọi của mình, trò chơi sẽ đưa bạn đến với thế giới
                      siêu tốc độ của những chiếc xe đưa{" "}
                      <strong>Công thức 1</strong>. Với nền tảng đồ họa tuyệt
                      đẹp cũng như cơ chế gameplay chân thực, F1 2021 sẽ đưa bạn
                      vào nhịp đập của những giây phút đua xe căng thẳng không
                      kém gì thức tế.
                    </p>
                  </div>
                  <AdsHorizontal />

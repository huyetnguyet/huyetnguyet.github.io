                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      cái tên - Lê Thị Khánh Huyền. Được biết, cô nàng này là
                      một <strong>TikToker</strong>, người Quảng Ninh, nổi tiếng
                      với 7,7 triệu lượt theo dõi dù cho chỉ mới 17 tuổi.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Khánh Huyền được nhiều người tìm kiếm với “cú đúp” tin
                      sốc: vừa là bạn gái tin đồn của <strong>Duy Nhỏ</strong>{" "}
                      (người yêu cũ của <strong>Linh Ngọc Đàm</strong>), đồng
                      thời cũng bị cho là nữ chính mới <strong>lộ clip</strong>{" "}
                    ...
                    />
                    <p>
                      Theo đó, gái xinh này chính là bạn gái tin đồn mới mà
                      người yêu cũ <strong>streamer</strong>{" "}
                      <strong>Linh Ngọc Đàm</strong> liên tục “thả thính” trong
                      thời gian gần đây. Thiếu gia nhà giàu này còn công khai
                      bình luận vào bài đăng của cô.{" "}
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Trước đó, cuối năm 2017 là khoảng thời gian đầu tiên cô
                      nổi tiếng rộng rãi trong giới học đường. Khi đó, Khánh
                      Huyền sở hữu gương mặt vô cùng xinh đẹp với sống mũi cao,
                      nụ cười duyên dáng và đôi mắt to tròn.{" "}
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Tuy nhiên, hot girl này không theo đuổi hình tượng ngây
                      thơ đáng yêu quá lâu, cô lựa chọn phong cách gợi cảm,
                      sexy, chững chạc hơn so với lứa tuổi của mình để theo
                    ...
                    <p>
                      ...
                      ngần ngại mà lên tiếng thẳng thắn thừa nhận rằng, clip
                      được lan truyền này đã được quay từ tháng 3/2019, hình ảnh
                      trong clip khá bình thường.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Qua đó, cô nàng cũng không giấu giếm bản thân từng dính
                      vào một vụ lùm xùm không đáng có khi một đoạn clip{" "}
                      <strong>nhạy cảm</strong> từ năm 15 tuổi. Nữ{" "}
                      <strong>TikToker</strong> đính chính rằng đó chỉ là trò
                      đùa của cô cùng một bạn nữ khác chứ không phải cảnh nóng
                      giữa cô và người yêu như mọi người vẫn nhầm tưởng.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Trên Facebook cá nhân, cô nàng này không ngại đăng tải
                      nhiều hình ảnh gợi cảm của mình. Hiện, cái tên này vẫn
                      đang thu hút được sự quan tâm lớn.
                    </p>
                  </div>
                  <AdsHorizontal />
                </div>

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    trên nền tảng di động. Đây là một tựa game cực kỳ vui nhộn,
                    thú vị và dễ chơi khi chỉ yêu cầu game thủ thực hiện các
                    thao tác đơn giản gồm di chuyển, tấn công và kỹ năng. Tất cả
                    những gì bạn cần làm chỉ là khéo léo căn thời gian thật
                    chuẩn xác để phản ứng kịp thời các hành động trong các trận
                    đấu nảy lửa.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    một vị vua với sức mạnh thần bí đã bảo vệ vương quốc với 12
                    sứ đồ. Khi nhà vua qua đời, họ cũng đột ngột biến mất khiến
                    cả quốc gia rơi vào sự hỗn loạn khi bị xâm chiếm bởi chủng
                    loài quái vật hung ác. Nhập vai vào 1 trong 12 anh hùng năm
                    xưa, bạn sẽ bắt đầu trải nghiệm cuộc chiến bất tận chống lại
                    lũ quái vật và kết thúc chiến tranh dưới danh nghĩa của một
                  ...
                  />
                  <p>
                    Giống như tên gọi, điều quan trọng nhất mà bạn cần biết khi
                    thử sức với Timing Hero chính là việc căn thời gian chuẩn để
                    thực hiện các thao tác. Hiểu theo một cách đơn giản, hệ điều
                    khiển của bạn trong chiến đấu sẽ có 3 phím di chuyển lên,
                    xuống và giật lùi để né các chiêu thức tấn công của kẻ địch.
                    Sau đó, bạn mới có thể sử dụng thời khắc sơ hở để tấn công
                    và tung ra những chiêu thức riêng biệt để kết liễu đối thủ.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Tại Timing Hero, có tới hơn 16 Boss quái vật khác nhau cùng
                    hàng trăm chủng loại tay sai thử thách người chơi tìm hiểu
                    và đánh bại. Đối với những newbie lần đầu trải nghiệm, có
                    thể khẳng định cảm giác vượt ải đến Boss là một hành trình
                    gian nan tưởng chừng như vô tận. Tuy nhiên, trong quá trình
                    chiến đấu, bạn sẽ dần dần được tích lũy những điểm kinh
                    nghiệm để nâng cấp các chỉ số cơ bản của anh hùng cao hơn.
                    Nhờ đó, bạn có thể tiến hóa và mở khóa những kỹ năng mới
                    mang nhiều giá trị như tấn công, cầm chân, hồi phục, hồi
                    sinh....
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    hiệu ứng kỹ năng của các cổ vật khác nhau. Sử dụng chúng như
                    thế nào để tạo ra sức mạnh tối ưu nhất? Điều đó hoàn toàn
                    phụ thuộc vào khả năng khéo léo và tư duy nhanh nhẹn của
                    bạn.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    quái vật trùm huyền thoại với 3 kỹ năng mạnh mẽ khác nhau).
                    Hãy cùng thử sức với những âm thanh thú vị của dòng game
                    8bit cổ điển và đưa ra những đánh giá khách quan của riêng
                    mình về trò chơi này nhé!
                  </p>
                  <ContentImage
                    src="https://lh6.googleusercontent.com/YWHfqxRBujPr2kf9S6VFggV1_2Ds-TaO89iDF31b1oCAWavC7yuiQGfWQjx0RS8dlqDOXcfuYWVITLD8KKmX8F9iezCS0NOB4YtP0aMCNAOapuOKeNVuEPD6rXTAWZzgjrY_91v3"

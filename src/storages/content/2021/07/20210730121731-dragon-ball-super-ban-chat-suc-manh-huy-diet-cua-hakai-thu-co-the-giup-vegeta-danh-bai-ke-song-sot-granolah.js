                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      <strong>Thần Hủy Diệt</strong> tượng trưng cho sự hủy
                      diệt, chết chóc, họ lãnh nhiệm vụ phá hủy các hành tinh để
                      duy trì sự cân bằng cho vũ trụ. Và sức mạnh làm nên tên
                      tuổi của họ chính là <strong>Hakai</strong>, đây là loại
                      sức mạnh vô cùng đặc biệt, nó có sức mạnh để tiêu diệt hầu
                      như bất cứ điều gì với ít nỗ lực, thậm chí cả những con
                      vật vô hình như linh hồn. Nhưng người bị phá hủy bởi Hakai
                      không đi đến thế giới khác và chỉ đơn giản là chấm dứt tồn
                      tại.
                    </p>
                    <p>
                      ...
                      lớn năng lượng. Ông chứng minh rằng điều này khi tạo ra
                      một vụ nổ cực mạnh với kích thước của vật thể bằng cách
                      phá hủy một tảng đá nhỏ, khiến nó phát nổ với một lực đủ
                      mạnh để đánh bật <strong>Vegeta</strong>.
                    </p>
                    <ContentImage
                      src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/7/30/anh-1-1627628436774114725314.jpg"
                    ...
                    />
                    <p>
                      Đặc biệt để sử dụng <strong>Hakai</strong> đúng cách thì
                      tâm trí của kẻ sử dụng phải luôn trong tình trạng bất ổn.
                      Trong manga, những người có thể sử dụng Hakai đeo một
                      chiếc bông tai vàng riêng biệt như một biểu tượng để họ có
                      thể sử dụng năng lực. Beerus, Champa, Belmod, Rumsshi,
                      Liquiir và mới nhất <strong>Vegeta</strong> đều đeo bông
                      tai này.
                    </p>
                    <p>
                      ...
                      không giấu vết. Với <strong>sức mạnh hủy diệt</strong>{" "}
                      kinh khủng như vậy, rõ ràng Hakai là một thứ có thể khiến
                      bất cứ kẻ nào cũng phải e sợ.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      kiến màn tỏa sáng của <strong>Vegeta</strong> trước trận
                      đấu với <strong>Granolah</strong>. Cho dù ban đầu có phần
                      lép vế, nhưng sau đó Vegeta đã vận khí và hóa thành một
                      dạng mới trông ngầu lòi và có vẻ mạnh mẽ hơn. Theo lời
                      Vegeta, có vẻ dạng biến hóa mới này là sự kết hợp giữa{" "}
                      <strong>sức mạnh hủy diệt</strong> và khả năng của người
                      Saiyan. Đến Granola cũng phải hoảng sợ khi nhìn thấy nên
                      ta có thể chắc chắn dạng biến hóa này có thể mạnh hơn cả
                      Ultra Instinct của Goku.
                    </p>
                    ...
                    <p>
                      ...
                      chứng tỏ anh có thể sử dụng{" "}
                      <strong>sức mạnh hủy diệt</strong>. Điều này sẽ giải thích
                      tại sao Goku cảm thấy hào quang của Vegeta giống God Ki
                      nhưng khác với bình thường. Vegeta có thể đã đạt được God
                      Ki giống với Thần Hủy Diệt.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      Đọc đến đây mọi người nghĩ sao về vấn đề này? Liệu sức
                      mạnh của <strong>Vegeta</strong> có phải là của{" "}
                      <strong>Thần Hủy Diệt</strong> hay{" "}
                      <strong>hoàng tử Saiyan</strong> có thể sử dụng{" "}
                      <strong>Hakai</strong> để đánh bại{" "}
                      <strong>Granolah</strong> hay không? Chúng ta hãy cùng chờ
                      đón những diễn biến tiếp theo của bộ truyện{" "}
                      <strong>Dragon Ball Super</strong> để biết được rõ nhé!
                    </p>
                  </div>
                  <AdsHorizontal />
                </div>

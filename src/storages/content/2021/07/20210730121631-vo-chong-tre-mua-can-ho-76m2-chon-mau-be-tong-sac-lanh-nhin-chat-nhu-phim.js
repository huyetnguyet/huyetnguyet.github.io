              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      Sau khi mua <strong>căn hộ</strong> rộng 76m2 tại khu
                      chung cư Palm Heights - Quận 2, cặp vợ chồng trẻ đã quyết
                      định thiết kế tổ ấm theo{" "}
                      <strong>phong cách hiện đại</strong>, đồng thời kết hợp
                      một vài chi tiết theo sở thích cá nhân.
                    </p>
                    <p>
                      Công năng của <strong>căn hộ</strong> gồm 2 phòng ngủ và 2{" "}
                      <strong>phòng vệ sinh</strong>. Ngoài ra, dựa trên nhu cầu
                      sử dụng của gia đình, <strong>kiến trúc sư</strong> đã
                      thay đổi một vài chi tiết về mặt công năng, điển hình là
                      thu ngắn lại khu vực hành lang để{" "}
                      <strong>phòng ngủ nhỏ</strong> có tầm nhìn tốt hơn, mang
                      lại không gian thoáng hơn cho cả khu vực khách bếp. Bên
                      cạnh đó team thiết kế còn quyết định đập bỏ 1 mảng tường
                      giữa phòng khách và khu giặt phơi để không gian đón được
                      nhiều ánh sáng hơn, đồng thời đây cũng là 1 điểm nhấn cho
                      hệ vách sofa.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      màu yêu thích của chủ nhà, đó là tone màu trầm, gỗ tối
                      màu, đặc biệt là màu bê tông. Ngoài ra còn kết hợp với hệ
                      cửa đi màu bê tông, sơn hiệu ứng, giấy dán tường, kèm
                      những mảng màu xám đậm để không gian thêm phần đa dạng.
                      Những gam màu và chi tiết này vừa phù hợp với sở thích của
                      chủ nhà, đồng thời tạo vẻ cá tính, độc đáo cho không gian.
                    </p>
                    <p>
                      Khu vực đầu tiên là tủ giày kết hợp ghế bench và 1 mảng
                      gương lớn. Đây là nơi để chủ nhà chuẩn bị trước khi ra
                      khỏi nhà, cũng như là 1 điểm nhấn gây ấn tượng khi bước
                      vào nhà.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      <strong>Không gian bếp</strong> được chia làm 2 khu vực:
                      khu vực bếp chính và khu vực bếp đảo thay vì làm 1 hệ bếp
                      chữ L. Thiết kế này giúp không gian bếp trở nên sang trọng
                      hơn. Bên cạnh đó, người sử dụng cũng có thể thoải mái hơn
                      khi nấu ăn, soạn chia, và đưa đến khu vực bàn ăn.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      Ở không gian <strong>phòng ngủ nhỏ</strong>, Ptd concept
                      sử dụng 1 vách kính lớn kèm hệ rèm sáo. Đây là sự kết hợp
                      giữa đặc và rỗng cho <strong>căn hộ</strong> để mang đến
                      sự thoải mái, nhẹ nhàng, nhất là khi xung quanh đã sử dụng
                      các vật liệu như bê tông và các mảng trang trí mạnh mẽ
                      khác.
                    </p>
                    ...
                    />
                    <p>
                      Phòng ngủ master được thiết kế đơn giản nhưng công năng
                      vẫn được đảm bảo đầy đủ với các hạng mục:{" "}
                      ...
                      WC thông qua 1 hệ rèm chống nước, đem lại cảm giác rộng
                      rãi, thông thoáng, phù hợp với gia đình trẻ. Hai WC cũng
                      được ốp gạch giả bê tông kết hợp gạch thẻ ốp theo kiểu
                      xương cá tạo sự thống nhất với toàn nhà.
                    </p>

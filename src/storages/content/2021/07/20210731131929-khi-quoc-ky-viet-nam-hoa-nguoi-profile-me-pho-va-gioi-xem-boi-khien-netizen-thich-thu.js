              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      Để chào mừng <strong>Tokyo Olympic 2020</strong>, một dự
                      án phi chính thức đã được thực hiện, cụ thể là một số nghệ
                      sĩ Nhật Bản đã cùng nhau tạo ra một chiến dịch quảng bá
                      không chính thức cho Tokyo Olympic 2020 lấy tên là{" "}
                      <strong>World Flags</strong>. Nói rõ hơn, World Flags là
                      dự án được các hoạ sĩ Nhật vẽ các quốc kỳ theo phong cách
                      nhân vật Samurai để mừng thế vận hội Tokyo 2020. Ngoài ra
                      còn để tuyên truyền và tìm hiểu văn hóa, lịch sử của các
                      quốc gia trên thế giới. Điểm độc đáo là mỗi quốc kỳ của
                      từng quốc gia đều được hô biến thành các nhân vật Samurai
                      và có hẳn profile ấn tượng.
                    </p>
                    <ContentImage
                      src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/7/31/photo-1-1627707697606365323420.jpg"
                    ...
                    <p>
                      ...
                      sinh 30/11 có liên quan đến sự kiện Nam Kỳ Khởi Nghĩa, vì
                      đó cũng là lần đầu tiên cờ đỏ sao vàng xuất hiện.
                    </p>
                    <p>Chiều cao: 1m75</p>
                    <p>Nhóm máu: B</p>
                    ...
                    <p>
                      ...
                      Toraji, Torazo), và sử dụng dấu sao năm cánh để xử lý các
                      kỹ thuật đặc biệt.
                    </p>
                    <p>
                      Vì yêu động vật nên đôi khi anh ta nhầm lẫn và triệu hồi
                      một con chó con thay vì Toraichi.
                    </p>
                    ...
                    />
                    <p>
                      Nhìn vào profile trên thì rõ ràng anh Việt Nam khá ấn
                      tượng đúng không nào. Mấy cái kỹ năng đặc biệt, món ăn yêu
                      thích và sở thích cũng thật sự rất Việt Nam. Bạn có thích{" "}

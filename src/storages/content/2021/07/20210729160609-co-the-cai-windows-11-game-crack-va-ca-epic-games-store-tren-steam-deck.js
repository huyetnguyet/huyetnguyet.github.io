                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      game cầm tay <strong>Nintendo Switch</strong> và Switch
                      OLED mới ra mắt.
                    </p>
                    <ContentImage
                      src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/7/18/photo-1-1626587589951893523105.jpg"
                    ...
                    <p>
                      ...
                      <strong>Nintendo Switch</strong> nhưng lớn hơn một chút
                      với các tính năng của một PC Gaming hoàn chỉnh. Nó chạy
                      một phiên bản <strong>hệ điều hành</strong> mang tên
                      SteamOS của Valve, hoàn chỉnh với giao diện giống các{" "}
                      <strong>hệ máy console</strong> khác hiện nay và có thể
                      truy cập vào Steam một cách dễ dàng. Nó có thể xuất ra màn
                      hình rời cũng như cho phép người dùng cài bất kỳ ứng dụng
                      bên thứ 3 nào.
                    </p>
                    <p>
                      Về phần cứng, <strong>Steam Deck</strong> có màn hình LCD
                      7 inch tần số quét 60HZ , độ phân giải 1280x800, trang bị
                      CPU tùy chỉnh của AMD với 4 nhân, 8 luồng, 8 đơn vị tính
                      toán RDNA 2 cho GPU và 16 GB của RAM LPDDR5. Thực tế mà
                      nói, điều đó làm cho nó mạnh hơn đáng kể so với Switch,
                      cho phép nó chạy các tựa game hiện tại một cách ấn tượng.
                      Trong video giới thiệu, Steam Deck có thể chơi được tựa
                      game Jedi Fallen Order ở mức thiết đặt High Settings.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      bàn di chuột - một ở hai bên của máy, dưới các ngón tay
                      cái - để tăng độ chính xác. <strong>Steam Deck</strong> có
                      tám trigger ở mặt sau của nó. Steam Deck sẽ chạy các tựa
                      game trong kho game của tài khoản Steam người dùng. Người
                      chơi sẽ chỉ cần đăng nhập vào tài khoản của họ, bạn bè và
                      danh mục của họ sẽ theo dõi họ trên thiết bị cầm tay.
                      Steam Deck có khả năng chạy các tựa game một cách mượt mà
                      như Baldur's Gate 3 , Crusader Kings 3 , Disco Elysium ,
                      Hades và Star Wars Jedi: Fallen Order.
                    </p>
                    <p>
                      Trong một cuộc phỏng vấn với IGN , nhà phát triển Valve là
                      Pierre-Loup Griffais cho biết: "
                      <strong>Steam Deck</strong> có thể chạy khá nhiều thứ mà
                      bạn có thể chạy trên PC thông thường khi bạn có thể vừa
                      chơi game cũng như làm việc, lượt web và xem video trực
                      tuyến."
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Trong quá trình trải nghiệm trên tay{" "}
                      <strong>Steam Deck</strong>, IGN cũng cho biết rằng game
                      thủ hoàn toàn có thể xóa SteamOS được cài đặt sẵn và thay
                      thế nó bằng Windows. Mặc dù điều đó có thể sẽ ảnh hưởng
                      đến hiệu suất chơi game của Steam Deck (do phiên bản
                      SteamOS mới này được tối ưu hóa cho phần cứng của Steam
                      Deck), nhưng điều đó có nghĩa là game thủ có thể cài đặt
                      bất kỳ ứng dụng nào bạn thường sử dụng trên PC (ngay cả
                      việc cài game crack). Thậm chí, game thủ có thể cài Epic
                      Games Store (đối thủ của Steam) để chơi các tựa game miễn
                      phí mà nền tảng này tặng hàng tuần.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      là phiên bản 256GB dung lượng lưu trữ có giá 529 USD (hơn
                      12 triệu VNĐ) và phiên bản đắt nhất có giá 649 USB (gần 15

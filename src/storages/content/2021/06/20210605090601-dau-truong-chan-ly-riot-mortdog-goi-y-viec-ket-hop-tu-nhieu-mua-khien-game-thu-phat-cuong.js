              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    ngày càng tốt lên chính là nhiệm vụ của đội ngũ kỹ sư Riot,
                    đặc biệt là với một tựa game luôn tồn tại nhiều biến số như
                    Đấu Trường Chân Lý.
                  </p>
                  <p>
                    Trải qua 5 mùa, tựa game ngày càng thu hút sự chú ý của đông
                    đảo người chơi hơn và thậm chí, đôi khi còn thu hút hơn Liên
                    Minh Huyền Thoại ở một số đặc điểm, nhất là những game thủ
                    chưa từng tiếp xúc LMHT cũng có thể chơi ĐTCL dễ dàng. Mỗi
                    mùa ĐTCL đều mang những chủ đề khác nhau và mới đây, Riot
                    Mortdog - kỹ sư trưởng dự án ĐTCL của Riot đã “nhá hàng” một
                    ý tưởng vô cùng táo bạo: những vị tướng của mùa 5 có thể
                    mang những đặc điểm từ tộc hệ của chúng ở các mùa trước.
                  </p>
                  <p>
                    Cụ thể, Riot đăng hình của 4 vị tướng là Nocturne, Riven,
                    Volibear và Katarina với 4 Tộc/Hệ của chúng ở các mùa trước
                    là Kiếm Khách (Nocturne), U Hồn (Riven), Điện (Volibear) và
                    Thần Tài (Katarina).
                  </p>
                  <p>
                    <ContentImage
                  ...
                  <p>
                    Nếu Nocturne bổ sung thêm Kiếm Khách, đây chính là phiên bản
                    nâng cấp hoàn hảo nhất của Blender Nocturne trứ danh năm nào
                    khi vị tướng này sẽ vừa có sát thương mà còn có thể kích
                    hoạt khả năng hồi phục cực nhanh, kết hợp với Cuồng Đao thì
                    sẽ gần như bất tử. Cùng tộc hệ Tà Thần với Nocturne chính là
                    Volibear. Vị tướng vốn đã vô cùng cứng cáp, có khống chế
                    cứng ở mùa 5 lại tăng thêm khả năng sát thương diện rộng từ
                    hệ Điện thì dĩ nhiên sẽ là quân cờ bị tranh giành số 1.
                  </p>
                  <p>
                    <ContentImage
                  ...
                  <p>
                    ...
                    thời điểm vị tướng này tỏa sáng nhất cho đến khi bị Riot xóa
                    sổ ở mùa 4.5. Cộng Sát Thương Kỹ Năng từ U Hồn, Tốc Độ Đánh
                    từ Quân Đoàn và khả năng Hồi Phục với Thần Sứ, Riven thực sự
                    sẽ là một lựa chọn rất mạnh.
                  </p>
                  <p>
                    <ContentImage
                  ...
                  <p>
                    Ít có tác dụng nhất có lẽ là ghép Thần Tài vào Katarina khi
                    cơ chế “nổ hũ” bây giờ đã được nâng cấp hơn với Long Tộc.
                    Tuy nhiên, nếu vị tướng đang khá mạnh ở meta hiện tại này
                    được kết hợp cùng những “đồng tộc hệ” của mình trước đây thì
                    không thể tưởng tượng nổi khi hũ nổ sẽ mang lại nhiều lợi
                    tức đến mức nào.
                  </p>
                  <p>
                    Dĩ nhiên, đây chỉ là lý thuyết và ý tưởng của riêng Riot
                    Mortdog vì có một thực tế rằng, ĐTCL mùa 5 vẫn còn tồn tại
                    nhiều meta bá đạo hơn bình thường và việc ghép thêm các tộc
                    hệ từ mùa trước sẽ chỉ khiến Riot thêm đau đầu mà thôi.
                  </p>
                </div>
              </div>

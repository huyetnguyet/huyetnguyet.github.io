              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    ...
                    Điện Statikk là trang bị không thể thiếu. Bên cạnh việc cung
                    cấp năng lượng cho tướng sở hữu, khả năng trừ kháng phép lên
                    các unit tuyến sau của Dao Điện Statikk tỏ ra quá phù hợp
                    với các unit Ác Quỷ. Lý do là bởi những unit như Poppy,
                  ...
                  <p>
                    Mặc dù không có bộ tộc - hệ liên quan với nhau nhưng kỹ năng
                    của Thresh và Syndra có thể kết hợp cực kỳ tốt để hạ gục
                    nhanh chóng chủ lực phe địch. Với<strong>Syndra</strong>
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    lực mạnh. Game thủ Đấu Trường Chân Lý có thể áp dụng team 4
                    Hiệp Sĩ - 3 Thiên Thần ở cấp độ 6 nhằm giữ máu một cách hiệu
                    quả nhất khi chơi xoay quanh combo Thresh - Syndra. Ngoài
                    thì bạn cũng cần phải đặt Thresh và<strong>Syndra</strong>
                  </p>
                  <p>
                    <strong>Warwick</strong>
                  </p>
                  <p>
                    Một trong những điểm yếu lớn nhất của đội hình Sát Thủ đó là
                    không có khả năng phòng ngự quá mạnh và dễ bị thua ở giai
                    đoạn đầu trận. Lời khuyên là bạn nên giải quyết vấn đề này
                    bằng các unit Đấu Sĩ, đặc biệt là Warwick. Về cơ bản thì với
                    sự xuất hiện của Warwick trong đội hình, game thủ có thể hủy
                    diệt tuyến sau bên phía đối phương một cách dễ dàng. Hơn
                    nữa, việc
                    <strong>Warwick</strong>
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Bí quyết ở đây đó là bạn sẽ tận dụng khả năng gây sát thương
                    lớn từ Sát Thủ để Warwick có thể dùng kỹ năng để kết liễu
                    tuyến sau của đối phương.
                  </p>
                </div>
              </div>

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    giữa game nhập vai với phiêu lưu hành động. Bạn sẽ bước vào
                    hành trình chinh phục thế giới thần tiên Mythrilia được vẽ
                    bằng tay cực kỳ chi tiết, khám phá sự thật về dòng máu của
                    mình và những bí ẩn động trời khác.
                  </p>
                  <p>
                    Năm 2017, <strong>The Vagrant</strong> chính thức ra mắt
                    trên hệ thống Early Access của Steam để thu hút sự chú ý của
                    cộng đồng, gây dựng số tiền cần thiết và thu thập ý kiến
                    nhằm củng cố sản phẩm. Và giờ đây, tuy những gì hiện hữu
                    trong The Vagrant lúc này có khác rất nhiều so với dự định
                    từ thuở đầu Kickstarter, nhưng ít ra, một quyết định tưởng
                    chừng táo bạo, bồng bột năm nào, cuối cùng đã tạo nên một
                    tựa game hoàn chỉnh.
                  </p>
                  <p>
                    ...
                    của mình, với nhân vật chính là một nữ anh hùng cực kỳ nóng
                    bỏng gợi cảm, đi cùng dàn NPC toàn những em gái ngực bự kinh
                    hoàng.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Đặc biệt, không chỉ nữ chính Vivian được nhiều{" "}
                    <strong>coser</strong> lựa chọn <strong>cosplay</strong>, mà
                    ngay cả dàn mỹ nữ phụ trong game cũng được tái hiện đầy nóng
                    bỏng ở đời thực. Đã nói là phải chứng minh, mời các bạn ngắm
                    ngay loạt ảnh cosplay siêu gợi cảm của nàng coser Hoshilily
                    khi hóa thân thành nhân vật <strong>Valerie</strong> trong{" "}

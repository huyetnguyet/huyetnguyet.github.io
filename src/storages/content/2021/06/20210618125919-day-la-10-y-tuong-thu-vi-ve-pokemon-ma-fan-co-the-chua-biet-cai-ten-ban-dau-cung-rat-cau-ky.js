            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    <strong>Pokémon</strong> là thương hiệu đình đám đã gắn liền
                    với rất nhiều thế hệ từ video game, series anime, phim điện
                    ảnh cho tới đồ chơi ăn theo. Sau nhiều năm phát triển, cái
                    tên đến từ xứ sở mặt trời mọc này đã trở thành một thương
                    hiệu toàn cầu, được nhiều người yêu thích.
                  </p>
                  <p>
                    Tuy nhiên, tất cả những điều to lớn đều bắt đầu từ những gì
                    nhỏ nhặt nhất, bản thân <strong>Pokémon</strong> cũng được
                    phát triển từ những ý tưởng, bản thảo trước. Sau đây cùng
                    xem lại những trang bản thảo về Pokémon mà fan chắc chắn sẽ
                    rất yêu thích.
                  </p>
                  ...
                  />
                  <p>
                    Trước khi cái tên <strong>Pokémon</strong> ra đời, loạt game
                    này được gọi là "<strong>Capsule Monsters</strong>". Tuy
                    nhiên cái tên này sau đó lại không phù hợp, nên đã được đổi
                    lại thành Pocket Monsters hay Pokémon như ngày nay. Ý tưởng
                    này từ Ken Sugimori muốn cho mọi người cảm thấy tò mò về
                    những gì mà họ cần biết về loạt game này, cũng như tạo hình
                    ban đầu của một vài Pokémon.
                  </p>
                  <h3>9. Poliwhirl</h3>
                  <ContentImage
                  ...
                  />
                  <p>
                    Một trong những điểm thú vị nhất về <strong>Pokémon</strong>{" "}
                    chính là các ý tưởng đầu tiên, khi có nét vẽ mang thiên
                    hướng tạo nên sự rùng rợn nhất định. Và{" "}
                    <strong>Poliwhirl</strong> chính là một trong số đó.
                  </p>
                  <p>
                    Ý tưởng đầu tiên cho <strong>Poliwhirl</strong> được vẽ nên
                    bởi Benimaru Ioth, với một nửa cơ thể hiện rõ chi tiết các
                    bộ phận bên trong của <strong>Pokémon</strong> này. Đây là
                    bản thảo cho một trong những thế hệ Pokémon đầu tiên được
                    rất nhiều fan yêu quý.
                  </p>
                  <h3>8. Gengar</h3>
                  <ContentImage
                  ...
                  <p>
                    ...
                    <strong>Gengar</strong>, một <strong>Pokémon</strong> hệ ma.
                    Ý tưởng này được tạo ra bởi Ken Sugimori, với khung cảnh tăm
                    tối và Gengar xuất hiện ở phía sau nhà huấn luyện Pokémon.
                    Chi tiết này tạo cảm giác như phong cách hù dọa đặc trưng
                  ...
                  <p>
                    ...
                    Pikachu đang bị buộc lại với một thiết bị đo lường điện năng
                    với mục đích làm thí nghiệm. Thêm một ý tưởng như toát lên
                    nét rùng rợn cho một Pokémon.
                  </p>
                  ...
                  <p>
                    ...
                    "Đầu tiên, nhân vật chính và <strong>Pokémon</strong> có mối
                    quan hệ giữa chủ với thú cưng. Nhưng khi bắt đầu thiết kế
                    trò chơi, chúng tôi đã tự hỏi rằng liệu mình có nên phát
                    triển theo hướng của tình bạn không".
                  </p>
                  ...
                  <p>
                    ...
                    <strong>Pokémon</strong> luôn được đề cao và xem như nhân tố
                    quan trọng hình thành nên thương hiệu game này. Và ý tưởng
                    từ Sugimori thể hiện hình ảnh chuyến du hành ở trên biển với
                    thiết kế nguyên bản của Lapras, Pokémon hệ nước và băng.
                  </p>
                  ...
                  />
                  <p>
                    Nhà thiết kế Ken Sugimori còn giới thiệu tới ý tưởng sơ khai
                    về hệ thống chiến đấu trong loạt game{" "}
                    <strong>Pokémon</strong> và vẫn được áp dụng cho những phần
                    game sau này. Điểm khác biệt là bản thảo này vào thời điểm
                    ban đầu chưa bổ sung thêm thanh máu cho Pokémon.
                  </p>
                  ...
                  <p>
                    ...
                    một bản thảo về Torterra do RJ Palmer sáng tạo. Tạo hình cho
                    bản điện ảnh đem đến những nét mới cũng như biến Torterra
                    khổng lồ hơn.
                  </p>
                  ...
                  <p>
                    ...
                    Detective <strong>Pikachu</strong> một ý tưởng cực kỳ hay là
                    phân cảnh về màn đại chiến giữa Charizard và Gyrados ở trong
                    phim. Đáng tiếc là phân cảnh này đã không được đưa vào trong
                    bộ phim khi ra mắt chính thức. Nhưng fan vẫn có thể hi vọng
                    là màn đối đầu này sẽ xuất hiện trong phần phim tiếp nối.
                  </p>
                  ...
                  <p>
                    ...
                    <strong>Pokémon</strong>. Nhưng ít ai biết rằng, nguyên bản
                    của Snorlax trong rất khác so với hiện tại.
                  </p>
                  <p>

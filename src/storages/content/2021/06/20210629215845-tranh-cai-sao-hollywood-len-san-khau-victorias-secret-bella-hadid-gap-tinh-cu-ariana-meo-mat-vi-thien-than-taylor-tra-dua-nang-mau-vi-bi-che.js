              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    khán giả săn đón và mong chờ. Không chỉ có dàn siêu mẫu danh
                    tiếng và chuyên nghiệp, show diễn còn mời những ngôi sao
                    đình đám Hollywood đến biểu diễn khuấy động sân khấu.
                  </p>
                  <p>
                    Tuy nhiên, show diễn được đầu tư mạnh tay của{" "}
                    <strong>Victoria's Secret</strong> cũng không thể tránh khỏi
                    những sự cố trong quá trình diễn ra. Những ngôi sao nổi
                    tiếng tham gia show đã nhiều lần gây bão MXH với những
                  ...
                  <p>
                    ...
                    <strong>The Weeknd</strong>. Cuộc gặp mặt định mệnh của cặp
                    đôi đình đám còn được nhiều cư dân mạng quan tâm hơn cả...
                    chuyện học hành của họ. Cả thế giới đều hồi hộp chờ đến
                    khoảnh khắc Bella bước ra sàn diễn và đụng độ tình cũ ngay
                    trên sóng trực tiếp.
                  </p>
                  <ContentImage
                    src={
                  ...
                  />
                  <p>
                    Và điều gì đến cũng đã đến, <strong>Bella Hadid</strong> sải
                    bước trên đường băng và <strong>The Weeknd</strong> đứng đợi
                    để giao lưu như những siêu mẫu khác. Khi nhìn nhau, cả 2 đều
                    nở nụ cười nhưng chỉ 1 giây sau, nàng mẫu đã "lật mặt" và
                    trở lại thần thái lạnh lùng kiêu sa. Biểu cảm bất cần lạnh
                    nhạt của người đẹp chân dài đã gây bão trên MXH và khiến dân
                    tình vô cùng "mãn nguyện".
                  </p>
                  <ContentImage
                    src={
                  ...
                  />
                  <p>
                    Trong khi đó, chị gái của Bella cũng có một phần diễn không
                    trọn vẹn trong show diễn ở Paris.{" "}
                    <strong>Gigi Hadid</strong> diện một bộ nội y màu đen nổi
                    bật trên làn da trắng mịn cùng đôi cánh lớn ở phía sau lưng.
                    Tuy nhiên khi đang đi catwalk, 1 chiếc dây áo của cô đã bị
                    đứt và khiến bộ đồ không còn đẹp đẽ như ban đầu. Nhiều khán
                    giả cũng tỏ ra thất vọng vì màn xuất hiện của cô đào hot
                    nhất chương trình không được diễn ra trọn vẹn.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    ...
                    <strong>Ariana Grande</strong> mới 21 tuổi nhưng đã là ngôi
                    sao đình đám được nhiều người yêu mến.{" "}
                    <strong>Victoria's Secret</strong> Fashion Show năm ấy đã
                    chộp được khoảnh khắc để đời của nữ ca sĩ. Cụ thể, khi đang
                    biểu diễn cực sung, Ariana đã suýt bị đôi cánh lớn của 1
                    người mẫu va vào đầu. Ngay lập tức, cô nàng đã cúi thấp đầu
                    và lộ biểu cảm hoang mang ngơ ngác lẫn một chút sợ hãi.
                    Khoảnh khắc này đã nhanh chóng trở nên viral vì vẻ mặt dễ
                    thương của giọng ca Position.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    ...
                    vẫn thoải mái "bung xõa" cùng các siêu mẫu cao hơn cô cả cái
                    đầu một cách vô cùng dễ thương
                  </p>
                  <ContentImage
                    src={
                  ...
                  />
                  <p>
                    Biểu cảm đáng yêu của Ariana khiến khán giả phải bật cười vì
                    quá hài hước và "lệch pha" so với show diễn sexy được nhiều
                    người mong chờ
                  </p>
                  <p>
                    <strong>Victoria's Secret</strong> Fashion Show không thiếu
                    những siêu mẫu vừa sinh con được vài tháng thậm chí vài
                    tuần, nhưng những cô đào đang mang thai thì cực kì hiếm. Bạn
                    gái mới của <strong>Kanye West</strong> -{" "}
                    <strong>Irina Shayk</strong> cũng đã từng đi catwalk với
                    chiếc bụng bầu đã nhô lên khá rõ. Cô nàng đã diện 1 bộ đồ
                    nội y khá kín đáo để che vòng eo nhưng vẫn bị người xem phát
                    hiện.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    ...
                    2013, siêu mẫu Jessica Hart đã đưa ra nhận xét: "Chúa sẽ phù
                    hộ cho trái tim của Taylor Swift. Tôi nghĩ cô ấy tuyệt vời.
                    Nhưng tôi không hiểu sao đối với tôi, cô ấy không hề phù
                    hợp". Điều này đã khiến cho nàng mẫu không thể tham dự{" "}
                    <strong>Victoria's Secret</strong> Fashion Show vì chọc nhầm
                    "rắn chúa". Hành động trả đũa của Taylor khiến cô bị một bộ
                    phận dân tình chỉ trích vì sự ích kỉ và nhỏ nhen.
                  </p>
                  <ContentImage
                    src={

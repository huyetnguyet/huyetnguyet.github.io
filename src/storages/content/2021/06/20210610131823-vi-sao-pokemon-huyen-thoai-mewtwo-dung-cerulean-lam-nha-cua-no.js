              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    trong cả thế giới Pokémon. Được sinh ra từ mẫu hóa thạch của
                    Mew, thế nhưng nó lại còn mạnh mẽ hơn cả phiên bản gốc.
                    Trong các phiên bản game, người chơi phải phá đảo game lần
                    1, sau đó mới có thể chạm trán và chinh phuc nó.
                  </p>
                  <ContentImage
                    src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/6/11/photo-1-16233447817771943324158.png"
                    alt="Pokemon, Mewtwo, "
                  ...
                  <p>
                    Thế nhưng, việc <strong>Mewtwo</strong> chọn Cerulean là như
                    thế nào thì vẫn là ẩn số với nhiều người. Nhiều người cho
                    rằng, hang Cerulean là nơi nó chọn, bởi nó muốn lánh xa con
                    người. Thế nhưng, điều đó có thật sự chính xác hay không thì
                    chưa ai biết rõ.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Khi tạo ra <strong>Mewtwo</strong>, con người đã có mục đích
                    rằng biến nó nó trở thành <strong>Pokemon</strong> chiến đấu
                    mạnh nhất, có thể đánh bại mọi đối thủ. Các nhà khoa học đã
                    thực hiện vô số thử nghiệm đối với nó để năng tầm năng lực
                    cho Mewtwo. Chính vì sự ra đời đau thương và sự đối xử tàn
                    tệ đó, Mewtwo đã trở thành Pokemon "máu lạnh" nhất trong số
                    tất cả các Pokemon. Nó có đủ sự thông minh để nhận ra điều
                    này, và sức mạnh con người ban cho nó biến nó trở thành 1 kẻ
                    vượt ngục mạnh mẽ, rời khỏi hòn đảo Cinnabar và đi tìm một
                    nơi trú ẩn mới.
                  </p>
                  ...
                  <p>
                    ...
                    <strong>Pokemon</strong> mạnh mẽ, nơi mà con người không dễ
                    dàng có thể thâm nhập. Một chỗ trú ẩn tăm tối với nhiều hang
                    cùng ngõ hẻm, phải giải được những câu đó rắc rối mới có thể
                    vượt qua.
                  </p>
                  <p>
                    ...
                    qua đây. Do đó, hang động Cerulean dường như là lựa chọn hợp
                    lý hơn cả.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    <strong>Mewtwo</strong> khi có thiết kế khá khó nhằn với các
                    tay huấn luyện <strong>Pokemon</strong>, kể cả là những nhà
                    vô địch. Có quá nhiều Pokemon mạnh ở đây, thật khó để các
                    huấn luyện viên không có trình độ có thể đến và làm phiền
                    nó. Việc nó tách biệt với thế giới bên ngoài cũng giúp cho
                    Mewtwo được sống trong sự yên ổn.{" "}
                  </p>
                </div>
              </div>

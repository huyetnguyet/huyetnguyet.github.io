            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Thuý An là Á hậu 2 của cuộc thi Hoa hậu Việt Nam 2018, đăng
                    quang đã 3 năm có lẻ nhưng chẳng mấy ai biết nàng là ai, đơn
                    giản vì Thuý An hầu như không có lấy 1 hoạt động trội bật để
                    người đời khắc cốt ghi tâm.
                  </p>
                  <p>
                    <ContentImage
                      src={
                  ...
                  <p>
                    ...
                    ngẫu hứng không theo lề lối, cộng thêm mẫu thiết kế bờm tóc
                    đã có niên đại từ thuở bao cấp khiến hình ảnh của Thuý An
                    không đẹp xinh như mọi ngày. Nhưng điểm chết người nhất ở cả
                    outfit lại là cách nàng Á hậu kết hợp mốt "no bra" với bộ
                    suit từ chất liệu tweed này. Việc thiên về khoe vòng 1 đã
                    đem về cho phong cách của Thuý An nhiều lời chê hơn là những
                    lời khen.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    - "Có phải mỗi mình tôi thấy bộ tóc và chiếc bờm quá lỗi mốt
                    và khó hiểu không?".
                  </p>
                  <p>
                  ...
                  />
                  <p>
                    - Chọn vải vóc đứng dáng, có độ cứng cáp vừa đủ giúp duy trì
                    phom dáng bộ đồ. Chất vải càng mềm và dễ nhăn, càng èo uột
                    thì khả năng "fail" càng cao.
                  </p>
                  <ContentImage
                    src={

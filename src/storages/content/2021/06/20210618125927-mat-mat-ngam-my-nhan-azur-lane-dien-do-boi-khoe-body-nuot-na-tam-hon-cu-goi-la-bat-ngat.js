            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    <strong>Azur Lane</strong> là một trò chơi di động nổi tiếng
                    của Idea Factory International đã ra mắt vào năm 2017. Azure
                    Lane là một game bắn súng side-scrolling của Trung Quốc được
                    tạo ra bởi Xiamen Yongshi và Shanghai Manjuu với nhà phát
                    hành Yostar đã phát hành phiên bản tiếng Nhật và tiếng Anh
                    cho Android. Điều này đã giúp trò chơi di động này tiếp cận
                    đến nhiều đối tượng hơn và nó đã thực sự trở nên phổ biến.
                  </p>
                  <p>
                    Azure Lane diễn ra trong một thế giới nơi các thiết giáp hạm
                    được nhân cách hóa từ khắp nơi trên thế giới chiến đấu với
                    nhau để giành chiến thắng với tất cả sự tham gia của những
                    người giỏi nhất. Ở trong thế giới này, game thủ được quyền
                    điều khiển những hotgirl Anime trên màn hình và thổi bay kẻ
                    địch bởi những phát pháo cuồng bạo. Việc tự do điều khiển
                    nhân vật cho phép người chơi né được họng súng của đối
                    phương trong khi kích hoạt skill để tạo nên những combo còn
                    dữ dội hơn nữa. Trong các chiến hạm mỹ nhân của{" "}
                    <strong>Azur Lane</strong>, <strong>Kashino</strong> là cái
                    tên nhận được rất nhiều sự chú ý của game thủ vì sự nóng
                    bỏng quá đỗi của cô nàng.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Dưới đây mời các bạn cùng ngắm nàng <strong>Kashino</strong>{" "}
                    trong bộ đồ bơi trắng tinh khôi qua màn thể hiện của nữ{" "}
                    <strong>coser</strong> @SharkSAME nhé!
                  </p>
                  <ContentImage
                    src={

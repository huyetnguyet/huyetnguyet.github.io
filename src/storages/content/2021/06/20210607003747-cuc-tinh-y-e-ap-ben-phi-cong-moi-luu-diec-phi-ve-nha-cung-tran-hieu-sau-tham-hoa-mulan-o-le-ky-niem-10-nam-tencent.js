            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Vào ngày 7/6, sự kiện cực hoành tráng kỷ niệm chặng đường 10
                    năm của<strong> Tencent</strong>
                  </p>
                  <p></p>
                  <ContentImage
                  ...
                  />
                  <p>
                    4. Tuy không đứng chung khung hình nhưng Địch Lệ Nhiệt Ba và
                    Ngô Lỗi - cặp bài trùng của Trường Ca Hành vẫn biết cách
                    "tung hint couple". Cả hai mang đến bài phát biểu cảm động
                    dành tặng<strong> Tencent</strong>
                  </p>
                  <ContentImage

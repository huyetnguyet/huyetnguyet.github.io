            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  />
                  <p>
                    Ra mắt cùng thời với Pokemon, Digimon ban đầu xuất hiện dưới
                    dạng Tamagotchi - hay còn gọi là "thú ảo". Nhận được sự ủng
                    hộ mạnh mẽ của khách hàng, Digimon phát triển thành một
                    chuỗi series anime Digimon Adventure đồng thời mở ra thế
                    giới game Digimon World. Sau hơn 20 năm phát triển, Digimon
                    hiện đã trở thành một trong những thương hiệu đình đám nhất
                    của ngành công nghiệp anime - game tại Nhật Bản.
                  </p>
                  <p>
                    ...
                    còn một số ít khán giả trung thành theo dõi thương hiệu này
                    mà thôi. Các bạn đã từng theo dõi anime này hay chưa?
                  </p>
                  <p>Love Live</p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    khác nhau đã được tung ra. Câu chuyện chủ yếu xoay quanh các
                    nữ idol đáng yêu và con đường sự nghiệp của họ. Ngoài việc
                    là một anime giải trí, Love Live còn là nơi để các idol, ca
                    sĩ trẻ của Nhật Bản thể hiện tài năng của mình. Cũng chính
                    vì điều này nên anime Love Live rất được yêu thích tại Nhật
                    Bản trong suốt nhiều năm qua. Tại Việt Nam thì chỉ một số ít
                    khán giả am hiểu văn hóa giải trí Nhật Bản mới thật sự yêu
                    thích Love Live.
                  </p>
                  <p>Cowboy Bebop</p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    Nhật Bản mà cả ở các nước phương Tây. Hiện tại, Cowboy Bebop
                    đang là anime có điểm số IMDb cao nhất. Tại Việt Nam, Cowboy
                    Bebop đã ra mắt quá lâu và nội dung của phim khá kén người
                    xem nên anime này được khá ít người biết đến.
                  </p>
                  ...
                  <p>
                    ...
                    Neon Genesis Evangelion đã "thổi bay" tâm trí khán giả toàn
                    thế giới với câu chuyện cực kì sâu sắc và phần hình ảnh đậm
                    chất nghệ thuật.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Năm 2006, Japan Media Art Festival đã xếp hạng Neon Genesis
                    Evangelion là anime nổi tiếng nhất mọi thời đại. Cho đến
                    nay, thương hiệu này vẫn ra mắt các sản phẩm mới và được đón
                    nhận nồng nhiệt tại Nhật Bản. Bất chấp sự nổi tiếng tại Nhật
                    Bản thì tại Việt Nam, Neon Genesis Evangelion cũng có một
                    lượng fan tuy nhiên không đáng kể.
                  </p>
                  <p>Sazae-san</p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    trong số các anime từng được làm ra. Kéo dài từ năm 1969 với
                    hơn 7000 tập phim của Sazae-san đã đồng hành cùng người dân
                    xứ sở hoa anh đào qua mọi thăng trầm lịch sử đồng thời đem
                    lại tiếng cười giải trí không biết bao nhiêu thế hệ tại đất
                    nước này. Vì là một anime rất "Nhật Bản" thế nên Sazae-san
                    chỉ được biết đến như "phim hoạt hình dài tập nhất lịch sử"
                    chứ gần như không có nhiều cơ hội tại các đất nước khác
                    trong đó có Việt Nam.
                  </p>
                  <p>
                    Trên đây là 5 anime nổi tiếng không kém One Piece tại Nhật
                    Bản nhưng lại bị "hắt hủi" tại Việt Nam. Các bạn đã từng xem
                    qua cái tên này trong số 5 tác phẩm mà chúng tôi vừa kể trên
                    hay chưa, hãy để lại ý kiến của mình nhé!
                  </p>
                </div>
              </div>

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    />
                    <p>
                      Địch Lệ Nhiệt Ba sinh năm 1992 là một trong những mỹ nhân
                      9x đẹp nức tiếng của làng giải trí Hoa ngữ. Mỗi khi xuất
                      hiện "mỹ nhân Tân Cương" đều thu hút sự chú ý của công
                      chúng vì quá đẹp. Sau mỗi sự kiện, cái tên Địch Lệ Nhiệt
                      Ba lại được đẩy lên top tìm kiếm.
                    </p>
                    <p>
                      Tuy nhiên, một số cư dân mạng lại chỉ trích nữ diễn viên.
                      Họ nói rằng, Địch Lệ Nhiệt Ba thiếu tài năng, chỉ giữ được
                      sự quan tâm của công chúng nhờ ngoại hình, là "bình hoa di
                    ...
                    <p>
                      ...
                      đất mỹ nhân của xứ sở tỷ dân bởi các cô gái Tân Cương có
                      vẻ đẹp hài hòa giữa nét phương Đông và phương Tây.
                    </p>
                    <p>
                      Vùng này là trạm nghỉ chân lớn nhất trên "con đường tơ
                      lụa" nối từ Á sang Âu nơi những nền văn hóa hòa quyện cũng
                      như sở hữu nguồn gen phong phú. Ngoài ra, điều kiện khí
                      hậu với khung cảnh thiên nhiên là thảo nguyên rộng lớn
                      cũng tác động đến ngoại hình của con người.
                    </p>
                    <ContentImage
                      src=""
                      alt="Địch Lệ Nhiệt Ba"
                    ...
                    />
                    <p>
                      Địch Lệ Nhiệt Ba được nhận xét là có khuôn mặt đẹp, các
                      nét trên gương mặt rõ ràng đặc biệt là chiếc mũi cao giúp
                      diện mạo thêm phần thanh tú. Bên cạnh đó tỷ lệ gương mặt
                      của Địch Lệ Nhiệt Ba cân đối. Mũi, môi và cằm nằm trên một
                    ...
                    />
                    <p>
                      Chẳng những vậy, Địch Lê Nhiệt Ba còn được khen ngợi hết
                      lời về vóc dáng. "Mỹ nhân Tân Cương" có thân hình mảnh mai
                      nhưng "vòng nào ra vòng nấy" vẫn có những đường cong gợi
                      cảm, không phải kiểu gầy gò, ốm yếu. Ngoài ra, khi áp dụng
                      nguyên lý "8 cái đầu" để xác định tỉ lệ cơ thể, kết quả
                      của Địch Lệ Nhiệt Ba là 8,5 gần đạt chuẩn mới "9 cái đầu".{" "}
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Bên cạnh đó, chân của Địch Lệ Nhiệt Ba dài, thon gọn mặc
                      dù cô chỉ cao 1m68. Chiều dài cánh tay cũng theo đúng tỷ
                      lệ chuẩn bằng 1/4 tổng chiều dài cơ thể. Còn vùng vai,
                      xương quai xanh của cô cũng đẹp ấn tượng. Chẳng những hõm
                      sâu mà đỉnh đầu xương quai xanh, đường lượn vai đều hoàn
                      hảo. Bởi vậy mà người ta mới không ngừng ca ngợi vóc dáng

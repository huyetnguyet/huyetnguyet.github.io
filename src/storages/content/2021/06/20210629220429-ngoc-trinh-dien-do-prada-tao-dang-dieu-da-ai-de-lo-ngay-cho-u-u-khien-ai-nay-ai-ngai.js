                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      <strong>Ngọc Trinh</strong> bất ngờ xuất hiện với 1 diện
                      mạo "kín cổng cao tường" hệt như nữ sinh thượng lưu. Diện
                      nguyên set <strong>Prada</strong> từ trang phục cho đến
                      phụ kiện, Trinh ngầm khẳng định danh xưng "
                      <strong>yêu nữ hàng hiệu</strong>" là chính cô chứ nào ai
                      có cửa.
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      trọng, lịch thiệp đúng chất <strong>Prada</strong>, còn
                      khí chất của <strong>Ngọc Trinh</strong> thì không phù hợp
                      với set đồ lắm...
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      phần nhạy cảm khiến ai nhìn vào cũng phải "đỏ mặt". Tấm
                      hình này còn được trưng dụng làm ảnh bìa cho cả bộ ảnh này
                      nữa...
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      <strong>Nữ hoàng nội y</strong>" khéo léo che đi bằng
                      chiếc túi cả chục triệu đồng.
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      MXH, khiến set đồ trở nên kém sang trọng đi vài phần. Có
                      lẽ Ngọc Trinh cùng ekip nên cầu toàn hơn trong thao tác
                      chuẩn bị áo quần đi chụp giúp trang phục giữ được tinh
                      thần vốn có của nó, trừ khi nàng không màng tới điều đó...
                    </p>
                    <ContentImage
                      src={

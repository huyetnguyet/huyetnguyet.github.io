              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      Vũ Ngọc <strong>Kim Chi</strong> nổi lên từ đầu năm 2019
                      với vai trò là <strong>streamer</strong> của tựa game Liên
                      Minh Huyền Thoại được Dũng CT động viên và giúp đỡ. Đến
                      nay, sau hai năm nỗ lực, cô nàng đã chứng minh được khả
                      năng của mình cũng như có được vị trí nhất định. Đặc biệt,
                      Chi được người hâm mộ cho là bóng hồng{" "}
                      <strong>sexy</strong> nhất làng game.
                    </p>
                    <p>
                      ...
                      dịch, cô nàng vẫn nhận được nhiều hợp đồng quảng cáo. Và
                      với phong cách <strong>sexy</strong> của mình, “bóng hồng”
                      đến từ Hải Phòng này lại một lần nữa “đốt mắt” anh em game
                      thủ với bản hợp đồng gần nhất.
                    </p>
                    <p>
                      Theo đó, <strong>Kim Chi</strong> làm hình ảnh truyền
                      thông cho một game mới. Tại đó, cô nàng diện một bộ trang
                      phục vô cùng <strong>sexy</strong> trong game, khoe trọn
                      vẹn những điểm mạnh và đường cong cơ thể. Kết hợp với hiệu
                      ứng màu sắc, nữ <strong>streamer</strong> xuất hiện cực
                      nóng bỏng, khiến cho người hâm mộ “đứng ngồi không yên”,
                    ...
                    <p>
                      ...
                      <strong>sexy</strong> này cũng khiến fan mắt chữ A miệng
                      chữ O khi quảng cáo cho một dòng loa không dây. Ở đó,{" "}
                      <strong>Kim Chi</strong> táo bạo không mặc áo, sử dụng loa
                      che khuất khuôn ngực đang lấp ló phía sau.{" "}
                    </p>
                    <p>
                      Việc đi theo phong cách <strong>sexy</strong>, xây dựng
                      hình ảnh quyến rũ này, <strong>Kim Chi</strong> cũng thừa
                      nhận mình đã từng bị không ít bình luận tiêu cực hay sự gạ
                      gẫm thô thiển. Song với cô gái trẻ này, điều ấy chỉ là thứ
                      yếu, không đáng để bận tâm. Chưa kể, ở chiều hướng ngược
                      lại, Kim Chi cũng có thêm rất nhiều bạn tốt.
                    </p>
                    <ContentImage
                      src={

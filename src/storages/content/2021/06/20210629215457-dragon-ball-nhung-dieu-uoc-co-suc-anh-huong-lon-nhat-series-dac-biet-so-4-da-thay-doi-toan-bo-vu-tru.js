                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      <strong>điều ước</strong> nhờ vào ngọc rồng đã xuất hiện
                      khá thường xuyên, bất kể là có thành công hay không, hay
                      từ bên phía phản diện lẫn chính diện. Nhưng không phải
                      điều ước nào cũng giống nhau và có tác động lớn.
                    </p>
                    <p>
                      Có những người lại muốn ước theo kiểu vô cùng lãng phí,
                      khiến người xem không thể không nghĩ: "Tại sao lại ước như
                      thế làm gì?". Nhưng cũng có những điều lại mang đến tác
                      động vô cùng lớn làm thay đổi toàn bộ cốt truyện.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      việc Piccolo quay trở lại thì có nghĩa Kami cũng hồi sinh
                      và do đó <strong>Rồng thần</strong> của Trái đất xuất
                      hiện.
                    </p>
                    <p>
                      ...
                      thể khôi phục lại tuổi trẻ cho một người bất kì, và hồi
                      sinh cho người đã chết sau 1 năm (quyền năng này là do
                      được Dende nâng cấp).
                    </p>
                    <h5>
                    ...
                    />
                    <p>
                      Đến cuối <strong>Dragon Ball</strong> Z, Majin Buu (bây
                      giờ là Kid Buu) về cơ bản đã xóa sổ mọi thứ trong đó bao
                      gồm cả Trái đất đã bị phá hủy. Lúc này Vegeta đã sử dụng
                      Dende để thực hiện hai <strong>điều ước</strong> đầu tiên
                      của mình đối với Porunga đó là khôi phục Trái đất, sau đó
                      mang lại tất cả những sinh mạng mà Buu đã giết quay trở
                      lại.
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Điều này không chỉ giúp khắc phục những thiệt hại do Buu
                      để lại, mà còn tạo cơ sở cho Goku bắt đầu thực hiện được
                      chiêu Spirit Bomb của mình. Trong khi{" "}
                      <strong>điều ước</strong> thứ ba để khôi phục sức mạnh của
                      Goku đã giúp đánh bại Buu, thì nếu không có 2 điều ước
                      trên thì tình thế sẽ không bao giờ được thay đổi.
                    </p>
                    <h5>
                      3. Shenron giải thích cách trở thành Super Saiyan God
                    </h5>
                    <ContentImage
                    ...
                    <p>
                      ...
                      giải thích của Shenron về cách đạt được Super Saiyan God
                      đã mở ra một thế giới sức mạnh mới cho các chiến binh Z.
                      Mặc dù <strong>điều ước</strong> không đặc biệt hào nhoáng
                      hay phức tạp, nhưng sự phân nhánh của nó đã dẫn đến tất cả
                      các sự kiện của các dạng Super Saiyan và hơn thế nữa.
                    </p>
                    <p>
                    ...
                    />
                    <p>
                      Tại hai thời điểm trong <strong>Dragon Ball</strong>{" "}
                      Super, Super Shenron đã khôi phục các{" "}
                      <strong>vũ trụ</strong> khỏi sự hủy diệt.{" "}
                      <strong>Điều ước</strong> đầu tiên là việc vũ trụ 6 được
                      khôi phục và thay đổi, còn điều ước thứ hai được thực hiện
                      bởi Android 17, đã khôi phục các vũ trụ khác sau khi chúng
                      bị phá hủy trong <strong>Giải đấu Quyền lực</strong>. Điều
                      ước này thật sự có tác động rất lớn đến cả vũ trụ.
                    </p>
                  </div>
                  <AdsHorizontal />
                </div>

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    ...
                    reroll ở cấp 6 đã trở nên vô cùng mạnh mẽ và thống trị meta.
                    Vì vậy việc giữ được lượng vàng, máu lớn để tìm kiếm{" "}
                    <strong>Yasuo</strong> 3 sao tại level 7 là cực kỳ khó nên
                    đội hình này không được <strong>game</strong> thủ Đấu Trường
                    Chân Lý quá trọng dụng. Tuy nhiên tới khi meta chuyển dần về
                    việc chơi xoay quanh Thây Ma thì đội hình này lại có dấu
                    hiệu hot trở lại. Thậm chí tỷ lệ lọt top 4 của team Yasuo -
                    Thây Ma hiện đang ở mức vô cùng cao.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    chống chịu chính, <strong>game</strong> thủ có thể khắc chế
                    Thây Ma Biến Dị một cách cực kỳ hiệu quả ở cuối trận. Khả
                    năng đánh cắp máu, sát thương và chỉ số phòng ngự từ kỹ năng
                    của Trundle có thể khiến Thây Ma Biến Dị trở nên "mềm" và dễ
                    bị hạ gục hơn hẳn. Hơn nữa, đội hình <strong>Yasuo</strong>{" "}
                    - Ma Sứ không hề sử dụng chủ lực hàng sau, vì vậy Thây Ma
                    Biến Dị chỉ có thể lao vào những unit chống chịu như
                    Trundle, <strong>Mordekaiser</strong> hay Pantheon mà thôi.
                  </p>
                  <ContentImage
                  ...
                  <h4>6 Thần Sứ</h4>
                  <p>
                    Những tưởng đã biến mất hoàn toàn khỏi meta thì team 6 Thần
                    Sứ lại có một pha trở lại khá ngoạn mục ở cuối phiên bản
                    11.11. Về cơ bản thì đội hình này không hề khác biệt so với
                    giai đoạn đầu mùa khi <strong>Karma</strong> vẫn là chủ lực
                    chính và được hỗ trợ bởi 2 unit Tà Thần gồm Volibear và
                    Ivern. Điều khiến cho team Thần Sứ được sử dụng nhiều trở
                    lại đó là hiệu ứng hồi phục quá mạnh, vượt ra khỏi khả năng
                    gây sát thương bùng nổ của Thây Ma Biến Dị.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Để tận dụng tốc độ đánh lớn của Thây Ma Biến Dị sau khi lao
                    tới mục tiêu, <strong>game</strong> thủ thường ghép các item
                    như Vô Cực Kiếm hay Cuồng Cung Runaan. Tuy nhiên, với hiệu
                    ứng hồi 90% máu tối đa ở mốc 6 tướng thì cả đội hình Thần Sứ
                    không hề ngại lượng sát thương lớn từ Thây Ma Biến Dị. Sau
                    khi sống sót qua lần dùng chiêu đầu tiên thì những đơn vị
                    như <strong>Karma</strong>, <strong>Riven</strong> có thể dễ
                    dàng "làm gỏi" đội hình Thây Ma với lượng sát thương lớn của
                    mình.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    <strong>Riven</strong> đều là các tướng cận chiến và bạn có
                    thể dùng Draven như một unit để "bait" Thây Ma Biến Dị. Nếu
                    bạn có thể kích hoạt hiệu ứng Tiên Tộc từ sớm thì Draven
                    cũng không hề ngại tộc Thây Ma bởi đã có sẵn khả năng miễn
                    nhiễm khống chế rồi.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Chúng ta cần nhớ rằng hầu hết các đội hình dựa vào tộc Thây
                    Ma đều không có tuyến trước quá "trâu bò". Với lượng tốc độ
                    đánh lớn và sát thương khủng thì team Quân Đoàn có thể dọn
                    dẹp đội hình Thây Ma một cách cực kỳ nhanh chóng, đặc biệt
                    là <strong>Riven</strong> với lối lên đồ dựa vào Cuồng Cung
                    Runaan. Khi đó thì dù Thây Ma Biến Dị của team bạn có bá đạo
                    tới đâu thì cũng không thể một mình hạ gục hết tất cả các
                    unit còn lại.
                  </p>
                  <ContentImage

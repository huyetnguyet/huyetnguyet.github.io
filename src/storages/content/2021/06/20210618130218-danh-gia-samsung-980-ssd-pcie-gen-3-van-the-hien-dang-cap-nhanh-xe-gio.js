                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      là 980 Pro sử dụng những công nghệ mới nhất đi kèm với
                      PCIe gen 4 băng thông lớn đem tới tốc độ "xé gió". Thế
                      nhưng điểm hạn chế nhỏ là chỉ có những nền tảng mới nhất
                      của Intel (CPU gen 11 và Mainboard Z590) hoặc AMD (CPU
                      Ryzen 3000, 5000 và Mainboard X570, B550) mới hỗ trợ.{" "}
                    </p>{" "}
                    <ContentImage
                      src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/6/17/photo-1-16239370492261108255459.jpg"
                    ...
                    <p>
                      ...
                      PCIe gen 3 phổ biến, tương thích với đại đa số các hệ
                      thống từ cũ tới mới, tốc độ không hề tồi và quan trọng là
                      giá thành rất vừa tầm không bị quá cao như các dòng PCIe
                      gen 4. Đây chính là lý do để các game thủ đang có ý định
                      nâng cấp hoặc dựng PC mới chiến game lựa chọn sản phẩm
                      này.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      tương tự như <strong>Samsung 980</strong> Pro trước đây
                      chỉ thay bằng tông chữ màu vàng mà thôi. Chiếc{" "}
                      <strong>SSD</strong> vẫn sử dụng quy chuẩn M.2. 2280 "quốc
                      dân". Một chút hấp dẫn là Samsung 980 vẫn được dán một
                      nhãn kiêm tản nhiệt ở mặt sau giúp giải phóng độ nóng tốt
                      hơn trong quá trình sử dụng.
                    </p>
                    <p>
                      Ở bên trong, <strong>Samsung</strong> 980 sử dụng chip nhớ
                      V-NAND thế hệ thứ 6 của Samsung, 128 lớp, thiết kế
                      DRAMless với controller Samsung Pablo. Để tăng tốc thì{" "}
                      <strong>SSD</strong> này tích hợp công nghệ TurboWrite
                      2.0, nhưng khác với <strong>Samsung 980</strong> Pro thì
                      sản phẩm chỉ có bộ đệm TLC động (thay vì kết hợp cả tĩnh
                      cả động) cộng với controller thấp cấp hơn. Do đó, dù có
                      dung tích lớn nhưng khi dữ liệu đầy bộ đệm thì tốc độ sẽ
                      không cao bằng đàn anh.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Để thử nghiệm tốc độ của <strong>Samsung</strong> 980,
                      chúng tôi sẽ cắm chiếc <strong>SSD</strong> vào dàn máy
                      cấu hình như sau:
                    </p>
                    ...
                    <p>
                      ...
                      tương đối cao nhưng vẫn thấp hơn một chút so với công bố
                      của NSX khi đạt 3200 MB/s (đọc) và 2320 MB/s (ghi). Tiếp
                      đến tốc độ đọc ghi ngẫu nhiên (4K) rất ổn với 62 MB/s
                      (đọc) và 161 MB/s (ghi), cho phép load game hay phần mềm
                      rất nhanh.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      trước khi hết bộ nhớ đệm và tụt xuống 800 - 900 MB/s ở
                      cuối. Phải nói là khá nhanh và ổn định khi copy dữ liệu
                      nặng lại "hỗn hợp" như thế này.
                    </p>
                    <p>
                      Về mặt tải game, chúng ta sẽ cùng thử với phần mềm
                      benchmark Final Fantasy XIV: Shadowbringers
                    </p>
                    <p>
                      Tốc độ tải 5 màn chơi là 11 giây, thuộc dạng rất nhanh so
                      với các mẫu <strong>SSD</strong> PCIe gen 3 trên thị
                      trường.
                    </p>
                    <p>
                      ...
                      khoảng 24 độ C và chạy tác vụ thông thường như load game
                      hay copy dữ liệu thì khoảng 55 độ C mà thôi.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      creator trong điều kiện hiện tại, khi mà chuẩn kết nối
                      PCIe gen 3 vẫn phổ biến hơn và điều quan trọng là tốc độ
                      của sản phẩm vẫn đáp ứng tốt các nhu cầu sử dụng thông
                      thường.
                    </p>
                    <p>
                      Hiện tại <strong>Samsung</strong> 980 có 3 phiên bản bao
                      gồm 250GB giá 1,58 triệu đồng, 500GB giá khoảng và 1TB giá
                      4,1 triệu đồng, được bán rộng rãi tại các đại lý trên toàn

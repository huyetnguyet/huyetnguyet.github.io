              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    những cái tên như Văn Hậu, Hồng Duy, Quang Hải, Duy Mạnh...
                    sau một đêm nổi tiếng không thua gì những ngôi sao hạng A.
                  </p>
                  <p>
                    Chắc chắn những người từng sống trong thời khắc hân hoan -
                    tự hào nhất của thể thao Việt Nam năm ấy vẫn còn nhớ những
                    cái ôm dưới tuyết trắng ở Thường Châu của tuyển U23 chứ đúng
                    không?
                  </p>
                  <ContentImage
                  ...
                  <p>
                    Bạn đã sẵn sàng nhìn lại sự thay đổi của họ sau 3 năm chưa?
                  </p>
                  <ContentImage
                  ...
                  <h4>Quang Hải</h4>
                  <p>
                    Có thể nói Quang Hải từng là người hùng và cũng là "tâm điểm
                    drama" từ kỳ tích Thường Châu tuyết trắng năm ấy. Chàng trai
                    sinh năm 1997 tự nhận bản thân "kém may mắn trong chuyện
                    tình cảm" nhưng trong sự nghiệp, Quang Hải luôn phong độ
                    tưng bừng!
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Vào năm 2018, Quang Hải đã có màn ghi bàn đi vào huyền thoại
                    của bóng đá Việt Nam ở Thường Châu, thậm chí còn được đặt
                    tên riêng cho cú sút này là "cầu vồng tuyết".
                  </p>
                  <ContentImage
                  ...
                  <h4>Công Phượng</h4>
                  <p>
                    Là một trong những cầu thủ xuất sắc nhất lứa U23 Việt Nam ở
                    Thường Châu, và tính tới thời điểm hiện tại, anh vẫn luôn
                    giữ phong độ trên sân cỏ. Trái ngược với sự thị phi về đời
                    tư của Quang Hải, kể từ sau thành công vang dội ở Thường
                    Châu, chàng cầu thủ xứ Nghệ luôn kín tiếng trong đời tư. Vào
                    hồi cuối năm 2020, Công Phượng chính thức cưới Viên Minh -
                    ái nữ của Giám đốc Ngân hàng Nhà nước Việt Nam chi nhánh
                    TP.HCM
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    Trường cũng đã chính thức lấy vợ là hotgirl RMIT Nhuệ Giang.
                    Từng có thời điểm, Xuân Trường mất điểm trong mắt người hâm
                    mộ vì loạt hành động trên MXH. Đó cũng là lý do mà ở thời
                    điểm hiện tại, Xuân Trường trở nên kín tiếng hơn và gần như
                    "ở ẩn", thi thoảng mới cập nhật vài bức hình làm vui lòng
                    người hâm mộ.{" "}
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    niên có gương mặt búng ra sữa, Văn Hậu giờ đã là thanh niên
                    cao 1m85, thân hình 6 múi vạm vỡ và là cầu thủ được đánh giá
                    sẽ toả sáng hơn nữa trong tương lai.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Chàng trai "tô son" năm ấy bán hàng online chốt đơn lia lịa
                    bây giờ đã trưởng thành hơn, đá "căng" hơn rất nhiều.
                  </p>
                  <h4>Duy Mạnh</h4>
                  <ContentImage
                  ...
                  <p>
                    ...
                    Thường Châu vẫn còn là cậu trai tân chưa lập gia đình. Hiện
                    tại, Duy Mạnh đang có cuộc hôn nhân hạnh phúc với "công chúa
                    béo" Quỳnh Anh và có một nhóc tỳ cực kì kháu khỉnh. Tất
                    nhiên, dù đã lên chức bố thì "Mạnh gắt" vẫn mãi là "Mạnh
                    gắt" nhé.
                  </p>
                  <h4>Văn Thanh</h4>
                  <ContentImage
                  ...
                  <p>
                    ...
                    ấy giờ đã trở thành nam thần sở hữu cơ bắp "múi sầu riêng",
                    đẹp trai phong độ rạng ngời.
                  </p>
                  <p></p>
                  <h4>Bùi Tiến Dũng</h4>
                  <ContentImage
                  ...
                  />
                  <p>
                    Anh chàng vừa gây sốt với màn khoe múi bụng được cô vợ share
                    tưng bừng trên Facebook hoá ra cũng từng... cởi hẳn áo để ăn
                    mừng ở Thường Châu. Cũng giống như Duy Mạnh, Bùi Tiến Dũng
                    sau 3 năm thì giờ cũng đã lên chức bố, có tổ ấm hạnh phúc
                    với cô nàng Khánh Linh.
                  </p>
                  <h4>Khán giả</h4>
                  ...
                  <p>
                    ...
                    không liệt kê đó chính là những khán giả cuồng nhiệt của đội
                    tuyển U23 Việt Nam. Ba năm trước, dân tình tha hồ tụ tập
                    đông đúc ở quán cà phê, quảng trường để xem đá bóng, thì
                    hiện tại, chúng ta phải cổ vũ các chàng trai tại nhà, xem
                    livestream trên YouTube vì ảnh hưởng của COVID-19. Nhưng xem
                    đá bóng bằng cách nào thì quan trọng nhất là tình yêu dành
                    cho bộ môn thể thao vua vẫn không hề thay đổi. Đúng không
                    "quý zị"?
                  </p>
                  <p>Nguồn: Tổng hợp</p>
                </div>

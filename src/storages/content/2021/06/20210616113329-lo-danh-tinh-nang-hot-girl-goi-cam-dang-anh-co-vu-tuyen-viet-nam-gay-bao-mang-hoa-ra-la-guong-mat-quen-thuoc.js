            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Trong thời đại mà mạng xã hội cũng như Internet đang phổ cập
                    và phát triển với một tốc độ chóng mặt như hiện nay, câu
                    chuyện về các cô nàng <strong>hot girl</strong> xinh đẹp
                    xuất hiện đã dần trở thành một điều gì đó khá quen thuộc đối
                    với cộng đồng mạng. Và mới đây thôi, chỉ với một bức ảnh cổ
                    động tuyển Việt Nam một cách rất đơn giản, thế nhưng cô nàng
                    hot girl này lại nhanh chóng trở thành tâm điểm của mọi sự
                    chú ý, đồng thời tạo ra một cơn sốt không hề nhỏ trên mạng
                    xã hội.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    ...
                    không ít người còn rất năng nổ trong việc tìm ra info của cô
                    gái xinh đẹp, trắng trẻo trong khung hình. Tất nhiên, cũng
                    không mất quá nhiều thời gian để danh tính của cô nàng được
                    tìm ra. Tưởng ai xa lạ, hóa ra đó chính là Lê Phương Anh,
                    một <strong>hot girl</strong> sinh năm 1997 tại Hà Nội. Sở
                    dĩ nói không xa lạ bởi vì mức độ nổi tiếng của nàng hot girl
                    cũng không phải dạng vừa với gần 300.000 lượt theo dõi trên
                    Facebook cá nhân trong khi con số tương tự trên Instagram
                    thậm chí còn tiệm cận con số 300.000.
                  </p>
                  <p>
                    Lê Phương Anh cũng đã từng gây bão cộng đồng mạng với bộ ảnh
                    cực kỳ xinh đẹp của mình
                  </p>
                  <p>
                    Sở hữu nhan sắc cực kỳ đáng yêu, mật ngọt nhưng lại cũng
                    không kém phần gợi cảm với số đo ba vòng 79-65-89 cân đối và
                    hoàn hảo, Phương Anh thậm chí còn được ví như "thần tiên tỷ
                    tỷ". Và dành cho những ai chưa biết thì cô nàng từng xuất
                    hiện trên báo nước ngoài và cũng được ca ngợi nhờ nhan sắc
                    cực kỳ ấn tượng của mình cùng với em gái. Bản thân nàng{" "}
                    <strong>hot girl</strong> cũng từng chia sẻ rằng đó chỉ là
                    những con số, cũng như việc nổi tiếng vì sự xinh đẹp, gợi
                    cảm cũng mang lại vô số phiền toái khác, nhưng Phương Anh tự
                    coi đó là những thử thách cần phải vượt qua mà thôi.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    Hiện tại, cô nàng đang theo đuổi sự nghiệp người mẫu ảnh và
                    mọi thứ tới khá tình cờ khi chỉ với việc đăng ảnh lên trang
                    cá nhân như bao cô gái bình thường khác, Lê Phương Anh bất
                    ngờ nhận được vô số lời đề nghị chụp quảng cáo. Hiện tại, cô
                    nàng vẫn đang trung thành với phong cách gợi cảm trong các
                    bộ ảnh của mình.
                  </p>
                  <p>

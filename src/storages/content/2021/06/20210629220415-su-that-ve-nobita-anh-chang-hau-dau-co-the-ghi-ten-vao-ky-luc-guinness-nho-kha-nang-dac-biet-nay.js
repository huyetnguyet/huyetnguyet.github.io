              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    />
                    <p>
                      Mới đây Rikao Yanagita, một giảng viên tại khoa khoa học
                      và kỹ thuật của Đại học Meiji và là tác giả của bộ sách
                      Phòng thí nghiệm Khoa học trong mơ (The Dream-Science
                      Laboratory), đã tổng hợp lại số lần{" "}
                      <strong>Nobita</strong> ăn "trứng ngỗng" trong các bài
                      kiểm tra và chỉ ra cậu học kém đến thế nào.
                    </p>
                    <p>
                      Theo đó thì sau hai ngày cày hết 45 tập truyện tranh
                      Doraemon, Yanagita phát hiện ra rằng những vấn đề xoay
                      quanh chủ đề học tập và việc học kém của{" "}
                      <strong>Nobita</strong> có tổng cộng 170 chương. Đầu tiên
                      là điểm kiểm tra của Nobita được đề cập đến trong 45 tập
                      truyện tổng cộng 43 lần, điều đáng chú ý ở đây là Nobita
                      ăn "trứng ngỗng" trong 26 bài kiểm tra, tức là khoảng 60%
                      tổng số bài kiểm tra của cậu đạt được 0 điểm. Điểm 0 đầu
                      tiên của cậu xuất hiện trong Tập 2, và từ đó đến Tập 20,
                      Nobita bị điểm 0 trong các bài kiểm tra của mình 7 lần
                      liên tiếp.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      đã trả lời sai liên tục 20 câu liên tiếp trong bài kiểm
                      tra, quan trọng hơn là hai mươi câu đó được làm theo thể
                      thức đúng/sai.
                    </p>
                    <p>
                      Tức là tỷ lệ nằm ở 50%, nhưng với <strong>Nobita</strong>{" "}
                      thì bằng một cách thần kỳ nào đó cậu đã trả lời sai tất
                      cả. Tỷ lệ để một người có thể làm được như Nobita là 1/(2
                      ^ 40), hoặc cụ thể hơn là 1 trên 1,099,511,627,776.
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Đây có thể coi là một con số và thành tích cực kỳ đáng nể
                      khi không phải ai cũng có thể làm được. Quả thật, khả năng
                      trả lời câu hỏi và vận may của <strong>Nobita</strong>{" "}
                      khiến người khác không còn gì để nói, nếu như Nobita có
                      mặt ở ngoài đời thật thì không chừng cậu sẽ đạt được kỷ
                      lục Guinness của thế giới với khả năng đặc biệt này.
                    </p>
                    <ContentImage

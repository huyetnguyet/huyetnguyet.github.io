                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      quanh cuộc đối đầu giữa chiến binh mạnh nhất vũ trụ
                      Granola với chiến binh Saiyan <strong>Son Goku</strong>.
                      Granola liên tục bắn chưởng tấn công Goku và dụ anh vào
                      một cánh rừng gần đó. Trong lúc truy đuổi, Goku cố tung
                      chưởng tấn công nhưng Granola nhanh chóng tránh né. Địa
                      hình rừng cây cũng khiến việc theo dấu Granola trở nên khó
                      khăn hơn. Được một lúc, Granola thoát khỏi tầm nhìn của
                      Goku. Ngay khi Goku đang bối rối, Granola xuất hiện từ
                      phía sau và đá bay Goku đi.
                    </p>
                    <ContentImage
                      src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/6/18/go1-16239900225751533435803.jpg"
                    ...
                    <p>
                      ...
                      Granola bất ngờ trước sự tăng tiến sức mạnh của Goku. Anh
                      ta bị đánh văng vào một mỏm đá. Goku dịch chuyển đến và
                      nói chuyện với Granola vài ba câu. Granola tiết lộ rằng
                      người đang chiến đấu với Goku chỉ là phân thân do Granola
                      tạo ra. Ngay sau đó, Granola tung một đòn chí mạng vào tim
                      khiến Goku văng ra xa rồi bất tỉnh.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Như vậy dù đã kích hoạt được{" "}
                      <strong>Ultra Instinct</strong> tuy nhiên điều mà Goku làm
                      được chỉ là tấn công được phân thân của Granola mà thôi.
                      Ngay lập tức thì điều này đã khiến nhiều fan Dragon Ball
                      Super cảm thấy bất ngờ. Nhiều người cho rằng cách mà tác
                      giả đang làm khiến cho Ultra Instinct bị "dìm hàng" một
                      cách trầm trọng. Trước đó với Ultra Instinct chúng ta đã
                      thấy Goku mạnh mẽ và áp đảo như thế nào khi đối đầu với
                      Moro. Sau quá trình tập luyện với{" "}
                      <strong>Thiên Sứ Whis</strong>, Ultra Instinct của Goku đã
                      được cải thiện rất nhiều, tuy nhiên khi đối đầu với
                      Granola nó lại chỉ là một thứ vô dụng. Nhiều fan Dragon
                      Ball Super hài hước cho rằng giống như trong LMHT vậy,
                      Ultra Instinct có vẻ như đã "out meta" khi đối đầu với
                      Granola.
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Trong khi đó nhiều fan Dragon Ball Super lại cho rằng việc
                      Goku bị đánh bại là kịch bản quen thuộc để tạo ra "đất
                      diễn" cho Vegeta thể hiện khả năng của mình. Đây cũng là
                      cách quen thuộc mà tác giả hay sử dụng để tạo thêm kịch
                      tính cho Dragon Ball Super. Vegeta sẽ thể hiện khả năng
                      của mình trước Granola trong khi đó Goku sau khi bình phục
                      vẫn sẽ là người tiếp tục quay trở lại trận chiến với chiến
                      binh mạnh nhất vũ trụ Granola.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      <strong>Dragon Ball Super chap 73</strong>? Liệu điều này
                      là một kịch bản quen thuộc hay thực sự khả năng của Goku
                      vô dụng trước Granola? Hãy để lại ý kiến của mình về vấn
                      đề này nhé!
                    </p>
                  </div>
                  <AdsHorizontal />

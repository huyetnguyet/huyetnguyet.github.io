                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      dù có thể chịu sự ghẻ lạnh từ gia đình, định kiến của xã
                      hội nhưng hiếm có trường hợp nào một cô nàng hot girl lại
                      phải chịu gạch đá từ chính khán giả của mình. Tuy nhiên,
                      hiếm chứ không phải là không có. Và cô nàng{" "}
                    ...
                    />
                    <p>
                      Theo đó, <strong>Makoto Toda</strong> ban đầu nhận được
                      rất nhiều sự kỳ vọng từ phía người xem, cũng như bao nhiêu
                      các tân binh khác. Thậm chí, cô nàng còn được coi là tài
                      năng lớn cũng như gây ấn tượng nhất của SOD - một studio
                      siêu nổi tiếng trong ngành công nghiệp{" "}
                      <strong>
                        phim <strong>AV</strong>
                      </strong>{" "}
                      Nhật Bản. Điều ấn tượng nhất là trong tác phẩm debut,
                      Makoto còn được giới thiệu như một trinh nữ, vẫn còn "cái
                      ngàn vàng". Thế nhưng, chẳng ai ngờ được rằng màn PR này
                      lại nhận phải hiệu ứng ngược cực kỳ dữ dội từ phía khán
                      giả.
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      được đưa ra cho rằng Makoto chẳng có tài năng nổi bật gì
                      mà chỉ đơn giản là được công ty ưu ái. Có bình luận còn
                      cay nghiệt gọi cô nàng là một kẻ đạo đức giả một cách khá
                      tiêu cực.
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      tới mức còn soạn hẳn một bức tâm thư để đáp trả các fan.
                      Cụ thể, trong đó cô nàng tự cho rằng đây là tình trạng mà
                      người nổi tiếng hay gặp phải, cũng như khẳng định mình
                      sinh ra không phải để làm vừa lòng tất cả và chỉ cần sống
                      vì bản thân mà thôi. Cũng sau tuyên bố đó, Makoto gần như
                      không hề ngó ngàng tới mạng xã hội nữa. Trang cá nhân của
                      cô nàng cũng được chuyển giao cho công ty quản lý.
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      Nhật Bản, phân tích cặn kẽ các chi tiết. Chưa kể, Makoto
                      còn đang bắt đầu bước chân vào con đường làm biên kịch,
                      đạo diễn cho chính các tác phẩm 18+ của mình nữa. Cũng kể
                      từ đó, cô nàng bắt đầu được nhiều người gọi tới với biệt
                      danh "đạo diễn trinh nữ" theo cách khá mỉa mai.
                    </p>
                    <ContentImage
                      src={

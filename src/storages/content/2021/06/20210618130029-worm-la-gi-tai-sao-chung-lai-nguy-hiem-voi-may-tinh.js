                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      <strong>chương trình phần mềm</strong> độc hại có chức
                      năng chính là lây nhiễm sang các máy tính khác trong khi
                      vẫn hoạt động trên những hệ thống bị nhiễm.
                    </p>
                    <p>
                      ...
                      phần tự động và vô hình đối với người dùng của hệ điều
                      hành. Thông thường, worm chỉ được chú ý khi sự sao chép
                      không kiểm soát của chúng tiêu tốn tài nguyên hệ thống,
                      làm chậm hoặc tạm dừng các tác vụ khác.
                    </p>
                    <h3>
                    ...
                    <p>
                      ...
                      các thiết bị lưu trữ khác được kết nối với hệ thống. USB
                      vẫn là một vector phổ biến cho worm máy tính.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      <strong>Worm</strong> máy tính thường dựa vào các hoạt
                      động và lỗ hổng trong những giao thức mạng để lan truyền.
                      Ví dụ, worm WannaCry ransomware đã khai thác một lỗ hổng
                      trong phiên bản đầu tiên của giao thức chia sẻ tài nguyên
                      Server Message Block (SMBv1) được triển khai trong{" "}
                      ...
                      cuộc tìm kiếm các nạn nhân tiềm năng mới trên mạng: Những
                      hệ thống phản hồi các yêu cầu SMBv1 do worm này thực hiện.
                      Worm có thể tiếp tục lây lan trong một tổ chức theo cách
                      này. Khi người mang theo thiết bị riêng (BYOD) bị nhiễm,
                      worm này có thể lây lan sang các mạng khác, cho phép tin
                      tặc quyền truy cập nhiều hơn.
                    </p>
                    <p>
                    ...
                    <p>
                      Stuxnet, một trong những loại <strong>worm</strong> máy
                      tính khét tiếng nhất cho đến nay, bao gồm một thành phần
                      worm lan truyền <strong>phần mềm độc hại</strong> thông
                      qua việc chia sẻ các thiết bị USB bị nhiễm, cũng như phần
                      mềm độc hại nhắm vào hệ thống kiểm soát giám sát và thu
                      thập dữ liệu (SCADA), được sử dụng rộng rãi trong môi
                      trường công nghiệp, bao gồm các tiện ích điện, dịch vụ cấp
                      nước, nhà máy xử lý nước thải và nhiều nơi khác.{" "}
                      <strong>Worm máy tính</strong> thuần túy tự lan truyền từ
                      hệ thống bị nhiễm sang hệ thống không bị nhiễm, nên khó mà
                      giảm thiểu khả năng bị hư hại từ những con worm máy tính
                      như vậy.
                    </p>
                    <p>
                      ...
                      đoạn mạng thông qua sự bão hòa của các liên kết mạng với
                      lưu lượng độc hại.
                    </p>
                    <h3>
                    ...
                    <p>
                      Virus máy tính hoặc <strong>worm</strong> hybrid là một
                      phần của <strong>phần mềm độc hại</strong> lây lan giống
                      như một worm, nhưng nó cũng sửa đổi code chương trình
                      giống như một loại virus - hoặc mang theo một số loại
                      payload độc hại, chẳng hạn như virus, ransomware hoặc một
                      số loại phần mềm độc hại khác.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      nhắn tin tức thời và khai thác quyền truy cập vào danh
                      sách liên hệ trên máy tính nạn nhân.
                    </p>
                    ...
                    <p>
                      ...
                      là do khả năng gây hại không mong muốn đối với các hệ
                      thống phản ứng bất ngờ với phần mềm như vậy, lớn hơn khả
                      năng loại bỏ các lỗ hổng. Trong mọi trường hợp, việc sử
                      dụng bất kỳ phần mềm nào thay đổi hệ thống mà không có sự
                      cho phép của chủ sở hữu hệ thống sẽ khiến nhà xuất bản
                      phải chịu nhiều cáo buộc hình sự và dân sự khác nhau.
                    </p>
                    <h3>
                    ...
                    <p>
                      ...
                      <strong>phần mềm độc hại</strong> xâm nhập vào hệ thống.
                      Sử dụng phần mềm diệt virus sẽ giúp ngăn phần mềm độc hại
                      chạy. Cẩn thận không nhấp vào file đính kèm, liên kết
                      trong email hoặc các ứng dụng nhắn tin khác có thể khiến
                      hệ thống tiếp xúc với phần mềm độc hại. Mã hóa file để bảo
                      vệ dữ liệu nhạy cảm được lưu trữ trên máy tính, máy chủ và
                      thiết bị di động
                    </p>
                    <p>

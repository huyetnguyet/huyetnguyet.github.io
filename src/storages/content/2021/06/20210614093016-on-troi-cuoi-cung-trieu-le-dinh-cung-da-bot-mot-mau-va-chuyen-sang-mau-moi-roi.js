              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    />
                    <p>
                      Tuy nhiên, nàng chỉ nhất nhất trung thành với trang phục
                      màu trắng khiến hình ảnh cứ mãi đóng khung trong 1 sắc tái
                      tẻ nhạt, không chút ấn tượng.
                    </p>
                    ...
                    <p>
                      ...
                      một màu thì stylist cũng đã dần thay đổi. Trong sự kiện
                      diễn ra gần đây, mỹ nhân họ Triệu diện mẫu đầm hồng pastel
                      ngọt ngào như tiểu thư tuổi 18. Tuy bộ cánh vẫn mang tông
                      pastel nhẹ nhàng nhưng đã có phần khác biệt so với những
                      bộ đồ trắng nhàm chán mà cô diện trước đó.
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      và tím khác biệt. Trang phục tươi sáng, ngọt ngào vừa đủ
                      tôn lên vẻ trẻ trung của Triệu Lệ Dĩnh mà vẫn khiến hình
                      ảnh của cô thêm phần mới mẻ, không bị nhàm chán.
                    </p>
                    <RelationNewsInPage category={category} />

                    <p>
                      Triệu Lệ Dĩnh vốn có gương mặt bầu bĩnh và nước da sáng
                      nên cô hợp với những bộ cánh có sắc màu tươi tắn hẳn. Thay
                      vì chỉ mãi đóng khung với những bộ cánh màu trắng, cô có
                      thể thử nghiệm với nhiều màu sắc khác biệt để làm mới hình
                      ảnh.
                    </p>
                    <ContentImage
                      src={
                    ...
                    />
                    <p>
                      Sao Đỏ Thời Trang dành tặng Triệu Lệ Dĩnh điểm khuyến
                      khích khi đã nỗ lực làm mới hình ảnh, đổi màu trang phục
                      sau thời gian chỉ mãi diện đồ trắng. Hy vọng cô sẽ tiếp
                      tục phát huy và mang đến nhiều style thú vị hơn.
                    </p>

            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Là một trong những <strong>hot girl</strong>. TikToker đình
                    đám nhất ở thời điểm hiện tại, <strong>Lê Bống</strong> hiện
                    đang nhận được rất nhiều sự quan tâm từ phía{" "}
                    <strong>cộng đồng mạng</strong>. Cũng dễ hiểu thôi, khi với
                    lượng follow lên tới hàng triệu người trên nhiều nền tảng,
                    Lê Bống luôn khiến bản thân trở thành tâm điển mỗi khi xuất
                    hiện tại một sự kiện, hay đơn giản hơn là chỉ với một vài
                    tấm ảnh được nhá nhẹ. Tuy nhiên, chính điều này đôi khi cũng
                    khiến cho cô nàng hot girl gặp vô số những rắc rối.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    ...
                    đuổi phong cách gợi cảm ở mọi lúc mọi nơi. Tuy nhiên, chính
                    điều này lại dẫn tới những rắc rối khó đỡ và quả thật, không
                    ít lần lỗi trang phục từ Lê Bống đã khiến cho người xem phải
                    chỉ trích về sự phản cảm. Bằng chứng là mới đây, bộ ảnh mà
                    cô nàng chụp sau khi vận động ở hồ Tây lại càng khiến cho
                    nhiều người phản ứng tiêu cực.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    ...
                    <strong>Lê Bống</strong> rất tự tin khi khoe vóc dáng với số
                    đo ba vòng chuẩn chỉnh của mình. Tuy nhiên, điều đáng chú ý
                    là trong nhiều kiểu ảnh, Lê Bống còn hồn nhiên, vô tư phô
                    diễn vòng ba của mình với các tư thế khá táo bạo. Tất nhiên,
                    hình ảnh này nhanh chóng nhận phải những gạch đá trái chiều
                    từ phía người xem. Một số người thậm chí còn cho rằng Lê
                    Bống đẹp, nhưng lại không biết thể hiện điều này một cách
                    khéo léo và những hình ảnh trên chỉ mang tới sự phản cảm.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    ...
                    <strong>cộng đồng mạng</strong> có phần săm soi và hơi nhạy
                    cảm thái quá với phong cách gợi cảm của nàng{" "}
                    <strong>hot girl</strong>. Tuy nhiên, sau sự cố lần này, gần
                    như chẳng còn ai lên tiếng bênh vực cô nàng TikToker nổi
                    tiếng nữa.
                  </p>
                  <ContentImage
                    src={

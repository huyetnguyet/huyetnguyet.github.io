            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  />
                  <p>
                    Trong mỗi lượt đi, bạn sẽ có 2 lần hành động. Bạn có thể tùy
                    ý dùng chúng để di chuyển, tấn công, phòng ngữ hoặc dùng sức
                    mạnh đặc biệt (khi đã tích đủ năng lượng). Game có nhiều lớp
                    nhân vật khác nhau, từ những chiến binh cận chiến mạnh mẽ
                    (những người đóng vai trò tanker) cho đến cung thủ tầm xa và
                    cả những nhân vật chuyên sử dụng sức mạnh phép thuật.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Mục tiêu của bạn sẽ thay đổi theo từng thử thách. Không chỉ
                    đơn giản là đánh bại đối thủ, bạn còn phải sinh tồn trong
                    những trận chiến nguy hiểm hoặc chạy đua để hoàn thành các
                    mục tiêu trước khi địch lao về phía bạn như vũ bão.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    bạn sẽ sớm chiêu mộ được cả một lực lượng chiến đấu luôn sẵn
                    sàng tham gia mọi thử thách, bao gồm các nhiệm vụ hàng ngày
                    và nhiệm vụ chủ chốt.
                  </p>
                  <p>

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    />
                    <p>
                      Trong buổi phỏng vấn với tạp chí Yomiuri, ông Ken
                      Sugimori, giám độc nghệ thuật của series{" "}
                      <strong>Pokemon</strong> mới đây đã tiết lộ rằng, nhà sản
                      xuất Koji Nishino chính là hình mẫu cho{" "}
                      <strong>Snorlax</strong>. Theo ông Sugimori cho biết,
                      Nishino được chọn vì ngoại hình cồng kềnh quá khổ của
                      mình, đồng thời Nishino cũng rất thích những thứ dễ
                      thương. Nghe cũng hợp lý so với Snorlax, đúng không?
                    </p>
                    <p>
                      Trước đó, cũng có những thông tin rằng Nishino có chút
                      liên quan tới chú <strong>Pokemon</strong> béo ú này. Cư
                      dân internet đã tìm thấy một hình ảnh của Nishino cùng
                      dòng chữ trích dẫn: "<strong>Snorlax</strong> giống như là
                      con của tôi".
                    </p>
                    <h3>2. Hitmonlee </h3>
                    <ContentImage
                    ...
                    <p>
                      ...
                      này. Theo đó, tên tiếng Nhật của Hitmonlee là Sawamular.
                      Đây là cái tên dựa trên võ sĩ kickbox Tadashi Sawamura,
                      người đã có 94,6% tỉ lệ thắng trong suốt sự nghiệp thi đấu
                    ...
                    <p>
                      ...
                      <strong>Hitmonchan</strong> cũng được thiết kế dựa trên
                      hình tượng của 2 võ sĩ khác nhau. Cái tên đầu tiên là
                      Jackie Chan - Thành Long, ngôi sao võ thuật - phim ảnh nổi
                      tiếng trên khắp toàn cầu và được đông đảo công chúng biết
                      tới. Cái tên còn lại là tay đấm Hiroyuki Ebihara, người có
                      62 trận thắng và 5 trận thua trong suốt sự nghiệp thi đấu.
                      Các nhà làm game đã tri ân ông bằng cái tên tiếng Nhật của
                      Pokémon này là Ebiwalar.
                    </p>
                    ...
                    <p>
                      {" "}
                      Wobbuffet là một Pokémon khá kỳ lạ. Nó đã được thay đổi
                      vài lần trong quá trình thiết kế của 2 tựa game Pokémon
                      Gold & Silver. Sau khi được chỉnh sửa lại, nó có một ngoại
                      hình trông khá hài hước và dí dỏm ở thời điểm hiện tại. Lý
                      do của việc này là Wobbuffet ít nhiều được lấy cảm hứng từ
                      một diễn viên hài Nhật Bản Hayashiya Sanpei. Hành động
                      thích chạm tay lên trán của Wobbuffet cũng được lấy từ
                      hình tượng của danh hài này.{" "}
                    </p>
                    <h3>5. Obstagoon</h3>
                    <ContentImage
                    ...
                    <p>
                      ...
                      đen cùng nhiều gai nhọn trên người, không khó để nhiều
                      người đã hình dung Pokémon này dường như được lấy cảm hứng
                      một tay chơi nhạc rock từng xuất hiện trong thập niên 80.
                      Đáp án "gần gũi" nhất có lẽ là siêu sao nhạc rock có tên
                      Gene Simmons thuộc ban nhạc hard rock Kiss.{" "}
                    </p>
                  </div>
                  <AdsHorizontal />
                </div>

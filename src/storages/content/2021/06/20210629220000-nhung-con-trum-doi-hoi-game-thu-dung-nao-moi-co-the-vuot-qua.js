                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    <p>
                      ...
                      <strong>game</strong>play và những con{" "}
                      <strong>trùm</strong> đầy tính sáng tạo. The Sorrow chính
                      là một ví dụ như vậy, khi hắn không phải là một đối thủ
                      "dễ chơi". Khó nhằn không phải vì hắn đòi hỏi kỹ năng cao
                      hay máu trâu, mà đơn giản The Sorrow troll người chơi một
                      cách đầy khó chịu.
                    </p>
                    <p>
                      ...
                      chơi và thế là... game over. Để giải quyết vấn đề này cực
                      kỳ đơn giản, người chơi chỉ cần tiếp tục mở kho đồ và chọn
                      viên thuốc hồi sinh lên là... chơi tiếp được. Đúng là cú
                      lừa đau xót cho các game thủ mày mò suốt cả màn chơi.{" "}
                    </p>
                    ...
                    <p>
                      ...
                      hiện nút O yêu cầu người chơi thực hiện chuỗi hành động
                      QTE như mọi khi, nhưng sự thật hoàn toàn không phải là
                      vậy.
                    </p>
                    ...
                    <p>
                      ...
                      <strong>game</strong> mới tiếp tục chiếu đoạn cắt cảnh
                      cuối cùng. Dĩ nhiên là Kratos rất thù oán Zeus, nhưng đập
                      thế chứ có đập nữa thì Kratos cũng không nguôi cơn giận
                      cho được.
                    </p>
                    ...
                    <p>
                      Thực chất thì, cách qua ải ở đây là buông xuôi và chấp
                      nhận cái chết của mình. Trong lúc trận đấu đang diễn ra
                      thì bạn sẽ nghe giọng nói trong đầu bảo là hãy từ bỏ đi,
                      nhưng đầu <strong>game</strong> đến giờ bạn sẽ biết được
                      một điều là không nên tin vào giọng nói này, cho nên cứ
                      cắm đầu cắm cổ mà đánh thôi. Một cú lừa khá là ngoạn mục
                      đấy.
                    </p>
                  </div>
                  <AdsHorizontal />

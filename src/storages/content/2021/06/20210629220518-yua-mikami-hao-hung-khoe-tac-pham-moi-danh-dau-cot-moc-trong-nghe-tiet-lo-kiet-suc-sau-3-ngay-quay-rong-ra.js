            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Cái tên <strong>Yua Mikami</strong> chưa bao giờ là hết hot
                    đối với các fan của ngành công nghiệp <strong>AV</strong>{" "}
                    Nhật Bản. Tuy rằng thời gian gần đây, nàng{" "}
                    <strong>hot girl</strong> gần như chẳng cho ra mắt bất kỳ
                    tác phẩm mới nào thật sự gây ấn tượng, nhưng không vì thế mà
                    các hoạt động của Yua Mikami có dấu hiệu gián đoạn. Nếu như
                    để ý theo dõi trên trang cá nhân của cô nàng, có lẽ không
                    khó để nhận ra rằng "thánh nữ" của làng{" "}
                    <strong>phim AV</strong> Nhật Bản vẫn đang miệt mài chạy
                    show với vô số những sự kiện lớn nhỏ. Chỉ duy nhất các hình
                    ảnh hậu trường hay lịch quay phim là cô nàng không hề đả
                    động mảy may mà thôi.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    ...
                    <strong>Yua Mikami</strong>, số đông các fan còn bày tỏ mong
                    muốn cô nàng đừng nên quên mất nguồn gốc nghề nghiệp - thứ
                    đã đưa tên tuổi của nàng <strong>hot girl</strong> tới với
                    số đông. Và mới đây, một tin vui dành cho các fan hâm mộ của
                    Yua Mikami, khi mà cô nàng đã bất ngờ đăng tải một dòng
                    trạng thái liên quan tới bộ phim mới ra mắt. Dựa theo những
                    gì mà nàng hot girl đăng tải, thì Yua Mikami vừa hoàn thành
                    xong một tác phẩm đánh dấu cột mốc kỷ niệm 6 năm trong nghề
                    của cô nàng, đồng thời hứa hẹn nó chứa vô số những nội dung
                    thú vị. Bản thân Yua Mikami cũng đã phải mất tới 3 ngày ròng
                    rã quay liên tục để hoàn thành nó.
                  </p>
                  <ContentImage
                    src={
                  ...
                  />
                  <p>
                    Bên cạnh đó, <strong>Yua Mikami</strong> cũng đồng thời tung
                    ra thêm một số thông tin rất hot liên quan tới tác phẩm lần
                    này. Cụ thể, bộ phim sẽ có thời lượng lên tới hơn 4 tiếng và
                    tạm thời, mức giá được ấn định khi phát hành là khoảng 2.500
                    yên, tương đương với khoảng 500.000 VNĐ.
                  </p>
                  <ContentImage
                    src={

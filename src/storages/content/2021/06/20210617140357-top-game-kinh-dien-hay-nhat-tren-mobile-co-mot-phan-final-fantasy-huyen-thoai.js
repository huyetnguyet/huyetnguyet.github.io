                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      có thời lượng chơi cao nhất. Trong một game nhập vai,
                      người chơi thường bước vào chân vào thế giới của một nhân
                      vật và tham gia vào hàng loạt các cuộc phiêu lưu, đạt cấp
                      độ tối đa về kỹ năng trên con đường khám phá thế giới.
                    </p>
                    <p>
                      Do sự phổ biến của thể loại này mà rất nhiều game nhập vai
                      đã được ra đời và thậm chí là chuyển thể từ PC sang
                      Mobile. Hãy cùng tìm xem năm cái tên được đánh giá là hấp
                      dẫn bậc nhất trên di động của thể loại game này nhé.
                    </p>
                    <h3>Titan Quest</h3>
                    <ContentImage
                      src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/6/16/photo-1-16238616599652048581583.jpg"
                    ...
                    <p>
                      ...
                      thoại , nhưng trên bối cảnh thần thoại Hy Lạp. Tiền thân
                      của các vị thần, các Titan, đã trốn thoát khỏi nhà tù và
                      đang nhắm tới việc tiêu diệt thế giới của con người. Một
                      mình các vị thần không thể ngăn cản họ - một anh hùng phải
                      vươn lên để lãnh đạo cuộc chiến và bảo vệ nhân loại.
                    </p>
                    ...
                    />
                    <p>
                      Đây là một trong những game nhập vai cổ điển hay nhất và
                      giờ đây, toàn bộ thứ đã được chuyển sang thiết bị di động.
                      Câu chuyện tiếp tục sau các sự kiện của Baldur's Gate 1,
                      với việc nhân vật chính phải chống lại một kẻ thù mới
                      toanh, một pháp sư quyền năng tên là Jon Irenicus. Phần
                      hay nhất của trò chơi này có lẽ là độ dài của nó. Phần
                      chơi Shadows of Amn ban đầu đã có hơn 60 giờ ... và hiện
                      tại, phiên bản này có hơn ba bản mở rộng khác. Người chơi
                      có thể tương tác với môi trường, nói chuyện với NPC và
                      tương tác với thế giới của Baldur's Gate II.
                    </p>
                    <h3>Icewind Dale</h3>
                    <ContentImage
                    ...
                    <p>
                      Được phát hành lần đầu vào năm 2000, Icewind Dale là một
                      trò chơi D & D lấy bối cảnh Forgotten Realms huyền thoại
                      của Wizards of The Coast. Trong trò chơi này, nhân vật
                      chính sẽ khám phá một vùng lãnh nguyên băng giá được gọi
                      là Icewind Dale. Nhiệm vụ của game thủ là hành trình vào
                      dãy núi Spine of the World và đối đầu với một âm mưu xấu
                      xa đang đe dọa hủy diệt khu vực. Icewind Dale cũng được
                      thực hiện bởi nhà phát triển Baldur's Gate, và vì thế, nó
                      có lối chơi giống hệt như vậy.
                    </p>
                    <h3>Eternium</h3>
                    <ContentImage
                    ...
                    />
                    <p>
                      Eternium là game nhập vai đầu tiên trong danh sách này
                      được thiết kế cho di động ngay từ đầu. Nó không phải là
                      một phiên bản chuyển thể từ PC nào hết. Lối chơi trong
                      Eternium là một cuộc cách mạng và tạo nên được sự đặc biệt
                      so với các sản phẩm ARPG khác.
                    </p>
                    ...
                    />
                    <p>
                      Và cũng trong phiên bản <strong>Final Fantasy</strong>{" "}
                      này, một nhân vật nổi tiếng đã trở nên thân thuộc hơn bao
                      giờ hết, đó chính là nàng Tifa đã từng khiến trái tim của
                      biết bao game thủ phải rung động.
                    </p>
                    <ContentImage

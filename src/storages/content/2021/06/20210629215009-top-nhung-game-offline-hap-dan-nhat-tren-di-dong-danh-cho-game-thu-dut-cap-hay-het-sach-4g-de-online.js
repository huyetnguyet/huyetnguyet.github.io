                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    <p>
                      ...
                      nhàng giúp người chơi thoải mái ngay cả khi chơi trong
                      thời gian dài. Cách điều khiển trong tựa game này cũng khá
                      trực quan vì chỉ cần một nút cũng đủ để khiến cho game thủ
                      làm chủ được mọi thứ.
                    </p>
                    <h5>GRID</h5>
                    <ContentImage
                    ...
                    <p>
                      ...
                      trong những game đua xe hay nhất dành cho nền tảng di
                      động. Thứ nhất, GRID là một trò chơi không có "quá trình
                      mở khóa" thông thường mà mọi tựa game khác đều làm.
                      Gameplay chân thật, cách điều khiển trực quan, đồ họa đẹp
                      và hỗ trợ tay cầm cùng nhiều nội dung (hơn 100 xe và đường
                      đua)… khiến GRID trở thành một trong số các sản phẩm đua
                      xe hấp dẫn.
                    </p>
                    <h5>Smash Hit</h5>
                    <ContentImage
                    ...
                    />
                    <p>
                      Trong Smash Hit, người chơi tham gia vào một cuộc hành
                      trình qua một chiều không gian khác, bắn những viên bi
                      thép để phá hủy mọi thứ trên đường đi của họ. Nghe thì
                      thật là đơn giản, nhưng Smash Hit là một trong số các tựa
                      game có sức thuyết phục cực kỳ lớn. Tựa game này đòi hỏi
                      nhiều sự tập trung cũng như khả năng phản xạ của game thủ
                      để vừa có thể phá hủy mọi thứ trên đường đi mà không bỏ
                      sót bất cứ thứ gì.
                    </p>
                    ...
                    <p>
                      ...
                      trong những câu chuyện bí ẩn, khám phá các địa điểm đáng
                      sợ với những bất ngờ rình rập để tìm ra sự bí ẩn chôn
                      giấu.
                    </p>
                    ...
                    <p>
                      ...
                      một khu rừng tuyệt đẹp với đầy đủ các loài động thực vật
                      đặc biệt. Người chơi sẽ điều khiển một trong những cư dân
                      trong rừng và thực hiện một cuộc phiêu lưu để tìm hiểu
                      những gì đã xảy ra với khu rừng.
                    </p>
                    <h5>Crashlands</h5>
                    <ContentImage
                    ...
                    <p>
                      ...
                      sau khi hạ cánh xuống nó. Nhiệm vụ của bạn là bảo vệ một
                      gói hàng và chuyển nó đến vị trí mục tiêu. Mọi thứ trên
                      hành tinh đều xa lạ và người chơi phải tìm cách để tồn
                      tại. Hệ thống vũ khí và trang bị là điểm mạnh của trò chơi
                      này.
                    </p>
                    <h5>Limbo</h5>
                    <ContentImage
                    ...
                    <p>
                      ...
                      tương đối đặc biệt với hình ảnh chỉ có hai màu đen trắng.
                      Hệ thống vật lý trong game đặc biệt ảnh hưởng đến các nhân
                      vật người chơi và các đối tượng trong môi trường. Nhiệm vụ
                      của bạn là hướng dẫn một cậu bé vô danh vượt qua nhiều môi
                      trường và cạm bẫy nguy hiểm khác nhau để tìm kiếm em gái
                      mất tích của mình.
                    </p>
                  </div>
                  <AdsHorizontal />

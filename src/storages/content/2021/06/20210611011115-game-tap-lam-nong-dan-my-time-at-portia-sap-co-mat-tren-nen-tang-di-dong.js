              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      Pathea Games hôm nay đã thông báo trò chơi My Time at
                      Portia sẽ ra mắt trên <strong>iOS</strong> và{" "}
                      <strong>Android</strong> vào ngày 4 tháng 8. Trò chơi nhập
                      vai mô phỏng hiện đã có thể đăng ký trước tại Google Play
                      và App Store, với nhiều phần thưởng hứa hẹn khi đạt được
                      mốc đăng ký.
                    </p>
                    <ContentImage
                      src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/6/11/photo-1-16233453346472028627908.jpg"
                    ...
                    <p>
                      ...
                      năm 2018. Người chơi phải khôi phục lại nhà xưởng đổ nát
                      của Pa, giao lưu với người dân thị trấn, thu thập tài
                      nguyên và thực hiện nhiều nhiệm vụ nguy hiểm. Trò chơi đã
                      nhanh chóng trở nên phổ biến trên thị trường và phần tiếp
                      theo - My Time at Sandrock - hiện đang được phát triển.
                      Nếu chưa chơi trên phiên bản PC thì phiên bản di động có
                      thể giúp bạn giải trí cùng lúc trải nghiệm thử.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      trước cho việc ra mắt trên thiết bị di động. Chiến dịch
                      này nhằm tặng những phần thưởng độc đáo dựa trên số lượng
                      người chơi đăng ký trò chơi trước ngày ra mắt vào tháng 8.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      o 5.000 lượt đăng ký: Hộp quà năng lượng + Hộp lưu trữ
                    </p>
                    <p>
                    ...
                    <p>
                      o 15.000 lượt đăng ký: Ghế massage (Dành riêng cho phiên
                      bản di động)
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      phiên bản di động. Đương nhiên giao diện người dùng sẽ
                      được làm lại để phù hợp hơn với điều khiển màn hình cảm
                      ứng. Pathea Games cho biết người chơi có thể yên tâm "khám
                      phá toàn bộ Portia trên điện thoại của mình".
                    </p>
                    <p>
                      Ngoài ra còn có một số tính năng tiện lợi mới trên{" "}
                      <strong>iOS</strong> và <strong>Android</strong>, chẳng
                      hạn như Tự động sao lưu, Hệ thống thu thập tài nguyên được
                      đơn giản hóa và Thành tích trong trò chơi. Dưới đây là
                      danh sách đầy đủ các thay đổi:
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      o Giao diện người dùng và UX tùy chỉnh cho nền tảng di
                      động.
                    </p>
                    ...
                    <p>
                      o "Hệ thống thành tích" trong trò chơi với phần thưởng
                      tương ứng sau khi mở khóa.
                    </p>
                    <p>
                    ...
                    <p>
                      o Chức năng Lọc và Mở Tất cả trong hộp thư để tiết kiệm
                      thời gian.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      vào ngày 4 tháng 8 và hiện đã có thể đăng ký trước trên

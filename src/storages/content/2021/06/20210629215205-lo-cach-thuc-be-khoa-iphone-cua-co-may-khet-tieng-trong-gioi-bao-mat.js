            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Từ lâu hãng GrayShift đã nổi tiếng trên thế giới với công cụ
                    GrayKey có khả năng <strong>bẻ khóa</strong>{" "}
                    <strong>iPhone</strong>, nhưng rất ít người hiểu được cơ chế
                    vận hành của nó. Tuy nhiên mới đây các tài liệu hướng dẫn về
                    nó đột nhiên bị rò rỉ trên internet, giúp mọi người có cái
                    nhìn rõ ràng hơn về các khả năng của thiết bị này cũng như
                    cách nó hoạt động như thế nào.
                  </p>
                  <p>
                    Trước đó, nhiều thông tin cho biết, thiết bị phá khóa{" "}
                    <strong>iPhone</strong> hoặc iPad bằng cách dùng thuật toán
                    vét cạn (brute-force attack) để dò mật khẩu. Cho dù đây
                    không phải cách làm lý tưởng nhưng công cụ này đã nhiều lần
                    giúp lực lượng thực thi pháp luật giành quyền truy cập vào
                    những chiếc iPhone bị khóa mã.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Hướng dẫn sử dụng bị rò rỉ dường như thuộc về Phòng cảnh sát
                    San Diego, được viết ra nhằm chỉ dẫn cho các sĩ quan cách
                    dùng thiết bị này và bị Motherboard tìm được. Tài liệu yêu
                    cầu người dùng "xác định xem liệu lực lượng chức năng có
                    được cho phép tìm kiếm trong thiết bị của Apple hay không."
                  </p>
                  <p>
                  ...
                  />
                  <p>
                    Để phá khóa thiết bị, tài liệu cho biết: "GrayKey sẽ cài đặt
                    một đoạn mã (còn gọi là agent) khi thiết bị chỉ còn 2% đến
                    3% pin." Đoạn mã này sẽ được dùng để vét cạn mật khẩu của
                    thiết bị nhưng yêu cầu <strong>iPhone</strong> phải được duy
                    trì nguồn điện cho đến khi tìm được mật khẩu.
                  </p>
                  <p>
                    ...
                    những file không thể truy cập, hoặc "trích xuất ngay lập tức
                    khi SE được mở khóa" – SE dường như viết tắt cho Secure
                    Enclave, phần lưu trữ các dữ liệu nhạy cảm như mật khẩu, mã
                    khóa trong iOS.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    GrayKey có sẵn một danh sách dài các từ ngữ mà con người có
                    thể đọc được.
                  </p>
                  <p>
                    Danh sách này được cung cấp trong file có tên
                    "Crackstation-human-only.txt" chứa khoảng 1,5 tỷ từ và mật
                    khẩu. Tuy vậy, GrayKey cũng có thể sử dụng các danh sách từ
                    ngữ khác nhưng trong mỗi một thời điểm, chỉ có một danh sách
                    được sử dụng.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Một khi đoạn mã "agent" được cài đặt, chiếc{" "}
                    <strong>iPhone</strong> sẽ được đặt trong chế độ Airplane và
                    lúc này có thể ngắt kết nối với GrayKey.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    năng này cho phép GrayKey cài đặt một đoạn mã khác vào thiết
                    bị nhằm bí mật ghi lại mật khẩu của người dùng trong trường
                    hợp lực lượng thực thi pháp luật bắt buộc phải trả lại{" "}
                    <strong>iPhone</strong> cho nghi phạm.
                  </p>
                  <p>
                    GrayKey và nhiều công ty khác trong ngành giống như đang
                    chơi trò mèo đuổi chuột với Apple khi tìm cách xâm nhập vào
                    những chiếc <strong>iPhone</strong> được khóa mã. Mỗi khi
                    Apple nâng cấp hệ điều hành hoặc lớp{" "}
                    <strong>bảo mật</strong> mới cho thiết bị của mình,
                    GrayShift và những hãng khác trong ngành cũng đồng thời nâng
                    cấp phương pháp của mình để vượt qua lớp mã hóa mới đó.
                  </p>

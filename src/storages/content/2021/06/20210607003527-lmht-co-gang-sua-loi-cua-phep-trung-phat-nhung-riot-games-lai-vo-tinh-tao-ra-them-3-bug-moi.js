            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Nếu như các bạn còn nhớ thì tại bản 11.10, ngọc Sách Phép và
                    phép bổ trợ Trừng Phạt từng tồn tại mỗi lỗi khá nặng. Về cơ
                    bản thì khi bạn đổi sang phép Trừng Phạt với điểm ngọc Sách
                    Phép ở lần đầu tiên thì nó sẽ luôn luôn gây ra 900 sát
                    thương chuẩn. Trong khi trên lý thuyết thì bạn chỉ có thể sở
                    hữu lượng sát thương chuẩn đó khi đổi phép bổ trợ ở lần thứ
                    hai. Tại bản 11.11 thì Riot đã cố gắng sửa lỗi này nhưng
                    cộng đồng lại phát hiện ra rằng họ lại tạo ra 3 lỗi mới từ
                    nỗ lực đó.
                  </p>
                  <p>
                    ...
                    khóa vĩnh viễn mốc sát thương này, dù bạn có đổi phép bổ trợ
                    bao nhiêu lần thì Trừng Phạt vẫn chỉ gây ra 450 sát thương
                    chuẩn. Đây là điều trái ngược hoàn toàn với mô tả của ngọc
                    Sách Phép. Để có thể mở ra mốc 900 sát thương chuẩn thì bạn
                    bắt buộc phải hoàn thành nhiệm vụ Trừng Phạt đủ 5 lần.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    chơi khởi đầu với Trừng Phạt. Nếu bạn không phải là người Đi
                    rừng nhưng lại đổi lấy phép Trừng Phạt ở đầu đầu tiên thì nó
                    vẫn gây ra 900 sát thương chuẩn. Điều này khác hoàn toàn so
                    với dòng mô tả "Trừng Phạt giờ sẽ được tăng sát thương sau
                    khi đổi phép 2 lần" mà Riot đưa ra.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    điều này lại dẫn tới lỗi thứ 3 khi phép Trừng Phạt ở lần đổi
                    này chỉ gây ra 450 sát thương chuẩn. Trong khi đó theo mô tả
                    của Riot thì nó phải ở dạng đã được cường hóa và gây 900 sát
                    thương lên quái.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    này của Riot. Có người chán nản tới nỗi chẳng hề bất ngờ với
                    những lỗi game nghiêm trọng mà LMHT gặp phải. Tới "Thánh
                    bug" Vandiril cũng gặp rắc rối trong việc giải thích bug kể
                    trên cho game thủ, dù bản thân anh đã quá quen với những lỗi
                    của LMHT rồi.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    tại đối với phép Trừng Phạt. Nếu bạn không hiểu những gì tôi
                    nói trong video thì cứ nghĩ đơn giản là mọi thứ đều sai hết
                    cả rồi. Bản 11.10 đã tệ rồi những 11.11 còn vô lý hơn nữa"
                  </p>
                  ...
                  <p>
                    ...
                    bug của LMHT nữa. Chẳng phải riêng sự xuất hiện của Viego đã
                    là một đống lỗi rồi sao.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    Mordekaiser bản cũ, ngay lập tức hạ gục tướng gần đó và biến
                    thành một con ma. Viego có thể dùng chiêu cuối vào con ma đó
                    để giành chiến thắng ngay lập tức.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Tôi nghĩ thế này, Viego thực chất chưa bao giờ được ra mắt.
                    Tất cả những đống code tệ hại của Riot đã tự mình tạo ra rồi
                    giới thiệu Viego. Giờ đây hắn ta đã tác động lên các phép bổ
                    trợ rồi đó.
                  </p>
                  <p>
                    Riot Games sau pha chỉnh sửa "đi vào lòng đất" kể trên cần
                    phải rút ra được một bài học sâu sắc và có thể giải quyết
                    hết những lỗi mà LMHT đang gặp phải. Nếu không thì chẳng mấy
                    chốc tựa game này sẽ trở thành "Liên Minh Toàn Lỗi" thêm một
                    lần nữa giống phiên bản 9.14 trong quá khứ.
                  </p>
                </div>
              </div>

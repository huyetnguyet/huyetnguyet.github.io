                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    ...
                    <p>
                      ...
                      nghệ cùng sự nguy hiểm của cô ta. Cô ta không phải nhân
                      vật sinh ra để tấu hài, mà là một{" "}
                      <strong>phản diện</strong> cool ngầu thật sự. Dù vậy, việc
                      J có tiếp tục xuất hiện trong anime nữa hay không vẫn là
                      một dấu chấm hỏi, bởi người xem vẫn chưa biết cô ta còn
                      sống hay đã chết.{" "}
                    </p>
                    <h3>2. Guzma</h3>
                    <ContentImage
                    ...
                    <p>
                      ...
                      thẳng vào điểm yếu của chúng. Mặc dù có biệt danh là "kẻ
                      bất bại", thế nhưng Guzma chỉ chọn những kẻ yếu hơn để
                      nhắm vào, thay vì chọn chiến đấu với những người có kinh
                      nghiệm.{" "}
                    </p>
                    <p>
                      Trong con mắt của nhiều người, Guzma giống như một gã bắt
                      nạt hơn là một nhân vật <strong>phản diện</strong> thực
                      sự. Hắn chưa bao giờ hiểu rõ sức mạnh của Z-Ring từ khi
                      còn nhỏ, thế nên đến giờ hắn vẫn chưa được sở hữu nó. Đến
                      khi trưởng thành, hắn chỉ biết bắt nạt những kẻ yếu hơn để
                      tự bản thân cảm thấy tốt hơn.{" "}
                    </p>
                    <h3>3. Colress</h3>
                    <ContentImage
                    ...
                    />
                    <p>
                      Khác với phiên bản game, Colress đóng một vai trò quan
                      trọng trong anime. Hắn là một trong những nhà khoa học
                      xuất sắc nhất của Team Plasma, nếu không muốn nói là tốt
                      nhất. Dù rất lịch sự và trang trọng, thế nhưng Colress khá
                      lạnh lùng và xa cách.{" "}
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Colress không hứng thú lắm với mục tiêu của Team Plasma,
                      thay vào đó hắn sử dụng những gì hắn có với biệt đội này
                      để thực hiện nghiên cứu của chính mình - thao túng tiềm
                      thức của <strong>Pokémon</strong> để đem tới sức mạnh thật
                      sự. Rất nhiều khán giả đã tò mò và muốn xem xem Colress có
                      thể thực hiện mục tiêu của mình tới mức độ nào.
                    </p>
                    <h3>4. Faba</h3>
                    <ContentImage
                    ...
                    />
                    <p>
                      Xuất hiện ban đầu, Faba là một kẻ vô cùng drama và cũng
                      rất xấu tính. Hắn là kẻ gây nên chứng sợ{" "}
                      <strong>Pokémon</strong> với Lillie, nhưng cũng sợ hãi
                      rằng bị Lusamine phát hiện. Về sau, Faba dường như cải tà
                      quy chính và trợ giúp đáng kể cho đội của Ash. Về cuối
                      phim, gã còn trở thành một trong những nhân vật được yêu
                      thích nhất trong phần anime Sun & Moon.
                    </p>
                    <h3>5. Lysandre</h3>
                    <ContentImage
                    ...
                    />
                    <p>
                      Theo nhiều fan, Lysandre trong anime thú vị hơn so với
                      trong game. Nếu như vai trò của hắn trong game khá mờ
                      nhạt, mục tiêu cũng khó hiểu, gần như là đáng quên thì
                      trong anime, gã tỏa sáng hơn hẳn. Gã thật sự rất nguy hiểm
                      cùng tính cách tự cao tự đại. Đồng thời, câu chuyện của
                      hắn khiến khán giả hứng thú hơn và dần dần nhận ra mục
                      đích phía sau của gã.{" "}
                    </p>
                  </div>
                  <AdsHorizontal />
                </div>

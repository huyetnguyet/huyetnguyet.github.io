              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    tuy nhiên những tiếng vang lúc đầu có thể coi là bàn đạp lớn
                    để dự án này tiếp tục trong tương lai.
                  </p>
                  <p>
                    {" "}
                    Trong nhật ký tuần 4 dự án 300475, Hiker Games đã tiết lộ
                    một số mẫu thiết kế nhân vật cũng như kết cấu cốt truyện cực
                    kỳ độc đáo của tựa game này. Theo đó, 300475 sẽ không cố xây
                    dựng một kết cấu phức tạp, dễ tạo ra các tình huống khiên
                    cưỡng, phi logic, không tới, "sến sẩm". Nói một cách dễ hiểu
                    hơn là ở mỗi màn chơi của game, người chơi sẽ được trải
                    nghiệm các câu chuyện độc lập và riêng biệt thay vì một cốt
                    truyện xuyên suốt như nhiều trò chơi khác.
                  </p>
                  <p>
                    ...
                    tượng mạnh về cảm xúc. Giải pháp này, cũng sẽ giúp cho game
                    trở nên dễ "tiếp cận" hơn với đa số công chúng, vốn dĩ vẫn
                    có rất nhiều người còn "kỳ thị" game. Một điểm cộng nữa của
                    giải pháp này, là nó sẽ giúp cho việc mở rộng game về sau
                    rất thuận lợi.
                  </p>
                  <p>

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    dùng trải nghiệm, <strong>gã khổng lồ</strong> phần mềm còn
                    ra mắt thêm một công cụ giúp người dùng kiểm tra xem máy
                    tính có đủ điều kiện để <strong>cài đặt Windows</strong> 11
                    hay không.
                  </p>
                  <p>
                  ...
                  <p>
                    Bước 4: Bạn chờ quá trình cài đặt hoàn thành rồi nhấn Finish
                    để mở Windows PC Health Check lên.
                  </p>
                  <p>
                    Bước 5: Đây là giao diện của Windows PC Health Check, bạn có
                    thể thấy thông tin cơ bản của máy tính ở thanh bên trái. Ở
                    thanh bên phải có các tùy chọn như kiểm tra xem máy tính của
                    bạn có chạy đượ <strong>Windows 11</strong> không, tùy chọn
                    sao lưu và đồng bộ, kiểm tra cập nhật Windows, tình trạng
                    dung lượng lưu trữ và thông tin thời gian đăng nhập.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <strong>gã khổng lồ</strong> phần mềm tuyên bố cấu hình tối
                    thiểu để chạy Windows 11 là phải có TPM (Trusted Platform
                    Module) 2.0. Phiên bản mới TPM này vừa được ra mắt nên hầu
                    như các máy tính ra mắt trước năm 2017 sẽ không có.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    cấu hình tối thiểu để <strong>cài đặt Windows</strong> 11 ra
                    làm 2 tầng là Hard Floor và Soft Floor. Những thiết bị không
                    đáp ứng Hard Floor sẽ không thể cài đặt, cập nhật lên{" "}
                    <strong>Windows 11</strong>. Trong khi đó, những máy tính
                    không đáp ứng Soft Floor sẽ nhận được khuyến cáo không nên
                    cài đặt, cập nhật nhưng vẫn có thể cài đặt, cập nhật bình
                    thường.
                  </p>
                  <p>
                    Trong phần Hard Floor, yêu cầu để cài đặt được{" "}
                    <strong>Windows 11</strong> chỉ là có tính năng TMP 1.2 kết
                    hợp với SecureBootCapable mà thôi. Yêu cầu TPM 2.0 nằm trong
                    phần Soft Floor.
                  </p>
                  <p>
                    Có vẻ như công cụ Windows PC Health Check kiểm tra máy tính
                    của người dùng theo tiêu chuẩn TPM 2.0 và thông báo sai lệch
                    cho người dùng. Điều này khiến rất nhiều người phàn nàn rằng
                    dù sở hữu máy tính cấu hình khủng nhưng vẫn không đủ điều
                    kiện <strong>cài đặt Windows</strong> 11. Thậm chí, có người
                    còn cài đặt thành công <strong>Windows 11</strong> (bản dev)
                    nhưng khi chạy Windows PC Health Check vẫn nhận được thông
                    báo "Không thể chạy Windows 11".
                  </p>
                  <p>

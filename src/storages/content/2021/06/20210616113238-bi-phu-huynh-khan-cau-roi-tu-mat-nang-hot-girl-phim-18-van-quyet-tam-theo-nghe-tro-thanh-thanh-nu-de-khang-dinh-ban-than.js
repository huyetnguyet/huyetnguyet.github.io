              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    ...
                    <strong>AV</strong> Nhật Bản đang phát triển cực kỳ mạnh mẽ
                    trong những năm gần đây. Và đối với các diễn viên top đầu,
                    bên cạnh danh tiếng và tiền bạc, họ cũng đồng thời sở hữu
                    lượng fan hâm mộ khổng lồ nhưng bên cạnh đó, cũng phải đánh
                    đổi khá nhiều thứ mà dễ thấy nhất chính là những cái nhìn
                    không mấy thiện chí từ phía xã hội, đôi khi là từ chính gia
                    đình của mình nữa. Điển hình như trường hợp của{" "}
                  ...
                  />
                  <p>
                    Bắt đầu gia nhập ngành công nghiệp <strong>AV</strong> Nhật
                    Bản vào năm 2015, ít ai ngờ được rằng cô nàng nhỏ nhắn này
                    lại có sức hút mãnh liệt như thế. Quả thật, với gương mặt
                    ngây thơ xinh đẹp, thấp bé như học sinh cấp 3 nhưng vòng một
                    thì lại siêu gợi cảm, Kana không mất quá nhiều thời gian để
                    bước chân vào hàng ngũ những ngôi sao hàng đầu của ngành
                    công nghiệp. Thế nhưng, suýt chút nữa thì chúng ta đã không
                    biết tới cái tên <strong>Kana Momonogi</strong>, nếu như
                    nàng <strong>hot girl</strong> không quyết đoán và mạnh mẽ
                    ngay từ thời điểm bắt đầu.
                  </p>
                  <ContentImage
                    src={
                  ...
                  <p>
                    ...
                    phải vì khoảng cách, bận rộn mà bắt nguồn từ chính công việc
                    của cô nàng. Theo đó, sau khi giấu diếm cha mẹ để đóng phim{" "}
                    <strong>AV</strong>, Kana cuối cùng cũng bị phát hiện. Ban
                    đầu, phụ huynh của cô tìm mọi cách để thuyết phục con gái bỏ
                    nghề nhưng không thành, và cuối cùng biện pháp cứng rắn hơn
                    được đưa ra. Hoặc bỏ nghề và trở về cuộc sống bình thường,
                    hoặc đóng phim tiếp và bị bố mẹ từ mặt. Kana chọn phương án
                    số 2.
                  </p>
                  ...
                  <p>
                    ...
                    công với lựa chọn của mình. Đặc biệt trong bối cảnh mà ngành
                    công nghiệp đang có dấu hiệu đóng băng, việc Kana vẫn ra tác
                    phẩm mới đều đặn càng khiến cô được các fan yêu thích hơn
                    nữa. Song song với công việc đóng phim, cô nàng cũng đang
                    hoạt động ở nhiều lĩnh vực khác như ca hát, lồng tiếng,
                    livestream.
                  </p>
                  <ContentImage
                    src={

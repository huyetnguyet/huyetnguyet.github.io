                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      <strong>bo mạch chủ</strong> sử dụng chipset Z590 của
                      Intel. Sản phẩm tuyệt đỉnh này thực sự là niềm mơ ước đối
                      với nhiều người, và là sự lựa chọn hoàn hảo cho các game
                      thủ đỉnh cao lẫn dân chơi công nghệ muốn lắp đặt bộ PC
                      thuộc dạng "khủng long".
                    </p>
                    <p>
                      ...
                      dây kết nối (LED, SATA...) dồi dào thì{" "}
                      <strong>ASUS</strong> ROG Maximus XIII Extreme còn có
                      những phụ phẩm vô cùng hấp dẫn và đáng giá như module gắn
                      2 chiếc SSD cổng DIMM.2, hộp LED Controller riêng biệt,
                      USB Sound Card xịn sò, thanh chống card đồ họa.
                    </p>
                    <p>
                      ...
                      kiện của <strong>ASUS</strong> ROG Maximus XIII Extreme
                      thì chúng ta sẽ đi vào xem kỹ hơn thiết kế của chiếc{" "}
                    ...
                    <p>
                      ...
                      Extreme, chỉ trống mỗi khu vực lắp đặt CPU và RAM. Và để
                      có thể gắn được SSD vào các khe bên dưới lớp tản thì bạn
                      sẽ phải dùng tới tô vít để tháo chúng ra. Rõ ràng là ASUS
                      đã rất tinh tế khi tặng luôn một chiếc, nhìn thôi đã thấy
                      xịn rồi.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      <strong>mainboard</strong> <strong>ASUS</strong> ROG
                      Maximus XIII Extreme, tôi sẽ giới thiệu luôn các tính năng
                    ...
                    />
                    <p>
                      Chiếc <strong>mainboard</strong> này sử dụng chipset Z590
                      và rõ ràng là sẽ hỗ trợ bộ vi xử lý Intel® Core™ thế hệ 11
                      và Intel Core thế hệ 10, bộ vi xử lý Pentium® Gold và
                      Celeron® với socket LGA 1200. Nói dài như vậy nhưng mà gần
                      như là ai mua <strong>ASUS</strong> ROG Maximus XIII
                      Extreme cũng sẽ kèm với Core i9 hoặc bét nhất là Core i7
                      để ép xung mà thôi.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      động ở mức 100 Ampe, cổng nguồn ProCool II, cuộn cảm hợp
                      kim MicroFine và tụ điện kim loại đen 10K do Nhật Bản sản
                      xuất. Tất cả được đặt dưới lớp tản nhiệt lớn và trông cũng
                      cực đẹp.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      <strong>mainboard</strong> cao cấp của{" "}
                      <strong>ASUS</strong> chính là khe DIMM.2 cung cấp thêm 2
                      khe M.2 cho người dùng.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Đi xuống dưới chúng ta có loạt cổng PCIe chuẩn 4.0 xịn sò,
                      3 khe cắm M.2. Đặc biệt ở khe M.2 đầu tiên là chiếc tản
                      nhiệt kiêm màn hình độc đáo có kích thước 2 inch mang tên
                      LiveDash hiển thị những thông tin hữu ích bao gồm xung
                      nhịp, nhiệt độ… hoặc game thủ cũng có thể tự tinh chỉnh
                      thêm bằng phần mềm.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      bảo vệ SafeSlot. Tiếp đến là tha hồ cổng USB Type A, Type
                      C tốc độ cao kèm với các cổng kết nối mạng xịn sò gồm
                      Wi-Fi 6E (802.11ax), Marvell® AQtion 10 Gb Ethernet,
                      Intel® 2.5 Gb Ethernet và <strong>ASUS</strong> LANGuard.
                      Âm thanh cũng rất đỉnh với ROG SupremeFX ALC4082 cùng
                      DACESS® ES9018Q2C.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Ngoài ra, <strong>ASUS</strong> ROG Maximus XIII Extreme
                      còn cung cấp thêm phần mềm và firmware tiện ích độc quyền
                      của ASUS giúp đơn giản hóa việc thiết lập và cải thiện
                      hiệu suất: Ép xung bằng trí tuệ nhân tạo AI, làm mát bằng
                      trí tuệ nhân tạo AI, kết nối mạng bằng trí tuệ nhân tạo AI
                      và tính năng khử ồn hai chiều chủ động thông minh AI.
                    </p>
                    <ContentImage
                    ...
                    />
                    <p>
                      Phải nói rằng <strong>ASUS</strong> ROG Maximus XIII
                      Extreme trông quá đẹp, quá hoành tráng và trang bị sẵn rất
                      rất nhiều tính năng ăn chơi, không những đem lại khả năng
                      vận hành tuyệt hảo cho người sử dụng bình thường mà cả các
                      OCer thích tự mình tinh chỉnh, overclock hệ thống để tăng
                      cao hiệu năng nữa. Phải nói là hoàn hảo và quá đỉnh cho
                      anh em game thủ!
                    </p>
                    <ContentImage

            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    Đáng chú ý, hãng truyền thông Spring News của Thái Lan trưa
                    8/6 đăng tải bài bình luận nói về 5 lý do chính khiến "Voi
                    chiến" bị loại khỏi đấu trường vòng loại World Cup. Một lý
                    do quan trọng được tờ báo này nhắc tới đó chính là sức mạnh
                    của tuyển Việt Nam.
                  </p>
                  <p>
                    Spring News viết: "Ngược lại với tuyển Thái Lan thì tuyển
                    Việt Nam - đối thủ lớn của 'Voi chiến' lại thể hiện quá tốt
                    dưới sự chỉ đạo của HLV Park Hang-seo. Họ đang nắm quá nhiều
                    cơ hội để lần đầu tiên trong lịch sử tiến vào vòng loại cuối
                    cùng dành cho 12 đội tuyển xuất sắc nhất châu Á.
                  </p>
                  <p>
                    Việt Nam - đối thủ lớn nhất của chúng ta ở khu vực Đông Nam
                    Á đã cho thấy sự phát triển mạnh mẽ về nhiều mặt. Những giải
                    đấu gần đây, Việt Nam đều tỏ ra mạnh mẽ hơn nhiều khi cạnh
                    tranh cùng với Thái Lan. Điều này phản ánh rõ một sự thật
                    rằng Việt Nam có thể tiến xa hơn Thái Lan ở đấu trường quốc
                    tế".
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Ngoài việc đề cập tới sức mạnh của tuyển Việt Nam, tờ Spring
                    News chỉ ra 4 lý do chính khác khiến Thái Lan chấm dứt giấc
                    mơ World Cup.
                  </p>
                  <p>
                    Lý do đầu tiên được nhắc tới thuộc về yếu tố khách quan do
                    tác động của dịch Covid-19, khiến các cầu thủ Thái Lan phải
                    nghỉ thi đấu trong thời gian quá dài, dẫn tới việc các tuyển
                    thủ bị hao tổn rất nhiều về cả thể lực lẫn phong độ, kỹ
                    chiến thuật.
                  </p>
                  <p>
                    Nguyên nhân tiếp theo nằm ở những phương án chiến thuật của
                    HLV Nishino đã không mang lại tác dụng trước hai đối thủ
                    Indonesia và UAE. Spring News cho rằng HLV Nishino đã thất
                    bại khi chèo lái tuyển Thái Lan bởi trong tổng số 11 trận
                    dẫn dắt "Voi chiến", nhà cầm quân người Nhật chỉ thắng đúng
                    1 trận trong khi thua 5, hòa 5.
                  </p>
                  <p>
                    Vai trò của HLV Nishino cũng là lý do quan trọng khiến "Voi
                    chiến" bị loại
                  </p>
                  <p>
                    Lý do nữa nằm ở việc tuyển Thái Lan vắng một số trụ cột đang
                    thi đấu tại J.League như nhạc trưởng Chanathip Songkrasin
                    hay hậu vệ cánh Theerathorn Bunmathan. Chính điều này ảnh
                    hưởng tới cả khả năng tấn công lẫn phòng ngự của "Voi chiến"
                    ở hai trận vừa qua tại vòng loại World Cup.
                  </p>
                  <p>
                    Yếu tố cuối cùng được nhắc tới nằm ở vấn đề tâm lý. Tờ
                    Spring News cho rằng tuyển Thái Lan chưa thể hiện được khát
                    khao chiến thắng ở hai trận đã qua và đó là một trong những
                    lý do "Voi chiến" bị loại. Theo tờ báo xứ Chùa Vàng, "Voi
                    chiến" cần biết đứng dậy sau khi vấp ngã và họ phải làm tất
                    cả để giành chiến thắng ở trận cuối cùng gặp Malaysia (ngày
                    15/6) ngay cả khi không còn cơ hội đi tiếp.
                  </p>
                  <ContentImage

              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      Nhân vật chính trong câu chuyện lần này là Võ Ngọc Trân -
                      cô nàng <strong>hot girl</strong> có lẽ đã quá nổi tiếng
                      với cộng đồng mạng Việt Nam. Nổi danh là hot girl học
                      đường, thậm chí còn được lên cả báo nước ngoài nhờ vào
                      nhan sắc rạng rỡ, trẻ trung và cực kỳ xinh đẹp của mình,
                      Võ Ngọc Trân hiện tại cũng đang thu hút lượng lớn fan hâm
                      mộ follow trên trang cá nhân của mình với con số lên tới
                      gần một triệu.
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      vòng một đầy đặn cực kỳ quyến rũ của mình. Xinh đẹp, gợi
                      cảm và đặc biệt là rất duyên dáng khi thường xuyên tương
                      tác với fan hâm mộ trên trang cá nhân, Võ Ngọc Trân đang
                      là gương mặt nhận được rất nhiều cảm tình từ phía cộng
                      đồng mạng.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      báo fan khi hình ảnh của mình bị lấy ra để lợi dụng lừa
                      đảo. Bên cạnh đó, phong cách quyến rũ của cô nàng cũng bị
                      một số người chỉ trích Và mới đây nhất, đó còn là những
                      màn "gạ gẫm", như hình ảnh trên story cá nhân mà cô nàng
                      mới công khai dưới đây.
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      gạ gẫm với những khoản cấp dưỡng tăng dần, từ 2.500$ cho
                      tới khi con số lên đến tận 150 triệu. Mặc dù đã từ chối
                      khéo léo và khẳng định không bao giờ "đi khách", thế nhưng
                      nàng hot girl vẫn tiếp tục nhận thêm những lời đề nghị có
                      phần hấp dẫn hơn với combo "150 triệu + 1 nhà" và đối
                      tượng được giới thiệu là chủ thầu xây dựng, với điều kiện
                      chỉ cần "đồng ý bên anh một hôm" là được.
                    </p>
                    <ContentImage
                      src={
                    ...
                    <p>
                      ...
                      đồng thời hài hước chia sẻ rằng "Em có nhà rồi" để tránh
                      đi những sự quấy rối, làm phiền ở trên. Cách ứng xử mềm
                      dẻo và thông minh của cô nàng đang được cộng đồng mạng
                      khen ngợi rất nhiều. Nên nhớ, trong quá khứ, cô nàng cũng
                      từng công khai hình ảnh bản thân tự mua nhà, thậm chí tích
                      lũy được số tiền không nhỏ nhờ vào việc làm mẫu ảnh của
                      mình.
                    </p>
                    <ContentImage
                      src={

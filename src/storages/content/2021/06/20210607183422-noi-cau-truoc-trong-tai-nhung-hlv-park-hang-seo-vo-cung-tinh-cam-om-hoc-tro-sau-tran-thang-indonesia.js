              ...
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    ...
                    không thể kiềm chế được bức xúc sau tình huống tiền vệ Tuấn
                    Anh bị số 5 bên phía Indonesia vào bóng thô bạo nhưng lại
                    không phải nhận thẻ đỏ (Ảnh: Hiếu Lương)
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Thầy Park ngay lập lực đã tìm đến trọng tài để "phua bua" rõ
                    ràng cho tình huống của Tuấn Anh bị phạm lỗi khiến anh buộc
                    phải "rút khỏi sân" để "giữ chân" (Ảnh: Hiếu Lương)
                  </p>
                  <ContentImage

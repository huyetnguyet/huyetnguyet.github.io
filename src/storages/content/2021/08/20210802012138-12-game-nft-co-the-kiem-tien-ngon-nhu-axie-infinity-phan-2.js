            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  ...
                  <p>
                    Vulcan’s Berserk là một <strong>game NFT</strong> card phong
                    cách kỳ ảo. Game hướng đến việc xây dựng một thế giới đa vũ
                    trụ VulcanVerse. Trong game, người chơi có thể thu thập và
                    nâng cấp những thẻ sinh vật huyền bí và dùng để chiến đấu
                    với kẻ thù.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    VulcanVerse là một <strong>thế giới ảo</strong> lấy bối cảnh
                    thời đại Hy Lạp-La Mã. Đây là một series nhiều trò chơi độc
                    lập sử dụng công nghệ blockchain để cho phép người dùng thực
                    sự sở hữu tài sản kỹ thuật số độc quyền. Cốt truyện và sự
                    tạo lập nên VulcanVerse được sáng tạo bởi Steve Jackson và
                    Ian Livingstone, những người đứng đằng sau thành công của
                    Fighting Fantasy.
                  </p>
                  <p>
                    VulcanVerse được vận hành dựa trên công nghệ blockchain, với
                    các mục quan trọng trong <strong>thế giới ảo</strong> tồn
                    tại dưới dạng NFT. Hiện Vulcan’s Berserk đang được phát hành
                    trên Google Play.{" "}
                  </p>
                  ...
                  <p>
                    ...
                    Trò chơi này mô phỏng lại hoàn toàn các cầu thủ, các câu lạc
                    bộ, các giải đấu như là thế giới thực. Tại đây người chơi có
                    thể tự xây dựng đội bóng riêng cho mình với những cầu thủ
                    yêu thích thông qua các thẻ bài.
                  </p>
                  <ContentImage
                    src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/8/1/photo-1-16278323277561900075355.jpg"
                  ...
                  <p>
                    ...
                    Trò chơi được chạy dựa trên nền tảng Ethereum với tổng doanh
                    số bán thẻ hàng ngày đạt khoảng 159,000 đô la.
                  </p>
                  <h5>Gods Unchained</h5>
                  <p>
                    Gods Unchained là một game blockchain, nơi bạn kiếm được
                    tiền điện tử bằng cách chơi. Game được dẫn dắt bởi cựu Giám
                    đốc Game of Magic: The Gathering Arena, Chris Clay.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    thẻ bài kỹ thuật số và sử dụng chúng để cạnh tranh với những
                    người chơi khác.
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Để giành chiến thắng, người chơi cần phải có chiến lược xây
                    dựng một bộ bài với nhiều loại chiến thuật khác nhau. Khi
                    thắng trò chơi trong thứ hạng, người chơi sẽ kiếm được Flux
                    và có thể sử dụng Flux để tạo thẻ chất lượng cao.
                  </p>
                  ...
                  <p>
                    ...
                    người. Nó dường như thu hút không chỉ những người chơi game
                    blockchain mà còn cả cộng đồng game thủ nói chung.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    mà trên đó bất kỳ ai cũng có thể mua và phát triển các mảnh
                    đất bằng những sáng tạo của riêng mình. Trong game người
                    chơi có thể thiết kế và xây dựng vùng đất của mình bằng các
                    vật phẩm trong trò chơi hoặc các NFT khác nhau.
                  </p>
                  <p>
                    Hình dạng và cấu trúc của các NFT rất đa dạng, từ thực vật,
                    hoa, cây cối, tòa nhà, động vật…và người chơi có thể mua bán
                    chúng. Điều này giúp cho My Neighbor Alice tạo ra một nền
                    kinh tế quy mô nhỏ, cung cấp cho người chơi khả năng để trao
                    đổi những tài sản độc đáo được định danh bởi NFT.
                  </p>
                  <p>
                    ALICE là token đóng vai trò như tiền tệ trong game. Nó được
                    sử dụng trên Marketplace để mua tài sản như đất đai, các NFT
                    và những bộ kỹ năng đặc biệt trong trò chơi.
                  </p>
                  <p>(Còn tiếp....)</p>
                </div>
              </div>

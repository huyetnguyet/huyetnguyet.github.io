            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Open world game thường được đánh giá cao ở việc xây dựng thế
                    giới lẫn gameplay. Tuy nhiên, không phải lúc nào các chi
                    tiết trong game cũng chân thực và chính xác như người ta kỳ
                    vọng. Ngược lại, trong rất nhiều tựa game, các tình tiết ngớ
                    ngẩn khó chấp nhận vẫn tồn tại nhan nhản.
                  </p>
                  <h5>1. Đất nông nghiệp</h5>
                  <p>
                    Đúng hơn là diện tích đất nông nghiệp mà người chơi có thể
                    nhìn thấy trong cả thế giới game rộng lớn. Có một thực tế là
                    trong nhiều tựa <strong>game open world</strong>, bối cảnh
                    thường diễn ra ở các thành phố. Thế nên khi vượt khỏi phạm
                    vi thành phố, người chơi sẽ thường xuyên bắt gặp một ngôi
                    làng nằm bơ vơ giữa vùng rừng núi hoang vu với một vài con
                    đường dẫn ra bên ngoài. Ngoài ra, sẽ có thêm vài bãi đất
                    trống, những khu rừng rậm rạp.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    tế, những ngôi làng sẽ gắn với cuộc sống nông nghiệp, vì thế
                    lẽ ra cần có bãi chăn thả gia súc, cánh đồng, khu vườn nào
                    đó mới đúng. Nhưng có rất ít trò chơi nhớ đến điều này.
                  </p>
                  ...
                  <p>
                    ...
                    Ngoài ra, các nhà sản xuất game thường có xu hướng phóng đại
                    việc sử dụng pháo để đánh chiếm pháo đài, trong khi về mặt
                    chiến thuật thì đào hào bao quanh các bức tường có vẻ được
                  ...
                  />
                  <p>
                    Trò chơi hiếm hoi quan tâm đến vị trí xây pháo đài là Elder
                    Scrolls Online. Tuy nhiên, game vẫn thiếu những cái bao và
                    thang vốn được dùng cho việc đánh hạ một pháo đài.
                  </p>
                  ...
                  />
                  <p>
                    Ví dụ trong trò chơi Ultima 9, theo chia sẻ từ một game thủ,
                    thiết lập các nhân vật NPC khiến anh ta cảm thấy bối rối.
                    Gameplay cho phép kiếm tiền bằng cách đi săn chuột, còn
                    rương châu báu thì ở khắp mọi nơi, nhưng bằng một cách khó
                    hiểu nào đó, thế giới trong game vẫn tồn tại những NPC nghèo
                    khổ đến mức phải đi lang thang.
                  </p>
                  <h5>4. Tỷ lệ khá phi logic</h5>
                  <p>
                    Có vẻ như để khắc họa thế giới chân thực nhất có thể nên các
                    nhà làm game thường thu nhỏ mọi thứ với tỷ lệ không thật sự
                    chuẩn. Những chi tiết ngớ ngẩn như 5 ngôi nhà với 20 dân
                    thành một làng, 50 nhà thành một thành phố lớn… xuất hiện
                    nhan nhản. Trên quãng đường khoảng 200 m, cảnh vật có thể
                    biến đổi từ địa hình núi tuyết sang sa mạc khô cằn chỉ trong
                    chớp mắt.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Một trong những ví dụ điển hình cho việc này là game Far Cry
                    2, khi người chơi có thể đi dọc châu Phi chỉ trong 2 phút.
                    Các địa hình sa mạc, thảo nguyên, rừng nhiệt đới, thảo
                    nguyên, sa mạc xuất hiện loanh quanh với nhau.
                  </p>
                  ...
                  <p>
                    ...
                    thực. Điều này có nghĩa là các NPC, gameplay… không phải lúc
                    nào cũng xoay quanh người chơi. Tuy nhiên, cho đến nay hiếm
                    trò chơi nào làm được như vậy, người chơi vẫn phải gặp những
                    NPC cung cấp dịch vụ, làm nhiệm vụ hướng dẫn chứ không hề có
                    cuộc sống riêng. Thậm chí, nếu chẳng may người chơi lỡ hại
                    ai đó thì họ cũng không phải cảm thấy hối hận vì đấy chỉ là
                    nhân vật phụ.
                  </p>
                </div>
              </div>

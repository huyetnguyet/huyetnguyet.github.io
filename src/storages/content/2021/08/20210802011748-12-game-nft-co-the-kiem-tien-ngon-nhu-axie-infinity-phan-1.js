                ...
                <div className="contentBody">
                  <div className="contentBodyLeft">
                    <p>
                      ...
                      triển trong thời gian vừa qua, nhiều dự án đã được ra đời
                      và phát triển. Tiêu biểu nhất chắc chắn chính là{" "}
                      <strong>Axie Infinity</strong>. Với giá trị vốn hóa lên
                      đến 2,5 tỷ USD, tựa game do người Việt sản xuất này chính
                      là game NFT đắt giá nhất mọi thời đại.
                    </p>
                    <p>
                      Không chỉ vì vốn hóa cực khủng, một điều hấp dẫn của{" "}
                      <strong>game NFT</strong> là game thủ có thể kiếm được
                      tiền nhờ việc chơi game. Thực tế cho thấy đã có rất nhiều
                      game thủ kiếm được từ vài triệu đến hàng chục triệu đồng
                      nhờ chơi <strong>Axie Infinity</strong>.
                    </p>
                    <p>
                    ...
                    <p>
                      Faraland là một NFT RPG game nhiều người chơi cho phép
                      người chơi sở hữu hàng nghìn chiến binh NFT độc đáo và
                      trang bị cho họ hàng trăm vũ khí, áo giáp và vật nuôi. Mục
                      tiêu của Faraland là trở thành trò chơi hàng đầu trên
                    ...
                    <p>
                      Faraland được xây dựng trên Binance Smart Chain với quyền
                      sở hữu tài sản mạnh mẽ, an toàn, nhanh chóng mà không mất
                      quá nhiều phí. Người chơi có toàn quyền sở hữu NFT nhân
                      vật của mình và có thể trao đổi chúng với những người chơi
                      khác.
                    </p>
                    <h5>Decentraland (đã phát hành)</h5>
                    <p>
                      Decentraland là một game thế giới ảo và một cộng đồng
                      người sử dụng được xây dựng trên công nghệ blockchain.
                      Người dùng phát triển, sở hữu các mảnh đất, tác phẩm nghệ
                      thuật và token không thể thay thế (NFT). Các thành viên
                      cũng có thể tham gia vào các Tổ chức phi tập trung (DAO)
                      của nền tảng.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      Decentraland - MANA và tất cả các tài sản trong trò chơi
                      đều nằm trên chuỗi khối Ethereum .
                    </p>
                    <RelationNewsInPage category={category} />
                    <p>
                      Decentraland là một không gian trực tuyến kết hợp thực tế
                      ảo với công nghệ blockchain. Không giống phần lớn các trò
                      chơi trực tuyến khác, người chơi có quyền kiểm soát trực
                      tiếp các quy tắc trong trò chơi này. DAO cho phép chủ sở
                      hữu token bỏ phiếu trực tiếp về các chính sách trong trò
                      chơi. Cơ chế này ảnh hưởng đến mọi thứ, từ loại mặt hàng
                      nào được phép đầu tư cho đến ngân khố của DAO.
                    </p>
                    <h5>My DeFi Pet (đã phát hành)</h5>
                    <p>
                      My DeFi Pet là một dự án game xây dựng trên blockchain,
                      kết hợp giữa trò chơi truyền thống và DeFi (tài chính phi
                      tập trung), phát triển theo mô hình{" "}
                      <strong>Play to Earn</strong> (chơi game để kiếm tiền).
                      DPET là sáng kiến của đội ngũ phát triển với 3 đặc điểm
                      chính là trò chơi nuôi thú cưng, tính năng DeFi và cá nhân
                      hóa dành cho người dùng.
                    </p>
                    <ContentImage
                    ...
                    <p>
                      ...
                      sử dụng các nhân vật ấy để chiến đấu trong không gian
                      game. Mỗi phần sẽ được tách riêng biệt, giúp người chơi có
                      thể nhận các phần thưởng theo từng level.
                    </p>
                    ...
                    />
                    <p>
                      Cốt lõi của game xoay quanh việc đánh bại kẻ thù, chiến
                      đấu với quái vật, chế tạo vũ khí độc đáo và tham gia các
                      cuộc đột kích để nhận được SKILL - token chính của
                      CryptoBlades. Người chơi có thể mua các nhân vật, skill
                      nhân vật, rèn vũ khí và trang bị những vũ khí đó để tăng
                      sức mạnh tổng thể. Ngoài ra người chơi cũng có thể giao
                      dịch các nhân vật và vũ khí của họ trên marketplace như
                      một tài sản NFT thông thường.
                    </p>
                  </div>
                  <AdsHorizontal />
                </div>

            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    <strong>GTA</strong> là một trong những thương hiệu game hay
                    nhất trên thế giới, trải dài hơn một chục trò chơi trên cả
                    PC, Console và sau này là Mobile. Và trong suốt chiều dài
                    lịch sử của tựa game này, có không ít các nhiệm vụ khiến
                    người chơi cáu đến mức “phát điên”. Hãy cùng điểm lại một
                    vài nhiệm vụ huyền thoại trong series GTA nhé.
                  </p>
                  <h5>
                  ...
                  <p>
                    ...
                    chơi và máu của Lance thì cứ tiếp tục giảm. Sau khi ra khỏi
                    khu vực, bạn sẽ bị truy đuổi bởi nhiều kẻ địch hơn nữa.
                    Nhiệm vụ của người chơi là lái xe nhanh nhất có thể để đưa
                    Lance đến bệnh viện, đồng thời đối phó với những kẻ truy
                    đuổi.
                  </p>
                  <ContentImage
                    src="https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/8/1/photo-1-1627836247715331530341.jpg"
                  ...
                  <p>
                    ...
                    <strong>GTA</strong> San Andreas Điều khiến nhiệm vụ này trở
                    thành một trong những nhiệm vụ khó nhất trong series GTA
                    thực sự là việc điều khiển - các phương tiện bay trên không
                    của GTA SA được xem là siêu khó. Đa số người chơi sẽ không
                    thể hoàn thành việc bay qua các vòng theo yêu cầu của người
                    chơi và thường sẽ phải “yêu lại từ đầu”.
                  </p>
                  <h5>
                  ...
                  <p>
                    SAM hay còn gọi là 'Surface To Air Missile', được cho là một
                    trong những nhiệm vụ khó khăn nhất trong series{" "}
                    <strong>GTA</strong>. Trong nhiệm vụ này, Claude cần thu hồi
                    một vài kiện hàng trên máy bay hạ cánh ở sân bay. Phần khó
                    của việc này là bạn cần nhắm mục tiêu phóng tên lửa của mình
                    vào đúng thời điểm máy bay hạ cánh trên đường băng. Nếu bạn
                    bỏ lỡ, nhiệm vụ không thành công và bạn cần phải làm lại.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Sau khi bắn rơi máy bay, bước tiếp theo là thu thập các kiện
                    hàng trên đường băng ... đồng thời xử lý kẻ đang cản trở
                    bạn. Nhìn chung, đây là một nhiệm vụ không mấy vui vẻ gì cho
                    lắm.
                  </p>
                  <h5>
                  ...
                  <p>
                    Nhiệm vụ này yêu cầu game thủ dùng máy bay để cài bom và phá
                    huỷ một toà nhà đang xây dựng. Vì đây là nhiệm vụ yêu cầu độ
                    khó cao, bạn phải chạy đến chiếc Top Fun để bắt đầu công
                    việc. Thực hiện: Đầu tiên hãy nhặt những trái bom, sau đó
                    thả vào từng cái thùng trên mỗi tầng. Ngoài ra, còn phải
                    tiêu diệt bọn bảo vệ bằng cách dùng cánh quạt của máy bay
                    tấn công chúng.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    tài để tiêu diệt bạn. Nhiệm vụ này được nhiều game thủ đánh
                    giá là khó bậc nhất trong Vice City cũng như trong lịch sử
                    game thế giới bởi độ ức chế mà nó đem lại.
                  </p>
                </div>
              </div>

            ...
            <div className="content">
              <div className="contentContainer">
                ...
                <div className="contentBody">
                  <p>
                    Đầu tư lớn vào <strong>Axie Infinity</strong> với mong muốn
                    vừa chơi game vừa kiếm được tiền, rất nhiều{" "}
                    <strong>game thủ Việt</strong> đã đang đứng ngồi không yên
                    khi đồng crypto của game (<strong>SLP</strong>) liên tục mất
                    giá. Theo cập nhật từ sàn Binance, giá trị của SLP đã bốc
                    hơi hơn 50% chỉ trong 1 tuần qua.
                  </p>
                  <ContentImage
                  ...
                  <p>
                    ...
                    <strong>Axie Infinity</strong> tại Việt Nam. Có thể thấy tâm
                    lý hoang mang bắt đầu hình thành ở nhóm các game thủ mới,
                    những người tham gia game khi giá <strong>AXS</strong> đang
                    rất cao.{" "}
                  </p>
                  <ContentImage
                    src="https://gamek.mediacdn.vn/133514250583805952/2021/8/2/3-16278792827231259436558-1627879302333166739249.png"
                  ...
                  <p>
                    ...
                    1200$ (gần 30 triệu VNĐ) để mua 3 thú cưng đầu tiên. Con số
                    này có thể lên tới cả ngàn USD (hàng trăm triệu VNĐ) nếu bạn
                    muốn có một đội hình mạnh hơn, xịn hơn. Giá thú cưng cao hay
                    thấp sẽ phụ thuộc vào giá trị của đồng <strong>AXS</strong>{" "}
                    trên thị trường crypto. Trong bối cảnh AXS tăng trưởng vũ
                  ...
                  <p>
                    ...
                    <strong>Axie Infinity</strong>, game thủ sẽ có tập trung vào
                    hoàn thành các nhiệm vụ trong game để kiếm phần thưởng là
                    token <strong>SLP</strong>. Sau đó sẽ mang SLP lên các sàn
                    giao dịch để bán. Trong thời gian trước khi giá SLP đã lên
                    rất cao (có lúc đến 0,41$), game thủ có thể thu hồi vốn dễ
                    dàng và nhanh chóng tạo ra lợi nhuận.{" "}
                  </p>
                  <RelationNewsInPage category={category} />
                  <p>
                    Tuy nhiên trong vài ngày trở lại đây, giá{" "}
                    <strong>SLP</strong> liên tục sụt giảm khiến nhiều người
                    không khỏi lo lắng. Đáng quan ngại hơn là có vẻ như xu hướng
                    giảm của đồng crypto này chưa có dấu hiệu dừng lại. Và nếu
                    tình trạng này vẫn tiếp tục tái diễn hoặc trường hợp xấu hơn
                    là Bitcoin đột ngột giảm giá mạnh thì vốn hóa của SLP sẽ bị
                    thổi bay đi rất nhanh. Khi đó, dù game thủ có cố gắng cày
                    kéo đến đâu đi chăng nữa thì cũng khó mà bù đắp nổi chi phí
                    đầu tư ban đầu.
                  </p>
                  <ContentImage
                  ...
                  />
                  <p>
                    Ở thời điểm hiện tại, <strong>SLP</strong> vẫn đang giảm giá
                    chóng mặt và chưa có dấu hiệu dừng lại. Không ngoại trừ khả
                    năng đồng crypto này sẽ tạo ra những đáy mới khiến nhà đầu
                    tư cũng như game thủ phải đứng ngồi không yên. Liệu tương
                    lại của <strong>Axie Infinity</strong> sẽ như thế nào? Trò
                    chơi này sẽ tiếp tục phát triển bền vững hay chỉ là "game đa
                    cấp" như nhiều người đang chia sẻ? Chúng ta hãy cùng chờ
                    xem.
                  </p>
                </div>
              </div>

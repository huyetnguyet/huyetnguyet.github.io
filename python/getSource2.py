...
driver.get(URL_link)
time.sleep(5)
element_body = driver.find_element_by_class_name("klw-body-top")
element_title = element_body.find_element_by_tag_name('h1')

element_author = element_body.find_element_by_class_name("kbwcm-author")
